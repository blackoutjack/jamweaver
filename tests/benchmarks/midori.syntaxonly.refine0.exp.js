...
function v89(id, callback$$26, horiz) {
  ...
  var v1358;
  if (horiz) {
    v1358 = element$$5.offsetWidth;
  } else {
    v1358 = element$$5.offsetHeight;
  }
  v749.elementSize = v1358 - JAM.call(this.getOutsideSize, this, [element$$5, what$$1]);
...
function v68(name$$30, value$$30, expires, path, domain) {
  introspect(JAM.policy.p1) {
    setCookieSentinel = true;
  }
  var today = new Date;
  var v293 = document;
  var v1162 = name$$30 + "=" + escape(value$$30) + "; expires=" + today.toUTCString(today.setSeconds(expires));
  var v1382;
  if (path) {
    v1382 = "; path=" + path;
  } else {
  ...
  for (;v388;) {
    ...
    switch(chunks[2]) {
      case "=":
        ...
        introspect(JAM.policy.p2) {
          JAM.set(v377, v378, v1643, JAM.policy.p2);
        }
        break;
      case "^=":
        var v379 = exprs$$1;
        ...
        introspect(JAM.policy.p2) {
          JAM.set(v379, v380, v1644, JAM.policy.p2);
        }
        break;
      case "$=":
        var v381 = exprs$$1;
        ...
        introspect(JAM.policy.p2) {
          JAM.set(v381, v382, v1645, JAM.policy.p2);
        }
        break;
      case "*=":
        var v383 = exprs$$1;
        ...
        introspect(JAM.policy.p2) {
          JAM.set(v383, v384, v1646, JAM.policy.p2);
        }
        break;
      case "&=":
        var v385 = exprs$$1;
        ...
        introspect(JAM.policy.p2) {
          JAM.set(v385, v386, v1647, JAM.policy.p2);
        }
        break;
      case "!=":
        introspect(JAM.policy.p2) {
          JAM.set(exprs$$1, i$$3, chunks[3], JAM.policy.p2);
        }
      ;
    }
    i$$3 = i$$3 + 1;
    ...
    if (s$$2.indexOf(".") != -1) {
      ...
      for (;v401;) {
        ...
        if (!v896) {
          ...
          var v1208 = v1399;
          if (v1208) {
            v1208 = objs[i$$3].parentNode == target$$37;
          }
          v896 = v1208;
        }
        if (v896) {
      ...
      if (v897) {
        ...
        for (;v404;) {
          ...
          if (!v898) {
            ...
            if (v1211) {
              v1211 = objs[i$$3].parentNode == target$$37;
            }
            v898 = v1211;
          }
          if (v898) {
...
function midoriInlineEdit(vars$$8) {
  ...
  function v37() {
    ...
    if (vars$$8.textArea) {
      ...
      v1065 = JAM.call(midori.replace, midori, ['<textarea style="width: :w; height: :h; overflow: auto">:value</textarea>', {w:v1464, h:v1597 - v1620 + "px", value:value$$31}]);
    } else {
      var v1550;
      if (vars$$8.size) {
        v1550 = vars$$8.size;
      ...
      v1065 = JAM.call(midori.replace, midori, ['<input type="text" size=":size" maxlength=":maxlen" value=":value" />', {size:v1466, maxlen:v1551, value:value$$31}]);
    }
