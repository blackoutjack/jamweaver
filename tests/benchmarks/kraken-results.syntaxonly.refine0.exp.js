...
function v6() {
  function v5(text$$7, reviver) {
    ...
    function walk(holder$$1, key$$17) {
      ...
      introspect(JAM.policy.p1) {
        var value$$31 = holder$$1[key$$17]
      }
      var v198 = value$$31;
      if (v198) {
        v198 = typeof value$$31 === "object";
      }
      if (v198) {
        for (k$$1 in value$$31) {
          var v199 = Object.hasOwnProperty;
          if (JAM.call(v199.call, v199, [value$$31, k$$1])) {
            v$$1 = walk(value$$31, k$$1);
            if (v$$1 !== undefined) {
              JAM.set(value$$31, k$$1, v$$1);
            } else {
              introspect(JAM.policy.p1) {
                delete value$$31[k$$1];
              }
      ...
      return JAM.call(reviver.call, reviver, [holder$$1, key$$17, value$$31]);
    }
    var j;
    cx.lastIndex = 0;
    if (cx.test(text$$7)) {
  ...
  function v3(value$$30, replacer, space) {
    var i$$3;
    gap = "";
    indent = "";
  ...
  function str$$6(key$$14, holder) {
    ...
    var v348 = value$$29;
    if (v348) {
      v348 = typeof value$$29 === "object";
    }
    var v215 = v348;
    if (v215) {
      v215 = typeof value$$29.toJSON === "function";
    }
    if (v215) {
      value$$29 = JAM.call(value$$29.toJSON, value$$29, [key$$14]);
    }
    if (typeof rep === "function") {
      value$$29 = JAM.call(rep.call, rep, [holder, key$$14, value$$29]);
    }
    switch(typeof value$$29) {
      case "string":
        return quote(value$$29);
      case "number":
        var v28;
      ...
      case "object":
        ...
        if (JAM.call(JAM.get(v350, "apply", JAM.policy.p1), v350, [value$$29]) === "[object Array]") {
          length$$11 = JAM.get(value$$29, "length", JAM.policy.p1);
          i$$2 = 0;
          var v32 = i$$2 < length$$11;
          for (;v32;) {
            var v30 = partial;
            var v31 = i$$2;
            var v219 = str$$6(i$$2, value$$29);
            if (!v219) {
              v219 = "null";
            }
            introspect(JAM.policy.p1) {
        ...
        if (v222) {
          ...
          for (k in value$$29) {
            ...
            if (JAM.call(JAM.get(v225, "call", JAM.policy.p1), v225, [value$$29, k])) {
              v = str$$6(k, value$$29);
              if (v) {
                var v358 = quote(k);
                var v426;
...
function resultLine(labelWidth, indent$$1, label$$2, meanWidth$$1, mean$$3, stdErr$$2) {
  var result$$3 = "";
  i = 0;
  var v100 = i < indent$$1;
  for (;v100;) {
  ...
  if (label$$2 in explanations) {
    introspect(JAM.policy.p1) {
      var v457 = explanations[label$$2]
    }
    result$$3 = result$$3 + ("<a href='" + v457 + "'>" + label$$2 + "</a>: ");
  } else {
    result$$3 = result$$3 + (label$$2 + ": ");
  }
  i = 0;
  var v102 = i < labelWidth - (label$$2.length + indent$$1);
  for (;v102;) {
    result$$3 = result$$3 + " ";
    i = i + 1;
    v102 = i < labelWidth - (label$$2.length + indent$$1);
  }
...
function sunspiderCompareResults(output1, output2$$1) {
  ...
  function resultLine$$1(labelWidth$$2, indent$$2, label$$3, meanWidth1, mean1$$1, stdErr1$$1, meanWidth2, mean2$$1, stdErr2$$1) {
    result = pad("", indent$$2);
