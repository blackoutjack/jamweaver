...
function v152() {
  ...
  for (;v177;) {
    ...
    for (;v176;) {
      var gray$$1 = JAM.call(qrcode.getPixel, qrcode, [x$$61, y$$43], JAM.policy.p37);
...
function v149(th) {
  ...
  for (;v210;) {
    ...
    for (;v209;) {
      var gray = JAM.call(qrcode.getPixel, qrcode, [x$$60, y$$42], JAM.policy.p37);
...
function v127(image$$3, dimension, transform) {
  ...
  for (;v339;) {
    ...
    try {
      ...
      var v338 = x$$48 < max;
      for (;v338;) {
        var xpoint = JAM.call(Math.floor, Math, [points$$1[x$$48]], JAM.policy.p36) * 4 + JAM.call(Math.floor, Math, [points$$1[x$$48 + 1]], JAM.policy.p36) * qrcode.width * 4;
        var bit = image$$3[JAM.call(Math.floor, Math, [points$$1[x$$48]], JAM.policy.p36) + qrcode.width * JAM.call(Math.floor, Math, [points$$1[x$$48 + 1]], JAM.policy.p36)];
...
function v126(image$$2, points) {
  ...
  var v349 = v1204;
  for (;v349;) {
    var x$$47 = JAM.call(Math.floor, Math, [points[offset$$8]], JAM.policy.p36);
    var y$$30 = JAM.call(Math.floor, Math, [points[offset$$8 + 1]], JAM.policy.p36);
    var v2539 = x$$47 < -1;
    if (!v2539) {
      v2539 = x$$47 > width$$9;
    }
  ...
  var v360 = v1208;
  for (;v360;) {
    x$$47 = JAM.call(Math.floor, Math, [points[offset$$8]], JAM.policy.p36);
    y$$30 = JAM.call(Math.floor, Math, [points[offset$$8 + 1]], JAM.policy.p36);
    var v2541 = x$$47 < -1;
    if (!v2541) {
      v2541 = x$$47 > width$$9;
    }
...
function BitMatrix(width$$10, height$$9) {
  ...
  function v39(x$$55, y$$38) {
    ...
    var v557 = this.bits;
    v557[offset$$11] = v557[offset$$11] ^ 1 << (x$$55 & 31);
    return;
  }
  function v38(x$$54, y$$37) {
    var offset$$10 = y$$37 * this.rowSize + (x$$54 >> 5);
    var v560 = this.bits;
    v560[offset$$10] = v560[offset$$10] | 1 << (x$$54 & 31);
    return;
  }
...
function FinderPatternFinder() {
  ...
  function v101() {
    ...
    if (startSize > 3) {
      ...
      for (;v828;) {
        ...
        if (JAM.call(Math.abs, Math, [pattern$$2.EstimatedModuleSize - average], JAM.policy.p36) > .2 * average) {
  ...
  function v95(stateCount) {
    ...
    var v2652 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[0] << INTEGER_MATH_SHIFT)], JAM.policy.p36) < maxVariance;
    if (v2652) {
      v2652 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[1] << INTEGER_MATH_SHIFT)], JAM.policy.p36) < maxVariance;
    }
    var v2446 = v2652;
    if (v2446) {
      v2446 = JAM.call(Math.abs, Math, [3 * moduleSize$$3 - (stateCount[2] << INTEGER_MATH_SHIFT)], JAM.policy.p36) < 3 * maxVariance;
    }
    var v1742 = v2446;
    if (v1742) {
      v1742 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[3] << INTEGER_MATH_SHIFT)], JAM.policy.p36) < maxVariance;
    }
    var v891 = v1742;
    if (v891) {
      v891 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[4] << INTEGER_MATH_SHIFT)], JAM.policy.p36) < maxVariance;
    }
    return v891;
  }
  function v94() {
...
function QRCodeDataBlockReader(blocks, version$$8, numErrorCorrectionCode) {
  function v123() {
    ...
    do {
      ...
      dataLength = JAM.call(this.getDataLength, this, [mode$$7], JAM.policy.p36);
      if (dataLength < 1) {
