...
function v484($$$4, undefined$$5) {
  ...
  function v480() {
    function v479(i$$110) {
      ...
      JAM.call(JAM.get(v512, v2506, JAM.policy.p3), v512, [_set, o$$2.animate]);
      if (that$$3.options.range === true) {
        if (that$$3.orientation === "horizontal") {
          if (i$$110 === 0) {
            ...
            JAM.call(JAM.get(v515, v2510, JAM.policy.p3), v515, [{left:valPercent + "%"}, o$$2.animate]);
          }
          if (i$$110 === 1) {
            ...
            JAM.call(JAM.get(v520, v2512, JAM.policy.p3), v520, [{width:valPercent - lastValPercent + "%"}, {queue:false, duration:o$$2.animate}]);
          }
        } else {
          if (i$$110 === 0) {
            ...
            JAM.call(JAM.get(v525, v2516, JAM.policy.p3), v525, [{bottom:valPercent + "%"}, o$$2.animate]);
          }
          if (i$$110 === 1) {
            ...
            JAM.call(JAM.get(v530, v2518, JAM.policy.p3), v530, [{height:valPercent - lastValPercent + "%"}, {queue:false, duration:o$$2.animate}]);
          }
        }
      }
    ...
    if (v2522) {
      ...
      JAM.set(_set, v2525, valPercent + "%", JAM.policy.p2);
      ...
      JAM.call(JAM.get(v544, v2527, JAM.policy.p3), v544, [_set, o$$2.animate]);
      ...
      if (v2528) {
        ...
        JAM.call(JAM.get(v547, v2530, JAM.policy.p3), v547, [{width:valPercent + "%"}, o$$2.animate]);
      }
      ...
      if (v2532) {
        ...
        JAM.call(JAM.get(v552, v2533, JAM.policy.p3), v552, [{width:100 - valPercent + "%"}, {queue:false, duration:o$$2.animate}]);
      }
      ...
      if (v2536) {
        ...
        JAM.call(JAM.get(v557, v2538, JAM.policy.p3), v557, [{height:valPercent + "%"}, o$$2.animate]);
      }
      ...
      if (v2540) {
        ...
        JAM.call(JAM.get(v562, v2541, JAM.policy.p3), v562, [{height:100 - valPercent + "%"}, {queue:false, duration:o$$2.animate}]);
      }
    }
    return;
  }
  ...
  function v472(index$$45, newValue$$1) {
    ...
    if (arguments.length > 1) {
      ...
      JAM.set(v599, v600, v5542, JAM.policy.p2);
      this._refreshValue();
...
function v434($$$2, undefined$$3) {
  ...
  function v430(type$$67, event$$17, data$$44) {
    ...
    if (v3914) {
      v3914 = JAM.call(callback$$42.apply, callback$$42, [this.element[0], [event$$17].concat(data$$44)]) === false;
    }
    var v2685 = v3914;
    if (!v2685) {
  ...
  function v429(element$$12) {
    ...
    var v5559 = JAM.call(v776.add, v776, [element$$12]);
  ...
  function v426(element$$11) {
    ...
    var v5560 = JAM.call(v780.add, v780, [element$$11]);
  ...
  function v421(suppressDisabledCheck, element$$9, handlers$$2) {
    ...
    if (!handlers$$2) {
      ...
      var v5561 = JAM.call(v794.add, v794, [element$$9]);
      this.bindings = v5561;
    }
  ...
  function v417(key$$25, value$$51) {
    ...
    if (key$$25 === "disabled") {
      ...
      var v797 = JAM.call(v2699.toggleClass, v2699, [this.widgetFullName + "-disabled ui-state-disabled", !!value$$51]);
  ...
  function v415(key$$23, value$$50) {
    ...
    if (typeof key$$23 === "string") {
      ...
      if (parts$$4.length) {
        ...
        curOption = JAM.set(v805, v806, v5562, JAM.policy.p2);
        i$$103 = 0;
        ...
        for (;v809;) {
          ...
          JAM.set(curOption, v807, v2707, JAM.policy.p2);
          introspect(JAM.policy.p3) {
  ...
  function v412(options$$10, element$$8) {
    ...
    element$$8 = JAM.call($$$2, null, [v3937])[0];
    var v5563 = JAM.call($$$2, null, [element$$8]);
    this.element = v5563;
    this.uuid = uuid$$2;
    uuid$$2 = uuid$$2 + 1;
    ...
    if (element$$8 !== this) {
      ...
      var v2720;
      if (element$$8.style) {
        v2720 = element$$8.ownerDocument;
      } else {
        var v3938 = element$$8.document;
        if (!v3938) {
          v3938 = element$$8;
        }
        v2720 = v3938;
      ...
      this.document = v5568;
      var v2721 = this.document[0].defaultView;
      if (!v2721) {
        v2721 = this.document[0].parentWindow;
      }
      ...
      for (key$$22 in v856) {
        ...
        if (v2734) {
          if (JAM.call($$$2.isPlainObject, $$$2, [value$$49])) {
            ...
            var v2735;
            introspect(JAM.policy.p3) {
              var v4770 = target$$40[key$$22]
            }
            if (JAM.call($$$2.isPlainObject, $$$2, [v4770])) {
              var v3953 = $$$2.widget;
              introspect(JAM.policy.p3) {
                var v3954 = target$$40[key$$22]
              }
              v2735 = JAM.call(v3953.extend, v3953, [{}, v3954, value$$49]);
            } else {
              var v3955 = $$$2.widget;
              v2735 = JAM.call(v3955.extend, v3955, [{}, value$$49]);
            }
            JAM.set(v852, v853, v2735, JAM.policy.p2);
          } else {
  ...
  function v404(name$$62, base$$1, prototype) {
    ...
    function v402(prop$$8, value$$48) {
      ...
      var v5570 = v401();
      JAM.set(proxiedPrototype, prop$$8, v5570, JAM.policy.p2);
      return;
    }
    ...
    constructor = JAM.set(v874, name$$62, v399, JAM.policy.p2);
...
function v396($$$1, undefined$$2) {
  ...
  function v394(instance, name$$61, args$$8) {
    ...
    var v3961 = !set$$10;
    if (!v3961) {
      v3961 = !instance.element[0].parentNode;
    }
    var v2763 = v3961;
    if (!v2763) {
      v2763 = instance.element[0].parentNode.nodeType === 11;
    }
    if (v2763) {
      return;
    }
  ...
  function v393(module, option$$1, set$$9) {
    ...
    for (i$$99 in set$$9) {
      ...
      JAM.set(v900, i$$99, v2770, JAM.policy.p2);
  ...
  function focusable(element$$3, isTabIndexNotNaN) {
    ...
    if (/input|select|textarea|button|object/.test(nodeName$$1)) {
      v2815 = !element$$3.disabled;
    } else {
      var v3995;
      if ("a" === nodeName$$1) {
        var v4793 = element$$3.href;
        if (!v4793) {
  ...
  function visible(element$$4) {
    ...
    var v954 = JAM.call(v2816.visible, v2816, [element$$4]);
    if (v954) {
      var v4795 = JAM.call($$$1, null, [element$$4]).parents().addBack();
...
function v363(window$$1, undefined$$1) {
  ...
  function v352() {
    ...
    var v4032 = v999.top;
    var v4829 = parseFloat(JAM.call(jQuery$$1.curCSS, jQuery$$1, [offsetParent$$1[0], "borderTopWidth", true]));
    if (!v4829) {
      v4829 = 0;
    }
    ...
    var v4830 = parseFloat(JAM.call(jQuery$$1.curCSS, jQuery$$1, [offsetParent$$1[0], "borderLeftWidth", true]));
    if (!v4830) {
      v4830 = 0;
    }
  ...
  function v346(options$$5) {
    ...
    var top$$2 = v2909 + v4071 - clientTop;
    var v2911 = box.left;
    ...
    var left$$5 = v2911 + v4072 - clientLeft;
  ...
  function v342(fx$$1) {
    ...
    if (v2914) {
      ...
      JAM.set(v1050, v1051, v4075 + fx$$1.unit, JAM.policy.p2);
    } else {
  ...
  function v338(gotoEnd$$2) {
    ...
    if (v2922) {
      ...
      var v5574 = JAM.call(JAM.get(v1084, specialEasing || defaultEasing, JAM.policy.p3), v1084, [this.state, n$$5, 0, 1, this.options.duration]);
      this.pos = v5574;
  ...
  function v337() {
    ...
    JAM.set(v1091, v1092, v5575, JAM.policy.p2);
  ...
  function v336() {
    ...
    JAM.set(v1095, v1096, v5576, JAM.policy.p2);
  ...
  function v323(prop$$6, speed$$3, easing, callback$$40) {
    function v322() {
      function v321(name$$56, val$$6) {
        ...
        if (rfxtypes.test(val$$6)) {
          ...
          JAM.call(JAM.get(e$$30, v2981, JAM.policy.p3), e$$30, [prop$$6]);
        } else {
      ...
      for (p in prop$$6) {
        ...
        if (JAM.call(jQuery$$1.isArray, jQuery$$1, [v2992])) {
          ...
          JAM.set(v1149, p, v2994[1], JAM.policy.p2);
          introspect(JAM.policy.p3) {
            var v1150 = prop$$6[p]
          }
    ...
    return JAM.call(JAM.get(this, v2996, JAM.policy.p3), this, [v322]);
  }
  ...
  function v319(fn$$15, fn2) {
    function v318() {
      ...
      JAM.call(JAM.get(v1161, v2999, JAM.policy.p3), v1161, []);
      return;
    }
  ...
  function v307(origSettings) {
    ...
    if (v1274) {
      var v4182 = parts$$2[1];
      if (v4182) {
        v4182 = parts$$2[1] !== location.protocol;
      }
      var v3071 = v4182;
      if (!v3071) {
        v3071 = parts$$2[2] !== location.host;
      }
      v1274 = v3071;
    }
    var remote = v1274;
  ...
  function v277(elem$$107, name$$51, value$$45) {
    var v4218 = !elem$$107;
    if (!v4218) {
    ...
    if (set$$8) {
      JAM.set(style, name$$51, value$$45, JAM.policy.p2);
    }
    introspect(JAM.policy.p3) {
      return style[name$$51];
    }
  }
  function v276(name$$49, value$$43) {
    function v275(elem$$106, name$$50, value$$44) {
      if (value$$44 === undefined$$1) {
        return JAM.call(jQuery$$1.curCSS, jQuery$$1, [elem$$106, name$$50]);
      }
      var v3141 = typeof value$$44 === "number";
      if (v3141) {
      ...
      JAM.call(jQuery$$1.style, jQuery$$1, [elem$$106, name$$50, value$$44]);
      return;
    }
    return access(this, name$$49, value$$43, true, v275);
  }
  ...
  function v273(elems$$8, context$$15, fragment$$3, scripts$$2) {
    ...
    if (typeof context$$15.createElement === "undefined") {
      ...
      if (!v3145) {
        ...
        if (v4233) {
          v4233 = context$$15[0].ownerDocument;
        }
        v3145 = v4233;
      }
      var v1387 = v3145;
  ...
  function v270(args$$6, table, callback$$30) {
    function v269(i$$78) {
      ...
      var v5583 = JAM.call(value$$42.call, value$$42, [this, i$$78, v4257]);
      v1426[0] = v5583;
    ...
    function root$$3(elem$$103, cur$$7) {
      ...
      if (JAM.call(jQuery$$1.nodeName, jQuery$$1, [elem$$103, "table"])) {
        var v3176 = elem$$103.getElementsByTagName("tbody")[0];
        if (!v3176) {
    ...
    var v4261 = v4962;
    if (v4261) {
      v4261 = typeof value$$42 === "string";
    }
    var v3178 = v4261;
    if (v3178) {
      v3178 = rchecked.test(value$$42);
    }
    if (v3178) {
  ...
  function v266(value$$41) {
    function v265() {
      ...
      if (next) {
        ...
        JAM.call(v1441.before, v1441, [value$$41]);
      } else {
        var v1442 = jQuery$$1(parent$$6);
        JAM.call(v1442.append, v1442, [value$$41]);
      }
      return;
    }
    function v264(i$$76) {
    ...
    if (v3183) {
      ...
      return JAM.call(this.pushStack, this, [jQuery$$1(v4269), "replaceWith", value$$41]);
    }
    return;
  }
  function v263(value$$40) {
    ...
    if (value$$40 === undefined$$1) {
      ...
      var v4270 = this[0];
      if (v4270) {
        v4270 = this[0].nodeType === 1;
      }
      if (v4270) {
        v1450 = this[0].innerHTML.replace(rinlinejQuery, "");
      } else {
        v1450 = null;
      }
      return v1450;
    } else {
      var v4970 = typeof value$$40 === "string";
      if (v4970) {
        v4970 = !rnocache.test(value$$40);
      }
      var v4272 = v4970;
      if (v4272) {
        var v4971 = jQuery$$1.support.leadingWhitespace;
        if (!v4971) {
          v4971 = !rleadingWhitespace.test(value$$40);
        }
        v4272 = v4971;
      }
      var v3188 = v4272;
      if (v3188) {
        var v4972 = wrapMap;
        var v5495 = rtagName.exec(value$$40);
        if (!v5495) {
          v5495 = ["", ""];
        }
        var v4973 = v5495[1].toLowerCase();
        introspect(JAM.policy.p3) {
      ...
      if (v3188) {
        ...
        try {
          ...
          for (;v1454;) {
            ...
            if (v4274.nodeType === 1) {
              ...
              JAM.set(v1452, "innerHTML", value$$40);
            }
            i$$74 = i$$74 + 1;
            v1454 = i$$74 < l$$20;
          }
        ...
        if (JAM.call(jQuery$$1.isFunction, jQuery$$1, [value$$40])) {
          ...
          JAM.call(v1456.append, v1456, [value$$40]);
        }
      }
    }
    return this;
  ...
  function v256() {
    ...
    if (v3200) {
      ...
      if (arguments.length) {
        ...
        JAM.call(v1481.apply, v1481, [set$$7, jQuery$$1(arguments[0]).toArray()]);
        return set$$7;
      }
    }
    return;
  ...
  function v241(html) {
    ...
    if (this[0]) {
      var v3209 = jQuery$$1(html, this[0].ownerDocument);
  ...
  function v217(selector$$15, context$$14) {
    ...
    var v3231;
    var v4994 = isDisconnected(set$$5[0]);
    if (!v4994) {
      v4994 = isDisconnected(all$$4[0]);
    }
    if (v4994) {
      v3231 = all$$4;
    } else {
      ...
      if (v3238) {
        ...
        for (;v1546;) {
          ...
          if (!v3239) {
            ...
            JAM.set(v1543, v1544, v3240, JAM.policy.p2);
          }
          i$$64 = i$$64 + 1;
          v1546 = i$$64 < l$$19;
        }
  ...
  function v207() {
    ...
    function v197() {
      ...
      function v195(match$$31, context$$8, isXML$$9) {
        ...
        if (v3267) {
          ...
          if (m$$2) {
            var v3268;
            var v5006 = m$$2.id === match$$31[1];
            if (!v5006) {
              var v5315 = typeof m$$2.getAttributeNode !== "undefined";
              if (v5315) {
                v5315 = m$$2.getAttributeNode("id").nodeValue === match$$31[1];
              }
              v5006 = v5315;
            }
            if (v5006) {
    ...
    function v188(elem$$71, match$$29) {
      ...
      if (v3284) {
        ...
        v1625 = JAM.call(JAM.get(v3282, name$$45, JAM.policy.p3), v3282, [elem$$71]);
      } else {
        var v3283;
        introspect(JAM.policy.p3) {
      ...
      if (result$$4 == null) {
        ...
        var v3285;
        if (type$$57 === "=") {
          v3285 = value$$39 === check;
        } else {
          var v4355;
          if (type$$57 === "*=") {
            v4355 = value$$39.indexOf(check) >= 0;
          } else {
            var v5009;
            if (type$$57 === "~=") {
              v5009 = (" " + value$$39 + " ").indexOf(check) >= 0;
            } else {
              var v5318;
              if (!check) {
                var v5450 = value$$39;
                ...
                var v5451;
                if (type$$57 === "!=") {
                  v5451 = value$$39 !== check;
                } else {
                  var v5499;
                  if (type$$57 === "^=") {
                    v5499 = value$$39.indexOf(check) === 0;
                  } else {
                    var v5515;
                    if (type$$57 === "$=") {
                      v5515 = value$$39.substr(value$$39.length - check.length) === check;
                    } else {
                      var v5526;
                      if (type$$57 === "|=") {
                        var v5530 = value$$39 === check;
                        if (!v5530) {
                          v5530 = value$$39.substr(0, check.length + 1) === check + "-";
                        }
                        v5526 = v5530;
                      } else {
                        v5526 = false;
    ...
    function v184(elem$$67, match$$25) {
      ...
      switch(type$$56) {
        ...
        case "nth":
          ...
          var v3296 = parent$$4;
          if (v3296) {
            var v4360 = parent$$4.sizcache !== doneName$$4;
            if (!v4360) {
              v4360 = !elem$$67.nodeIndex;
            }
            v3296 = v4360;
          }
          if (v3296) {
          ...
          if (first$$2 === 0) {
            ...
            var v1639 = diff % first$$2 === 0;
            if (v1639) {
              v1639 = diff / first$$2 >= 0;
            }
            return v1639;
          }
        ;
    ...
    function v183(elem$$66, match$$24, i$$54, array$$13) {
      ...
      if (filter$$1) {
        ...
        if (name$$44 === "contains") {
          ...
          return v4361.indexOf(match$$24[3]) >= 0;
        } else {
          if (name$$44 === "not") {
    ...
    function v155(match$$16, curLoop$$4, inplace$$3, result$$3, not$$3) {
      if (match$$16[1] === "not") {
        var v5324 = chunker.exec(match$$16[3]);
        if (!v5324) {
          v5324 = "";
        }
        var v3316 = v5324.length > 1;
        if (!v3316) {
          v3316 = /^\w/.test(match$$16[3]);
        }
        if (v3316) {
          var v1673 = match$$16;
          var v5584 = JAM.call(Sizzle, null, [match$$16[3], null, null, curLoop$$4]);
          v1673[3] = v5584;
        } else {
        ...
        var v3318 = Expr.match.POS.test(match$$16[0]);
        if (!v3318) {
          v3318 = Expr.match.CHILD.test(match$$16[0]);
        }
        if (v3318) {
          return true;
        }
    ...
    function v153(match$$14) {
      if (match$$14[1] === "nth") {
        var v5325 = match$$14[2] === "even";
        if (v5325) {
          v5325 = "2n";
        }
        var v5021 = v5325;
        if (!v5021) {
          var v5326 = match$$14[2] === "odd";
          if (v5326) {
            v5326 = "2n+1";
          }
          v5021 = v5326;
    ...
    function v148(match$$9, context$$6) {
      if (typeof context$$6.getElementsByName !== "undefined") {
        ...
        for (;v1700;) {
          ...
          if (v4379.getAttribute("name") === match$$9[1]) {
            introspect(JAM.policy.p3) {
        ...
        for (type$$55 in Expr.filter) {
          ...
          if (v3348) {
            ...
            if (v1730) {
              ...
              match$$7 = JAM.call(JAM.get(v1727, type$$55, JAM.policy.p3), v1727, [match$$7, curLoop, inplace, result, not, isXMLFilter]);
              if (!match$$7) {
                anyFound = found = true;
              } else {
                if (match$$7 === true) {
      ...
      for (;v1752;) {
        ...
        if (match$$6 = v3357.exec(expr$$4)) {
          ...
          if (left$$2.substr(left$$2.length - 1) !== "\\") {
            ...
            v1746[1] = v5585;
            var v1747 = Expr.find;
            set$$3 = JAM.call(JAM.get(v1747, type$$54, JAM.policy.p3), v1747, [match$$6, context$$4, isXML$$3]);
            if (set$$3 != null) {
    ...
    function Sizzle(selector$$8, context$$3, results$$1, seed) {
      ...
      if (v3378) {
        ...
        var v4411 = v5034;
        if (v4411) {
          v4411 = Expr.match.ID.test(parts$$1[0]);
        }
        var v3387 = v4411;
        if (v3387) {
        ...
        if (v3387) {
          ...
          var v1778;
          if (ret$$9.expr) {
            v1778 = JAM.call(Sizzle.filter, Sizzle, [ret$$9.expr, ret$$9.set])[0];
          } else {
            v1778 = ret$$9.set[0];
          }
          context$$3 = v1778;
        ...
        if (context$$3) {
          ...
          for (;v1786;) {
            ...
            JAM.call(JAM.get(v1785, cur$$2, JAM.policy.p3), v1785, [checkSet$$2, pop, contextXML]);
    ...
    for (type$$53 in Expr.match) {
      ...
      JAM.set(v1830, v1831, v5586, JAM.policy.p2);
      ...
      JAM.set(v1832, v1833, v5587, JAM.policy.p2);
    }
    try {
      var v4431 = Array.prototype.slice;
      JAM.call(v4431.call, v4431, [document$$1.documentElement.childNodes, 0])[0].nodeType;
    } catch (e$$20) {
      makeArray = v191;
    }
    var sortOrder;
  ...
  function v126(type$$51, data$$36) {
    if (this[0]) {
      ...
      JAM.call(v1876.trigger, v1876, [event$$8, data$$36, this[0]]);
    ...
    function v119(type$$48, data$$33, fn$$7) {
      ...
      if (typeof type$$48 === "object") {
        ...
        for (key$$18 in type$$48) {
          ...
          JAM.call(JAM.get(this, name$$40, JAM.policy.p3), this, [key$$18, data$$33, v1887, fn$$7]);
        }
        return this;
      }
  ...
  function testChange$$1(e$$14) {
    ...
    if (v3457) {
      ...
      return JAM.call(v1912.trigger, v1912, [e$$14, arguments[1], elem$$29]);
    }
    return;
  }
  ...
  function v87(event$$2, data$$26, elem$$22) {
    ...
    if (v3510) {
      ...
      if (!event$$2.isDefaultPrevented()) {
        ...
        var old;
        var v1998 = JAM.call(jQuery$$1.nodeName, jQuery$$1, [target$$38, "a"]);
        if (v1998) {
          v1998 = type$$38 === "click";
        }
        var isClick = v1998;
        ...
        if (v3514) {
          var v5364 = target$$38;
          if (v5364) {
            v5364 = target$$38.nodeName;
          }
          var v5085 = v5364;
          if (v5085) {
            var v5365 = jQuery$$1.noData;
            var v5366 = target$$38.nodeName.toLowerCase();
            introspect(JAM.policy.p3) {
              v5085 = v5365[v5366];
            }
          }
  ...
  function v82(elem$$19, name$$39, value$$38, pass$$1) {
    var v4540 = !elem$$19;
    if (!v4540) {
    ...
    if (v3554) {
      ...
      return JAM.call(JAM.get(v2065, name$$39, JAM.policy.p3), v2065, [value$$38]);
    }
    ...
    if (elem$$19.nodeType === 1) {
      ...
      if (v3562) {
        if (set) {
          ...
          JAM.set(elem$$19, name$$39, value$$38, JAM.policy.p2);
        }
      ...
      if (set) {
        JAM.call(elem$$19.setAttribute, elem$$19, [name$$39, "" + value$$38]);
      }
      var v2080;
    ...
    return JAM.call(jQuery$$1.style, jQuery$$1, [elem$$19, name$$39, value$$38]);
  }
    ...
    function v76() {
      if (type$$35 === "string") {
        ...
        for (;v2111;) {
          ...
          JAM.call(JAM.get(self$$4, v3583, JAM.policy.p3), self$$4, [className$$2]);
          var v3584 = i$$20;
          i$$20 = i$$20 + 1;
  ...
  function v74(value$$35) {
    ...
    var v4563 = value$$35;
    if (v4563) {
      v4563 = typeof value$$35 === "string";
    }
    var v3590 = v4563;
    if (!v3590) {
      v3590 = value$$35 === undefined$$1;
    }
    if (v3590) {
  ...
  function v68(name$$37, value$$33) {
    return access(this, name$$37, value$$33, true, jQuery$$1.attr);
  }
  ...
  function v54(key$$16, value$$32) {
    ...
    if (value$$32 === undefined$$1) {
      ...
      if (v4577) {
        v2164 = JAM.call(this.data, this, [parts[0]]);
      } else {
        v2164 = data$$22;
      }
      return v2164;
    } else {
      var v2165 = JAM.call(this.trigger, this, ["setData" + parts[1] + "!", [parts[0], value$$32]]);
  ...
  function v50(elem$$10, name$$35, data$$21) {
    ...
    if (typeof name$$35 === "object") {
      ...
      thisCache = JAM.set(v2178, v2179, v5594, JAM.policy.p2);
    } else {
      introspect(JAM.policy.p3) {
  ...
  function v49() {
    ...
    var v3639 = div.getElementsByTagName("input")[0].value === "on";
  ...
  function v41(elems$$4, callback$$29, arg$$2) {
    ...
    for (;v2220;) {
      ...
      value$$31 = JAM.call(callback$$29, null, [v2217, i$$13, arg$$2]);
      if (value$$31 != null) {
  ...
  function v39(first$$1, second) {
    ...
    if (typeof second.length === "number") {
      ...
      for (;v2226;) {
        var v2225 = i$$11;
        i$$11 = i$$11 + 1;
        JAM.set(first$$1, v2225, second[j$$1], JAM.policy.p2);
        j$$1 = j$$1 + 1;
        v2226 = j$$1 < l$$1;
      }
    } else {
      ...
      for (;v2228;) {
        ...
        var v3660 = j$$1;
        j$$1 = j$$1 + 1;
        JAM.set(first$$1, v2227, second[v3660], JAM.policy.p2);
        introspect(JAM.policy.p3) {
  ...
  function v35(object, callback$$27, args$$4) {
    ...
    if (args$$4) {
      ...
      if (isObj) {
        ...
        if (v3668) {
          v3668 = JAM.call(callback$$27.call, callback$$27, [value$$30, i$$9, value$$30]) !== false;
        }
        var v2241 = v3668;
        for (;v2241;) {
          ...
          if (v3670) {
            v3670 = JAM.call(callback$$27.call, callback$$27, [value$$30, i$$9, value$$30]) !== false;
          }
          v2241 = v3670;
        }
      }
  ...
  function v33(data$$20) {
    ...
    if (v3673) {
      var v2243 = document$$1.getElementsByTagName("head")[0];
      if (!v2243) {
  ...
  function v22() {
    ...
    var v3695 = typeof target$$37 !== "object";
    if (v3695) {
      v3695 = !JAM.call(jQuery$$1.isFunction, jQuery$$1, [target$$37]);
    }
    if (v3695) {
      target$$37 = {};
    }
      ...
      if (v3696 != null) {
        for (name$$31 in options$$1) {
          ...
          if (v3697) {
            ...
            JAM.set(v2277, v2278, v5597, JAM.policy.p2);
          } else {
            if (copy !== undefined$$1) {
              JAM.set(target$$37, name$$31, copy, JAM.policy.p2);
            }
          }
        }
      }
  ...
  function v11(num$$5) {
    ...
    if (num$$5 == null) {
      ...
      var v3707;
      if (num$$5 < 0) {
        v3707 = JAM.call(this.slice, this, [num$$5])[0];
      } else {
        introspect(JAM.policy.p3) {
          v3707 = this[num$$5];
        }
  ...
  function access(elems, key$$14, value$$29, exec, fn, pass) {
    ...
    if (typeof key$$14 === "object") {
      ...
      for (k in key$$14) {
        ...
        access(elems, k, v2338, exec, fn, value$$29);
      }
      return elems;
    }
    if (value$$29 !== undefined$$1) {
      ...
      var v2340 = v3736;
      if (v2340) {
        v2340 = JAM.call(jQuery$$1.isFunction, jQuery$$1, [value$$29]);
      }
      exec = v2340;
      var i$$2 = 0;
      ...
      for (;v2343;) {
        ...
        if (exec) {
          ...
          v3737 = JAM.call(value$$29.call, value$$29, [v4650, i$$2, JAM.call(fn, null, [v5146, key$$14])]);
        } else {
          v3737 = value$$29;
        }
    ...
    var v2345;
    if (length$$11) {
      v2345 = JAM.call(fn, null, [elems[0], key$$14]);
    } else {
      v2345 = undefined$$1;
    }
    return v2345;
      ...
      for (;v2363;) {
        ...
        if (v4656.selector === handleObj.selector) {
          ...
          if (v3749) {
            ...
            related = JAM.call(v3750.closest, v3750, [handleObj.selector])[0];
          }
          var v3752 = !related;
          if (!v3752) {
  ...
  function buildFragment(args$$2, nodes, scripts) {
    ...
    if (v4670) {
      var v3765 = nodes[0].ownerDocument;
      if (!v3765) {
        v3765 = nodes[0];
      }
      v2378 = v3765;
    ...
    if (v5479) {
      v5479 = typeof args$$2[0] === "string";
    }
    var v5395 = v5479;
    if (v5395) {
      v5395 = args$$2[0].length < 512;
    }
    var v5154 = v5395;
    if (v5154) {
    ...
    var v4673 = v5154;
    if (v4673) {
      v4673 = !rnocache.test(args$$2[0]);
    }
    var v3767 = v4673;
    if (v3767) {
      var v4674 = jQuery$$1.support.checkClone;
      if (!v4674) {
        v4674 = !rchecked.test(args$$2[0]);
      }
      v3767 = v4674;
    }
    if (v3767) {
    ...
    if (cacheable) {
      ...
      JAM.set(v2384, v2385, v3768, JAM.policy.p2);
    }
