...
function v29(runner$$2) {
  ...
  function RunNextBenchmark() {
    ...
    if (data$$20 == null) {
      ...
      v33 = JAM.call(RunNextBenchmark, null, [], JAM.policy.p1);
    }
    return v33;
  }
...
function v17() {
  ...
  var v106 = Math;
  var v299 = JAM.call(v16, null, [], JAM.policy.p1);
  v106.random = v299;
  return;
}
function v14(s$$2) {
...
function runCodeLoadClosure() {
  JAM.call(runClosure, null, [], JAM.policy.p1);
  salt = salt + 1;
  return;
}
function runCodeLoadJQuery() {
  JAM.call(runJQuery, null, [], JAM.policy.p1);
  salt = salt + 1;
  return;
}
...
function cacheBust(str$$6, old) {
  ...
  var hash$$1 = JAM.call(Math.abs, Math, [JAM.call(jenkinsHash, null, [keys, keys.length], JAM.policy.p1)], JAM.policy.p1);
  var replacement = old + JAM.call(hash$$1.toString, hash$$1, [36], JAM.policy.p1);
  return JAM.call(str$$6.replace, str$$6, [JAM.new(RegExp, [old, "g"], JAM.policy.p1), replacement], JAM.policy.p1);
}
function runClosure() {
  var src$$inline_0 = "var googsalt=" + salt + ";" + BASE_JS + "(function(){return goog.cloneObject(googsalt);})();";
  src$$inline_0 = JAM.call(cacheBust, null, [src$$inline_0, "goog"], JAM.policy.p1);
  var result$$inline_1 = JAM.call(indirectEval, null, [src$$inline_0], JAM.policy.p1);
  if (result$$inline_1 != salt) {
    throw JAM.new(Error, ["Incorrect result: " + result$$inline_1], JAM.policy.p1);
  }
  return;
}
function MockElement() {
  ...
  function v5(a$$2) {
    return JAM.new(MockElement, [], JAM.policy.p1);
  }
  function v4() {
    return JAM.new(MockElement, [], JAM.policy.p1);
  }
...
function runJQuery() {
  ...
  src$$inline_3 = JAM.call(cacheBust, null, [src$$inline_3, "jQuery"], JAM.policy.p1);
  var result$$inline_4 = JAM.call(indirectEval, null, [src$$inline_3], JAM.policy.p1);
  if (result$$inline_4 != salt) {
    throw JAM.new(Error, ["Incorrect result: " + result$$inline_4], JAM.policy.p1);
  }
  return;
}
...
function CheckCompatibility() {
  ...
  var v147 = v249;
  if (v147) {
    v147 = typeof JAM.new(Uint8Array, [0], JAM.policy.p1).subarray != "undefined";
  }
...
var v300 = JAM.call(v12, null, [], JAM.policy.p1);
v152.now = v300;
...
var CodeLoad = JAM.new(BenchmarkSuite, ["CodeLoad", [45E4], [JAM.new(Benchmark, ["CodeLoadClosure", false, false, 1600, runCodeLoadClosure, setupCodeLoad, tearDownCodeLoad, null, 16], JAM.policy.p1), JAM.new(Benchmark, ["CodeLoadJQuery", false, false, 100, runCodeLoadJQuery, setupCodeLoad, tearDownCodeLoad, null, 16], JAM.policy.p1)]], JAM.policy.p1);
var salt;
var indirectEval;
