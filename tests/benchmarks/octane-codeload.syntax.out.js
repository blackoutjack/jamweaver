...
function cacheBust(str$$6, old) {
  ...
  var hash$$1 = Math.abs(JAM.call(jenkinsHash, null, [keys, keys.length], JAM.policy.p1));
...
function ShowBox(name$$32) {
  function v11(entry) {
    if (name$$32.valueOf() === entry.valueOf()) {
      var box1 = JAM.call(document.getElementById, document, ["Box-" + name$$32 + "Latency"]);
      box1.style.visibility = "visible";
    }
    return;
  }
  var box = JAM.call(document.getElementById, document, ["Box-" + name$$32]);
...
function AddResult(name$$33, result$$4) {
  ...
  var box$$1 = JAM.call(document.getElementById, document, ["Result-" + name$$33]);
