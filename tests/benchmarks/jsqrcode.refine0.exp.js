...
function v154(patterns) {
  function distance(pattern1$$1, pattern2$$1) {
    ...
    return JAM.call(Math.sqrt, Math, [xDiff * xDiff + yDiff * yDiff], JAM.policy.p41);
  }
...
function v153(from, to) {
  ...
  var rest = JAM.call(this.slice, this, [v1076], JAM.policy.p41);
  var v172;
  if (from < 0) {
  ...
  this.length = v172;
  var v173 = this.push;
  return JAM.call(v173.apply, v173, [this, rest], JAM.policy.p40);
}
function v152() {
  ...
  for (;v177;) {
    ...
    for (;v176;) {
      var gray$$1 = JAM.call(qrcode.getPixel, qrcode, [x$$61, y$$43], JAM.policy.p40);
...
function v151(grayScale) {
  var middle$$1 = JAM.call(qrcode.getMiddleBrightnessPerArea, qrcode, [grayScale], JAM.policy.p41);
  var sqrtNumArea = middle$$1.length;
  var areaWidth$$1 = JAM.call(Math.floor, Math, [qrcode.width / sqrtNumArea], JAM.policy.p41);
  var areaHeight$$1 = JAM.call(Math.floor, Math, [qrcode.height / sqrtNumArea], JAM.policy.p41);
...
function v150(image$$9) {
  var numSqrtArea = 4;
  var areaWidth = JAM.call(Math.floor, Math, [qrcode.width / numSqrtArea], JAM.policy.p41);
  var areaHeight = JAM.call(Math.floor, Math, [qrcode.height / numSqrtArea], JAM.policy.p41);
  ...
  for (;v206;) {
    ...
    for (;v205;) {
      ...
      var v2854 = JAM.call(Math.floor, Math, [(v2522 + v2695[1]) / 2], JAM.policy.p41);
      introspect(JAM.policy.p13) {
        v203[v204] = v2854;
      }
      ax = ax + 1;
...
function v149(th) {
  ...
  for (;v210;) {
    ...
    for (;v209;) {
      var gray = JAM.call(qrcode.getPixel, qrcode, [x$$60, y$$42], JAM.policy.p40);
...
function v147(ctx) {
  ...
  var image$$8 = JAM.call(qrcode.grayScaleToBitmap, qrcode, [qrcode.grayscale()], JAM.policy.p41);
  if (qrcode.debug) {
    var y$$40 = 0;
  ...
  var reader$$1 = JAM.call(Decoder.decode, Decoder, [qRCodeMatrix.bits], JAM.policy.p41);
  ...
  for (;v233;) {
    ...
    for (;v232;) {
      ...
      str$$6 = v1129 + JAM.call(String.fromCharCode, String, [v1884], JAM.policy.p41);
      j$$24 = j$$24 + 1;
      introspect(JAM.policy.p27) {
  ...
  return JAM.call(qrcode.decode_utf8, qrcode, [str$$6], JAM.policy.p41);
}
function v146(s$$4) {
...
function v145(src$$1) {
  function v144() {
    ...
    JAM.call(context$$1.drawImage, context$$1, [image$$7, 0, 0], JAM.policy.p42);
    qrcode.width = image$$7.width;
    qrcode.height = image$$7.height;
    try {
      var v237 = qrcode;
      var v2855 = JAM.call(context$$1.getImageData, context$$1, [0, 0, image$$7.width, image$$7.height], JAM.policy.p25);
      v237.imagedata = v2855;
    } catch (e$$5) {
      qrcode.result = "Cross domain image reading not supported in your browser! Save it to your computer then drag and drop the file!";
      if (qrcode.callback != null) {
        JAM.call(qrcode.callback, qrcode, [qrcode.result], JAM.policy.p41);
      }
      return;
    }
    try {
      var v240 = qrcode;
      var v2856 = JAM.call(qrcode.process, qrcode, [context$$1], JAM.policy.p41);
      v240.result = v2856;
    } catch (e$$6) {
      JAM.call(console.log, console, [e$$6], JAM.policy.p41);
  ...
  if (arguments.length == 0) {
    ...
    var v243 = qrcode;
    var v2857 = JAM.call(context.getImageData, context, [0, 0, qrcode.width, qrcode.height], JAM.policy.p25);
...
function v143(bits$$13) {
  ...
  var dataBlocks = JAM.call(DataBlock.getDataBlocks, DataBlock, [codewords$$1, version$$7, ecLevel$$2], JAM.policy.p40);
  var totalBytes = 0;
  var i$$44 = 0;
...
function v142(codewordBytes, numDataCodewords$$2) {
  ...
  try {
    ...
    JAM.call(v258.decode, v258, [codewordsInts, numECCodewords], JAM.policy.p40);
  } catch (rse) {
    throw rse;
  }
  i$$43 = 0;
...
function v139(rawCodewords, version$$5, ecLevel$$1) {
  ...
  var ecBlocks = JAM.call(version$$5.getECBlocksForLevel, version$$5, [ecLevel$$1], JAM.policy.p41);
  var totalBlocks = 0;
...
function v137(maskedFormatInfo$$1) {
  ...
  for (;v289;) {
    ...
    var bitsDifference$$1 = JAM.call(this.numBitsDiffering, this, [maskedFormatInfo$$1, targetInfo], JAM.policy.p40);
...
function v136(maskedFormatInfo) {
  var formatInfo$$1 = JAM.call(FormatInformation.doDecodeFormatInformation, FormatInformation, [maskedFormatInfo], JAM.policy.p41);
  if (formatInfo$$1 != null) {
    return formatInfo$$1;
  }
  return JAM.call(FormatInformation.doDecodeFormatInformation, FormatInformation, [maskedFormatInfo ^ FORMAT_INFO_MASK_QR], JAM.policy.p41);
}
function v135(a, b$$1) {
  a = a ^ b$$1;
  var v2844 = a & 15;
...
function v134(x0$$4, y0$$4, x1$$5, y1$$5, x2$$3, y2$$3, x3$$2, y3$$2) {
  return JAM.call(this.squareToQuadrilateral, this, [x0$$4, y0$$4, x1$$5, y1$$5, x2$$3, y2$$3, x3$$2, y3$$2], JAM.policy.p40).buildAdjoint();
}
...
function v132(x0$$2, y0$$2, x1$$3, y1$$3, x2$$1, y2$$1, x3, y3, x0p, y0p, x1p, y1p, x2p, y2p, x3p, y3p) {
  var qToS = JAM.call(this.quadrilateralToSquare, this, [x0$$2, y0$$2, x1$$3, y1$$3, x2$$1, y2$$1, x3, y3], JAM.policy.p40);
  var sToQ = JAM.call(this.squareToQuadrilateral, this, [x0p, y0p, x1p, y1p, x2p, y2p, x3p, y3p], JAM.policy.p40);
  return JAM.call(sToQ.times, sToQ, [qToS], JAM.policy.p41);
}
function v131(versionBits) {
  ...
  for (;v315;) {
    ...
    if (targetVersion == versionBits) {
      return JAM.call(this.getVersionForNumber, this, [i$$4 + 7], JAM.policy.p41);
    }
    var bitsDifference = JAM.call(FormatInformation.numBitsDiffering, FormatInformation, [versionBits, targetVersion], JAM.policy.p40);
  ...
  if (bestDifference <= 3) {
    return JAM.call(this.getVersionForNumber, this, [bestVersion], JAM.policy.p41);
  }
  return null;
}
function v130(dimension$$3) {
  ...
  try {
    return JAM.call(Version.getVersionForNumber, Version, [dimension$$3 - 17 >> 2], JAM.policy.p41);
  } catch (iae) {
...
function v128(image$$4, dimension$$1, p1ToX, p1ToY, p2ToX, p2ToY, p3ToX, p3ToY, p4ToX, p4ToY, p1FromX, p1FromY, p2FromX, p2FromY, p3FromX, p3FromY, p4FromX, p4FromY) {
  ...
  return JAM.call(GridSampler.sampleGrid3, GridSampler, [image$$4, dimension$$1, transform$$1], JAM.policy.p40);
}
function v127(image$$3, dimension, transform) {
  ...
  for (;v339;) {
    ...
    JAM.call(transform.transformPoints1, transform, [points$$1], JAM.policy.p41);
    JAM.call(GridSampler.checkAndNudgePoints, GridSampler, [image$$3, points$$1], JAM.policy.p40);
    try {
      x$$48 = 0;
      var v338 = x$$48 < max;
      for (;v338;) {
        ...
        var v326 = JAM.call(Math.floor, Math, [v1899], JAM.policy.p41) * 4;
        var v2708 = x$$48 + 1;
        introspect(JAM.policy.p27) {
          var v2537 = points$$1[v2708]
        }
        var xpoint = v326 + JAM.call(Math.floor, Math, [v2537], JAM.policy.p41) * qrcode.width * 4;
        var v328 = image$$3;
        introspect(JAM.policy.p27) {
        ...
        var v329 = v1196 + v1903 * JAM.call(Math.floor, Math, [v2538], JAM.policy.p41);
        introspect(JAM.policy.p27) {
          var bit = v328[v329]
        }
        ...
        if (bit) {
          JAM.call(bits.set_Renamed, bits, [x$$48 >> 1, y$$31], JAM.policy.p30);
        }
        x$$48 = x$$48 + 2;
        v338 = x$$48 < max;
      }
...
function Version(versionNumber, alignmentPatternCenters, ecBlocks1$$1, ecBlocks2$$1, ecBlocks3, ecBlocks4) {
  ...
  function v10() {
    ...
    JAM.call(bitMatrix.setRegion, bitMatrix, [dimension$$2 - 8, 0, 8, 9], JAM.policy.p30);
    JAM.call(bitMatrix.setRegion, bitMatrix, [0, dimension$$2 - 8, 9, 8], JAM.policy.p25);
    ...
    for (;v373;) {
      ...
      for (;v372;) {
        ...
        JAM.call(bitMatrix.setRegion, bitMatrix, [v1217 - 2, i$$3, 5, 5], JAM.policy.p30);
        y$$32 = y$$32 + 1;
        v372 = y$$32 < max$$1;
      }
      x$$49 = x$$49 + 1;
    ...
    JAM.call(bitMatrix.setRegion, bitMatrix, [6, 9, 1, dimension$$2 - 17], JAM.policy.p25);
    JAM.call(bitMatrix.setRegion, bitMatrix, [9, 6, dimension$$2 - 17, 1], JAM.policy.p25);
    if (this.versionNumber > 6) {
      JAM.call(bitMatrix.setRegion, bitMatrix, [dimension$$2 - 11, 0, 3, 6], JAM.policy.p30);
      JAM.call(bitMatrix.setRegion, bitMatrix, [0, dimension$$2 - 11, 6, 3], JAM.policy.p25);
    }
    return bitMatrix;
  }
  function v9() {
...
function Detector(image$$5) {
  function v26() {
    ...
    var info$$1 = JAM.call(v449.findFinderPattern, v449, [this.image], JAM.policy.p41);
    return JAM.call(this.processFinderPatternInfo, this, [info$$1], JAM.policy.p41);
  }
  function v25(info) {
    var topLeft$$3 = info.TopLeft;
    var topRight$$3 = info.TopRight;
    var bottomLeft$$3 = info.BottomLeft;
    var moduleSize$$1 = JAM.call(this.calculateModuleSize, this, [topLeft$$3, topRight$$3, bottomLeft$$3], JAM.policy.p40);
    if (moduleSize$$1 < 1) {
      throw "Error";
    }
    var dimension$$7 = JAM.call(this.computeDimension, this, [topLeft$$3, topRight$$3, bottomLeft$$3, moduleSize$$1], JAM.policy.p40);
    var provisionalVersion = JAM.call(Version.getProvisionalVersionForDimension, Version, [dimension$$7], JAM.policy.p41);
    ...
    if (provisionalVersion.AlignmentPatternCenters.length > 0) {
      ...
      var estAlignmentX$$1 = JAM.call(Math.floor, Math, [topLeft$$3.X + correctionToTopLeft * (bottomRightX$$1 - topLeft$$3.X)], JAM.policy.p41);
      var estAlignmentY$$1 = JAM.call(Math.floor, Math, [topLeft$$3.Y + correctionToTopLeft * (bottomRightY$$1 - topLeft$$3.Y)], JAM.policy.p41);
      var i$$7 = 4;
      var v460 = i$$7 <= 16;
      for (;v460;) {
        alignmentPattern$$1 = JAM.call(this.findAlignmentInRegion, this, [moduleSize$$1, estAlignmentX$$1, estAlignmentY$$1, i$$7], JAM.policy.p40);
        break;
      }
    }
    var transform$$4 = JAM.call(this.createTransform, this, [topLeft$$3, topRight$$3, bottomLeft$$3, alignmentPattern$$1, dimension$$7], JAM.policy.p40);
    var bits$$2 = JAM.call(this.sampleGrid, this, [this.image, transform$$4, dimension$$7], JAM.policy.p40);
    var points$$4;
  ...
  function v24(image$$6, transform$$3, dimension$$6) {
    ...
    return JAM.call(sampler.sampleGrid3, sampler, [image$$6, dimension$$6, transform$$3], JAM.policy.p40);
  }
  function v23(topLeft$$2, topRight$$2, bottomLeft$$2, alignmentPattern, dimension$$5) {
    ...
    var transform$$2 = JAM.call(PerspectiveTransform.quadrilateralToQuadrilateral, PerspectiveTransform, [3.5, 3.5, dimMinusThree, 3.5, sourceBottomRightX, sourceBottomRightY, 3.5, dimMinusThree, topLeft$$2.X, topLeft$$2.Y, topRight$$2.X, topRight$$2.Y, bottomRightX, bottomRightY, bottomLeft$$2.X, bottomLeft$$2.Y], JAM.policy.p25);
    return transform$$2;
  }
  function v22(overallEstModuleSize, estAlignmentX, estAlignmentY, allowanceFactor) {
    var allowance = JAM.call(Math.floor, Math, [allowanceFactor * overallEstModuleSize], JAM.policy.p41);
    var alignmentAreaLeftX = JAM.call(Math.max, Math, [0, estAlignmentX - allowance], JAM.policy.p25);
    var alignmentAreaRightX = JAM.call(Math.min, Math, [qrcode.width - 1, estAlignmentX + allowance], JAM.policy.p40);
    if (alignmentAreaRightX - alignmentAreaLeftX < overallEstModuleSize * 3) {
      throw "Error";
    }
    var alignmentAreaTopY = JAM.call(Math.max, Math, [0, estAlignmentY - allowance], JAM.policy.p25);
    var alignmentAreaBottomY = JAM.call(Math.min, Math, [qrcode.height - 1, estAlignmentY + allowance], JAM.policy.p40);
    var alignmentFinder = new AlignmentPatternFinder(this.image, alignmentAreaLeftX, alignmentAreaTopY, alignmentAreaRightX - alignmentAreaLeftX, alignmentAreaBottomY - alignmentAreaTopY, overallEstModuleSize, this.resultPointCallback);
    return alignmentFinder.find();
  }
  function v21(topLeft$$1, topRight$$1, bottomLeft$$1, moduleSize) {
    var tltrCentersDimension = JAM.call(Math.round, Math, [JAM.call(this.distance, this, [topLeft$$1, topRight$$1], JAM.policy.p40) / moduleSize], JAM.policy.p41);
    var tlblCentersDimension = JAM.call(Math.round, Math, [JAM.call(this.distance, this, [topLeft$$1, bottomLeft$$1], JAM.policy.p40) / moduleSize], JAM.policy.p41);
  ...
  function v19(topLeft, topRight, bottomLeft) {
    return(JAM.call(this.calculateModuleSizeOneWay, this, [topLeft, topRight], JAM.policy.p40) + JAM.call(this.calculateModuleSizeOneWay, this, [topLeft, bottomLeft], JAM.policy.p40)) / 2;
  }
  function v18(pattern$$1, otherPattern) {
    var moduleSizeEst1 = JAM.call(this.sizeOfBlackWhiteBlackRunBothWays, this, [JAM.call(Math.floor, Math, [pattern$$1.X], JAM.policy.p41), JAM.call(Math.floor, Math, [pattern$$1.Y], JAM.policy.p41), JAM.call(Math.floor, Math, [otherPattern.X], JAM.policy.p41), JAM.call(Math.floor, Math, [otherPattern.Y], JAM.policy.p41)], JAM.policy.p40);
    var moduleSizeEst2 = JAM.call(this.sizeOfBlackWhiteBlackRunBothWays, this, [JAM.call(Math.floor, Math, [otherPattern.X], JAM.policy.p41), JAM.call(Math.floor, Math, [otherPattern.Y], JAM.policy.p41), JAM.call(Math.floor, Math, [pattern$$1.X], JAM.policy.p41), JAM.call(Math.floor, Math, [pattern$$1.Y], JAM.policy.p41)], JAM.policy.p40);
  ...
  function v17(fromX$$1, fromY$$1, toX$$1, toY$$1) {
    var result = JAM.call(this.sizeOfBlackWhiteBlackRun, this, [fromX$$1, fromY$$1, toX$$1, toY$$1], JAM.policy.p40);
    var scale = 1;
    ...
    var otherToY = JAM.call(Math.floor, Math, [fromY$$1 - (toY$$1 - fromY$$1) * scale], JAM.policy.p41);
    scale = 1;
    if (otherToY < 0) {
    ...
    otherToX = JAM.call(Math.floor, Math, [fromX$$1 + (otherToX - fromX$$1) * scale], JAM.policy.p41);
    result = result + JAM.call(this.sizeOfBlackWhiteBlackRun, this, [fromX$$1, fromY$$1, otherToX, otherToY], JAM.policy.p40);
    return result - 1;
  }
  function v16(fromX, fromY, toX, toY) {
    var steep = JAM.call(Math.abs, Math, [toY - fromY], JAM.policy.p41) > JAM.call(Math.abs, Math, [toX - fromX], JAM.policy.p41);
    if (steep) {
      var temp = fromX;
      fromX = fromY;
      fromY = temp;
    ...
    var dx$$4 = JAM.call(Math.abs, Math, [toX - fromX], JAM.policy.p41);
    var dy$$4 = JAM.call(Math.abs, Math, [toY - fromY], JAM.policy.p41);
    var error$$1 = -dx$$4 >> 1;
    var v528;
    if (fromY < toY) {
      v528 = 1;
    ...
    for (;v539;) {
      ...
      if (state == 3) {
        ...
        return JAM.call(Math.sqrt, Math, [diffX * diffX + diffY * diffY], JAM.policy.p41);
      }
    ...
    return JAM.call(Math.sqrt, Math, [diffX2 * diffX2 + diffY2 * diffY2], JAM.policy.p41);
  }
  this.image = image$$5;
...
function FormatInformation(formatInfo) {
  ...
  var v2863 = JAM.call(ErrorCorrectionLevel.forBits, ErrorCorrectionLevel, [formatInfo >> 3 & 3], JAM.policy.p41);
...
function BitMatrix(width$$10, height$$9) {
  ...
  function v37(x$$53, y$$36) {
    ...
    return(URShift(v2311, x$$53 & 31) & 1) != 0;
  }
  function v36() {
...
function BitMatrixParser(bitMatrix$$1) {
  function v47() {
    ...
    var dataMask$$1 = JAM.call(DataMask.forReference, DataMask, [formatInfo$$2.DataMask], JAM.policy.p41);
    var dimension$$11 = this.bitMatrix.Dimension;
    JAM.call(dataMask$$1.unmaskBitMatrix, dataMask$$1, [this.bitMatrix, dimension$$11], JAM.policy.p40);
    ...
    for (;v583;) {
      ...
      for (;v582;) {
        ...
        var v581 = col < 2;
        for (;v581;) {
          if (!JAM.call(functionPattern.get_Renamed, functionPattern, [j$$4 - col, i$$15], JAM.policy.p40)) {
            bitsRead = bitsRead + 1;
            currentByte = currentByte << 1;
            var v1542 = this.bitMatrix;
            if (JAM.call(v1542.get_Renamed, v1542, [j$$4 - col, i$$15], JAM.policy.p40)) {
              currentByte = currentByte | 1;
            }
            if (bitsRead == 8) {
  ...
  function v46() {
    ...
    if (provisionalVersion$$1 <= 6) {
      return JAM.call(Version.getVersionForNumber, Version, [provisionalVersion$$1], JAM.policy.p41);
    }
    var versionBits$$2 = 0;
    ...
    for (;v590;) {
      ...
      var v589 = i$$14 >= ijMin;
      for (;v589;) {
        versionBits$$2 = JAM.call(this.copyBit, this, [i$$14, j$$3, versionBits$$2], JAM.policy.p30);
        i$$14 = i$$14 - 1;
        v589 = i$$14 >= ijMin;
      }
      j$$3 = j$$3 - 1;
    ...
    var v2865 = JAM.call(Version.decodeVersionInformation, Version, [versionBits$$2], JAM.policy.p41);
    ...
    var v2866 = JAM.call(Version.decodeVersionInformation, Version, [versionBits$$2], JAM.policy.p41);
  ...
  function v45() {
    ...
    var v596 = i$$13 < 6;
    for (;v596;) {
      formatInfoBits = JAM.call(this.copyBit, this, [i$$13, 8, formatInfoBits], JAM.policy.p30);
      i$$13 = i$$13 + 1;
      v596 = i$$13 < 6;
    }
    ...
    var v2867 = JAM.call(FormatInformation.decodeFormatInformation, FormatInformation, [formatInfoBits], JAM.policy.p41);
    ...
    var v2868 = JAM.call(FormatInformation.decodeFormatInformation, FormatInformation, [formatInfoBits], JAM.policy.p41);
  ...
  function v44(i$$12, j$$1, versionBits$$1) {
    ...
    if (JAM.call(v2321.get_Renamed, v2321, [i$$12, j$$1], JAM.policy.p40)) {
...
function DataMask000() {
  ...
  function v48(bits$$5, dimension$$12) {
    ...
    for (;v608;) {
      ...
      for (;v607;) {
        if (JAM.call(this.isMasked, this, [i$$16, j$$5], JAM.policy.p40)) {
          JAM.call(bits$$5.flip, bits$$5, [j$$5, i$$16], JAM.policy.p30);
        }
        j$$5 = j$$5 + 1;
...
function DataMask001() {
  ...
  function v50(bits$$6, dimension$$13) {
    ...
    for (;v612;) {
      ...
      for (;v611;) {
        if (JAM.call(this.isMasked, this, [i$$18, j$$7], JAM.policy.p40)) {
          JAM.call(bits$$6.flip, bits$$6, [j$$7, i$$18], JAM.policy.p30);
        }
        j$$7 = j$$7 + 1;
...
function DataMask010() {
  ...
  function v52(bits$$7, dimension$$14) {
    ...
    for (;v616;) {
      ...
      for (;v615;) {
        if (JAM.call(this.isMasked, this, [i$$20, j$$9], JAM.policy.p40)) {
          JAM.call(bits$$7.flip, bits$$7, [j$$9, i$$20], JAM.policy.p30);
        }
        j$$9 = j$$9 + 1;
...
function DataMask011() {
  ...
  function v54(bits$$8, dimension$$15) {
    ...
    for (;v620;) {
      ...
      for (;v619;) {
        if (JAM.call(this.isMasked, this, [i$$22, j$$11], JAM.policy.p40)) {
          JAM.call(bits$$8.flip, bits$$8, [j$$11, i$$22], JAM.policy.p30);
        }
        j$$11 = j$$11 + 1;
...
function DataMask100() {
  ...
  function v56(bits$$9, dimension$$16) {
    ...
    for (;v624;) {
      ...
      for (;v623;) {
        if (JAM.call(this.isMasked, this, [i$$24, j$$13], JAM.policy.p40)) {
          JAM.call(bits$$9.flip, bits$$9, [j$$13, i$$24], JAM.policy.p30);
        }
        j$$13 = j$$13 + 1;
...
function DataMask101() {
  ...
  function v58(bits$$10, dimension$$17) {
    ...
    for (;v628;) {
      ...
      for (;v627;) {
        if (JAM.call(this.isMasked, this, [i$$26, j$$15], JAM.policy.p40)) {
          JAM.call(bits$$10.flip, bits$$10, [j$$15, i$$26], JAM.policy.p30);
        }
        j$$15 = j$$15 + 1;
...
function DataMask110() {
  ...
  function v60(bits$$11, dimension$$18) {
    ...
    for (;v632;) {
      ...
      for (;v631;) {
        if (JAM.call(this.isMasked, this, [i$$28, j$$17], JAM.policy.p40)) {
          JAM.call(bits$$11.flip, bits$$11, [j$$17, i$$28], JAM.policy.p30);
        }
        j$$17 = j$$17 + 1;
...
function DataMask111() {
  ...
  function v62(bits$$12, dimension$$19) {
    ...
    for (;v636;) {
      ...
      for (;v635;) {
        if (JAM.call(this.isMasked, this, [i$$30, j$$19], JAM.policy.p40)) {
          JAM.call(bits$$12.flip, bits$$12, [j$$19, i$$30], JAM.policy.p30);
        }
        j$$19 = j$$19 + 1;
...
function ReedSolomonDecoder(field) {
    ...
    for (;v647;) {
      ...
      for (;v642;) {
        if (i$$34 != j$$21) {
          ...
          denominator$$3 = JAM.call(v639.multiply, v639, [denominator$$3, JAM.call(GF256.addOrSubtract, GF256, [1, JAM.call(v2330.multiply, v2330, [v2331, xiInverse], JAM.policy.p40)], JAM.policy.p25)], JAM.policy.p40);
        }
        j$$21 = j$$21 + 1;
        v642 = j$$21 < s$$3;
      }
      ...
      var v1563 = JAM.call(errorEvaluator.evaluateAt, errorEvaluator, [xiInverse], JAM.policy.p41);
      var v2332 = this.field;
      var v2869 = JAM.call(v1562.multiply, v1562, [v1563, JAM.call(v2332.inverse, v2332, [denominator$$3], JAM.policy.p41)], JAM.policy.p40);
      introspect(JAM.policy.p13) {
        v643[v644] = v2869;
      }
      if (dataMatrix$$1) {
  ...
  function v66(errorLocator) {
    ...
    var v653 = v1567;
    for (;v653;) {
      if (JAM.call(errorLocator.evaluateAt, errorLocator, [i$$33], JAM.policy.p41) == 0) {
        var v650 = result$$3;
        var v651 = e$$4;
        var v1569 = this.field;
        var v2871 = JAM.call(v1569.inverse, v1569, [i$$33], JAM.policy.p41);
        introspect(JAM.policy.p13) {
          v650[v651] = v2871;
        }
        e$$4 = e$$4 + 1;
  ...
  function v65(a$$1, b$$2, R) {
    ...
    var v673 = r$$1.Degree >= JAM.call(Math.floor, Math, [R / 2], JAM.policy.p41);
    for (;v673;) {
      var rLastLast = rLast;
      var sLastLast = sLast;
      var tLastLast = tLast;
      ...
      var denominatorLeadingTerm = JAM.call(rLast.getCoefficient, rLast, [rLast.Degree], JAM.policy.p41);
      var v663 = this.field;
      var dltInverse = JAM.call(v663.inverse, v663, [denominatorLeadingTerm], JAM.policy.p41);
      ...
      for (;v670;) {
        ...
        var v666 = this.field;
        var scale$$1 = JAM.call(v666.multiply, v666, [JAM.call(r$$1.getCoefficient, r$$1, [r$$1.Degree], JAM.policy.p41), dltInverse], JAM.policy.p40);
        var v1577 = this.field;
        q = JAM.call(q.addOrSubtract, q, [JAM.call(v1577.buildMonomial, v1577, [degreeDiff, scale$$1], JAM.policy.p40)], JAM.policy.p41);
        r$$1 = JAM.call(r$$1.addOrSubtract, r$$1, [JAM.call(rLast.multiplyByMonomial, rLast, [degreeDiff, scale$$1], JAM.policy.p40)], JAM.policy.p41);
      ...
      var v671 = JAM.call(q.multiply1, q, [sLast], JAM.policy.p41);
      s$$2 = JAM.call(v671.addOrSubtract, v671, [sLastLast], JAM.policy.p41);
      var v672 = JAM.call(q.multiply1, q, [tLast], JAM.policy.p41);
      t = JAM.call(v672.addOrSubtract, v672, [tLastLast], JAM.policy.p41);
      v673 = r$$1.Degree >= JAM.call(Math.floor, Math, [R / 2], JAM.policy.p41);
    }
    ...
    var v675 = this.field;
    var inverse = JAM.call(v675.inverse, v675, [sigmaTildeAtZero], JAM.policy.p41);
    var sigma$$1 = JAM.call(t.multiply2, t, [inverse], JAM.policy.p41);
    var omega$$1 = JAM.call(r$$1.multiply2, r$$1, [inverse], JAM.policy.p41);
  ...
  function v64(received, twoS) {
    ...
    for (;v681;) {
      ...
      var eval$$1 = JAM.call(poly.evaluateAt, poly, [JAM.call(v1583.exp, v1583, [v2341], JAM.policy.p41)], JAM.policy.p41);
    ...
    var sigmaOmega = JAM.call(this.runEuclideanAlgorithm, this, [JAM.call(v1586.buildMonomial, v1586, [twoS, 1], JAM.policy.p42), syndrome, twoS], JAM.policy.p40);
    var sigma = sigmaOmega[0];
    var omega = sigmaOmega[1];
    var errorLocations = JAM.call(this.findErrorLocations, this, [sigma], JAM.policy.p41);
    var errorMagnitudes = JAM.call(this.findErrorMagnitudes, this, [omega, errorLocations, dataMatrix], JAM.policy.p40);
    i$$32 = 0;
    ...
    for (;v689;) {
      ...
      var position = v684 - JAM.call(v1589.log, v1589, [v1590], JAM.policy.p41);
      if (position < 0) {
...
function GF256Poly(field$$1, coefficients) {
  function v77(other$$8) {
    ...
    var remainder = this;
    var denominatorLeadingTerm$$1 = JAM.call(other$$8.getCoefficient, other$$8, [other$$8.Degree], JAM.policy.p41);
    var v694 = this.field;
    var inverseDenominatorLeadingTerm = JAM.call(v694.inverse, v694, [denominatorLeadingTerm$$1], JAM.policy.p41);
    ...
    for (;v700;) {
      ...
      var v697 = this.field;
      var scale$$2 = JAM.call(v697.multiply, v697, [JAM.call(remainder.getCoefficient, remainder, [remainder.Degree], JAM.policy.p41), inverseDenominatorLeadingTerm], JAM.policy.p40);
      var term = JAM.call(other$$8.multiplyByMonomial, other$$8, [degreeDifference, scale$$2], JAM.policy.p40);
      var v699 = this.field;
      var iterationQuotient = JAM.call(v699.buildMonomial, v699, [degreeDifference, scale$$2], JAM.policy.p40);
      quotient = JAM.call(quotient.addOrSubtract, quotient, [iterationQuotient], JAM.policy.p41);
      remainder = JAM.call(remainder.addOrSubtract, remainder, [term], JAM.policy.p41);
  ...
  function v74(other$$7) {
    ...
    for (;v726;) {
      ...
      for (;v725;) {
        ...
        var v2875 = JAM.call(GF256.addOrSubtract, GF256, [v1609, JAM.call(v2353.multiply, v2353, [aCoeff, v2354], JAM.policy.p40)], JAM.policy.p40);
        introspect(JAM.policy.p13) {
          v723[v724] = v2875;
        }
        j$$22 = j$$22 + 1;
...
function FinderPattern(posX, posY, estimatedModuleSize) {
  function v90(moduleSize$$2, i$$47, j$$25) {
    var v1641 = JAM.call(Math.abs, Math, [i$$47 - this.y], JAM.policy.p41) <= moduleSize$$2;
    if (v1641) {
      v1641 = JAM.call(Math.abs, Math, [j$$25 - this.x], JAM.policy.p41) <= moduleSize$$2;
    }
    if (v1641) {
      var moduleSizeDiff = JAM.call(Math.abs, Math, [moduleSize$$2 - this.estimatedModuleSize], JAM.policy.p41);
...
function FinderPatternFinder() {
  function v104(image$$12) {
    ...
    var iSkip = JAM.call(Math.floor, Math, [3 * maxI$$1 / (4 * MAX_MODULES)], JAM.policy.p41);
    ...
    for (;v804;) {
      ...
      for (;v801;) {
        ...
        if (v800) {
          ...
          if ((currentState & 1) == 0) {
            if (currentState == 4) {
              if (JAM.call(this.foundPatternCross, this, [stateCount$$5], JAM.policy.p41)) {
                var confirmed = JAM.call(this.handlePossibleCenter, this, [stateCount$$5, i$$54, j$$28], JAM.policy.p40);
                if (confirmed) {
                  iSkip = 2;
                  if (this.hasSkipped) {
      ...
      if (JAM.call(this.foundPatternCross, this, [stateCount$$5], JAM.policy.p41)) {
        confirmed = JAM.call(this.handlePossibleCenter, this, [stateCount$$5, i$$54, maxJ$$1], JAM.policy.p40);
        if (confirmed) {
    ...
    JAM.call(qrcode.orderBestPatterns, qrcode, [patternInfo], JAM.policy.p41);
  ...
  function v103() {
    ...
    for (;v811;) {
      ...
      totalDeviation = totalDeviation + JAM.call(Math.abs, Math, [pattern$$3.EstimatedModuleSize - average$$1], JAM.policy.p41);
      i$$53 = i$$53 + 1;
      v811 = i$$53 < max$$7;
    }
    ...
    for (;v819;) {
      ...
      if (center$$1.Count >= CENTER_QUORUM) {
        if (firstConfirmedCenter == null) {
          ...
          return JAM.call(Math.floor, Math, [(JAM.call(Math.abs, Math, [firstConfirmedCenter.X - center$$1.X], JAM.policy.p41) - JAM.call(Math.abs, Math, [firstConfirmedCenter.Y - center$$1.Y], JAM.policy.p41)) / 2], JAM.policy.p41);
        }
      }
      i$$52 = i$$52 + 1;
      v819 = i$$52 < max$$6;
  ...
  function v101() {
    ...
    if (startSize > 3) {
      ...
      for (;v828;) {
        ...
        if (JAM.call(Math.abs, Math, [pattern$$2.EstimatedModuleSize - average], JAM.policy.p41) > .2 * average) {
          var v826 = this.possibleCenters;
          JAM.call(v826.remove, v826, [i$$51], JAM.policy.p31);
          i$$51 = i$$51 - 1;
        }
        i$$51 = i$$51 + 1;
    ...
    if (this.possibleCenters.length > 3) {
      ...
      JAM.call(v830.sort, v830, [v100], JAM.policy.p41);
    }
  ...
  function v99(stateCount$$4, i$$50, j$$27) {
    ...
    var centerJ$$1 = JAM.call(this.centerFromEnd, this, [stateCount$$4, j$$27], JAM.policy.p40);
    var centerI$$1 = JAM.call(this.crossCheckVertical, this, [i$$50, JAM.call(Math.floor, Math, [centerJ$$1], JAM.policy.p41), stateCount$$4[2], stateCountTotal$$2], JAM.policy.p40);
    if (!isNaN(centerI$$1)) {
      centerJ$$1 = JAM.call(this.crossCheckHorizontal, this, [JAM.call(Math.floor, Math, [centerJ$$1], JAM.policy.p41), JAM.call(Math.floor, Math, [centerI$$1], JAM.policy.p41), stateCount$$4[2], stateCountTotal$$2], JAM.policy.p30);
      if (!isNaN(centerJ$$1)) {
        ...
        for (;v845;) {
          ...
          if (JAM.call(center.aboutEquals, center, [estimatedModuleSize$$1, centerI$$1, centerJ$$1], JAM.policy.p40)) {
        ...
        if (!found) {
          ...
          JAM.call(v846.push, v846, [point$$2], JAM.policy.p41);
          if (this.resultPointCallback != null) {
            var v847 = this.resultPointCallback;
            JAM.call(v847.foundPossibleResultPoint, v847, [point$$2], JAM.policy.p41);
          }
        }
        return true;
      }
  ...
  function v98(startJ, centerI, maxCount$$1, originalStateCountTotal$$1) {
    ...
    if (5 * JAM.call(Math.abs, Math, [stateCountTotal$$1 - originalStateCountTotal$$1], JAM.policy.p41) >= originalStateCountTotal$$1) {
      return NaN;
    }
    var v867;
    if (JAM.call(this.foundPatternCross, this, [stateCount$$3], JAM.policy.p41)) {
      v867 = JAM.call(this.centerFromEnd, this, [stateCount$$3, j$$26], JAM.policy.p40);
    } else {
      v867 = NaN;
    }
    return v867;
  ...
  function v97(startI, centerJ, maxCount, originalStateCountTotal) {
    ...
    if (5 * JAM.call(Math.abs, Math, [stateCountTotal - originalStateCountTotal], JAM.policy.p41) >= 2 * originalStateCountTotal) {
      return NaN;
    }
    var v883;
    if (JAM.call(this.foundPatternCross, this, [stateCount$$2], JAM.policy.p41)) {
      v883 = JAM.call(this.centerFromEnd, this, [stateCount$$2, i$$49], JAM.policy.p40);
    } else {
      v883 = NaN;
    }
    return v883;
  ...
  function v95(stateCount) {
    ...
    var moduleSize$$3 = JAM.call(Math.floor, Math, [(totalModuleSize << INTEGER_MATH_SHIFT) / 7], JAM.policy.p41);
    var maxVariance = JAM.call(Math.floor, Math, [moduleSize$$3 / 2], JAM.policy.p41);
    var v2652 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[0] << INTEGER_MATH_SHIFT)], JAM.policy.p41) < maxVariance;
    if (v2652) {
      v2652 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[1] << INTEGER_MATH_SHIFT)], JAM.policy.p41) < maxVariance;
    }
    var v2446 = v2652;
    if (v2446) {
      v2446 = JAM.call(Math.abs, Math, [3 * moduleSize$$3 - (stateCount[2] << INTEGER_MATH_SHIFT)], JAM.policy.p41) < 3 * maxVariance;
    }
    var v1742 = v2446;
    if (v1742) {
      v1742 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[3] << INTEGER_MATH_SHIFT)], JAM.policy.p41) < maxVariance;
    }
    var v891 = v1742;
    if (v891) {
      v891 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[4] << INTEGER_MATH_SHIFT)], JAM.policy.p41) < maxVariance;
    }
    return v891;
  }
  function v94() {
...
function AlignmentPattern(posX$$1, posY$$1, estimatedModuleSize$$2) {
  function v110(moduleSize$$4, i$$55, j$$29) {
    var v1744 = JAM.call(Math.abs, Math, [i$$55 - this.y], JAM.policy.p41) <= moduleSize$$4;
    if (v1744) {
      v1744 = JAM.call(Math.abs, Math, [j$$29 - this.x], JAM.policy.p41) <= moduleSize$$4;
    }
    if (v1744) {
      var moduleSizeDiff$$1 = JAM.call(Math.abs, Math, [moduleSize$$4 - this.estimatedModuleSize], JAM.policy.p41);
  ...
  function v108() {
    return JAM.call(Math.floor, Math, [this.y], JAM.policy.p41);
  }
  function v107() {
    return JAM.call(Math.floor, Math, [this.x], JAM.policy.p41);
  }
  function v106() {
    return this.count;
  }
...
function AlignmentPatternFinder(image$$13, startX, startY, width$$12, height$$11, moduleSize$$5, resultPointCallback) {
  function v115() {
    ...
    for (;v914;) {
      ...
      for (;v911;) {
        ...
        if (v910) {
          if (currentState$$1 == 1) {
            ...
            if (currentState$$1 == 2) {
              if (JAM.call(this.foundPatternCross, this, [stateCount$$10], JAM.policy.p41)) {
                var confirmed$$1 = JAM.call(this.handlePossibleCenter, this, [stateCount$$10, i$$59, j$$31], JAM.policy.p40);
                if (confirmed$$1 != null) {
                  return confirmed$$1;
                }
              }
      ...
      if (JAM.call(this.foundPatternCross, this, [stateCount$$10], JAM.policy.p41)) {
        confirmed$$1 = JAM.call(this.handlePossibleCenter, this, [stateCount$$10, i$$59, maxJ$$2], JAM.policy.p40);
        if (confirmed$$1 != null) {
          return confirmed$$1;
        }
      }
  ...
  function v114(stateCount$$9, i$$58, j$$30) {
    ...
    var centerJ$$3 = JAM.call(this.centerFromEnd, this, [stateCount$$9, j$$30], JAM.policy.p40);
    var centerI$$2 = JAM.call(this.crossCheckVertical, this, [i$$58, JAM.call(Math.floor, Math, [centerJ$$3], JAM.policy.p41), 2 * stateCount$$9[1], stateCountTotal$$4], JAM.policy.p40);
    if (!isNaN(centerI$$2)) {
      ...
      for (;v925;) {
        ...
        if (JAM.call(center$$2.aboutEquals, center$$2, [estimatedModuleSize$$3, centerI$$2, centerJ$$3], JAM.policy.p40)) {
      ...
      JAM.call(v926.push, v926, [point$$3], JAM.policy.p41);
      if (this.resultPointCallback != null) {
        var v927 = this.resultPointCallback;
        JAM.call(v927.foundPossibleResultPoint, v927, [point$$3], JAM.policy.p41);
      }
    }
    return null;
  }
  function v113(startI$$1, centerJ$$2, maxCount$$2, originalStateCountTotal$$2) {
    ...
    if (5 * JAM.call(Math.abs, Math, [stateCountTotal$$3 - originalStateCountTotal$$2], JAM.policy.p41) >= 2 * originalStateCountTotal$$2) {
      return NaN;
    }
    var v941;
    if (JAM.call(this.foundPatternCross, this, [stateCount$$8], JAM.policy.p41)) {
      v941 = JAM.call(this.centerFromEnd, this, [stateCount$$8, i$$57], JAM.policy.p40);
    } else {
      v941 = NaN;
    }
    return v941;
  ...
  function v112(stateCount$$7) {
    ...
    for (;v943;) {
      ...
      if (JAM.call(Math.abs, Math, [moduleSize$$6 - v2675], JAM.policy.p41) >= maxVariance$$1) {
        return false;
      }
      i$$56 = i$$56 + 1;
      v943 = i$$56 < 3;
...
function QRCodeDataBlockReader(blocks, version$$8, numErrorCorrectionCode) {
  function v123() {
    ...
    do {
      ...
      dataLength = JAM.call(this.getDataLength, this, [mode$$7], JAM.policy.p41);
      if (dataLength < 1) {
        throw "Invalid data length: " + dataLength;
      }
      switch(mode$$7) {
        case MODE_NUMBER:
          var temp_str = JAM.call(this.getFigureString, this, [dataLength], JAM.policy.p41);
          ...
          for (;v954;) {
            var v952 = ta;
            var v953 = j$$32;
            var v2885 = JAM.call(temp_str.charCodeAt, temp_str, [j$$32], JAM.policy.p41);
            introspect(JAM.policy.p13) {
              v952[v953] = v2885;
            }
            j$$32 = j$$32 + 1;
          ...
          JAM.call(output$$1.push, output$$1, [ta], JAM.policy.p41);
          break;
        case MODE_ROMAN_AND_NUMBER:
          temp_str = JAM.call(this.getRomanAndFigureString, this, [dataLength], JAM.policy.p41);
          ...
          for (;v958;) {
            var v956 = ta;
            var v957 = j$$32;
            var v2886 = JAM.call(temp_str.charCodeAt, temp_str, [j$$32], JAM.policy.p41);
            introspect(JAM.policy.p13) {
              v956[v957] = v2886;
            }
            j$$32 = j$$32 + 1;
          ...
          break;
        case MODE_8BIT_BYTE:
          var temp_sbyteArray3 = JAM.call(this.get8bitByteArray, this, [dataLength], JAM.policy.p41);
          JAM.call(output$$1.push, output$$1, [temp_sbyteArray3], JAM.policy.p41);
          break;
        case MODE_KANJI:
          temp_str = JAM.call(this.getKanjiString, this, [dataLength], JAM.policy.p41);
          JAM.call(output$$1.push, output$$1, [temp_str], JAM.policy.p41);
      }
    } while (true);
    return output$$1;
  }
  function v122(dataLength$$4) {
    ...
    do {
      ...
      unicodeString = unicodeString + JAM.call(String.fromCharCode, String, [shiftjisWord], JAM.policy.p41);
  ...
  function v121(dataLength$$3) {
    ...
    do {
      ...
      JAM.call(output.push, output, [intData$$2], JAM.policy.p41);
  ...
  function v119(dataLength$$1) {
    ...
    do {
      if (length$$11 > 1) {
        ...
        var firstLetter = JAM.call(Math.floor, Math, [intData / 45], JAM.policy.p41);
...
function handleFiles(f) {
  function v125(theFile) {
    function v124(e$$10) {
      JAM.call(qrcode.decode, qrcode, [e$$10.target.result], JAM.policy.p41);
      return;
    }
    return v124;
  }
...
function load() {
  ...
  JAM.call(qrcode.decode, qrcode, [img$$2], JAM.policy.p41);
  return;
}
function passLine(stringPixels) {
  ...
  if (c >= 320 * 240 * 4) {
    c = 0;
    JAM.call(gCtx.putImageData, gCtx, [imageData, 0, 0], JAM.policy.p42);
  }
  return;
}
