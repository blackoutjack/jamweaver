...
function v4() {
  function v3(url$$7) {
    JAM.call(initialize, null, [url$$7], JAM.policy.p2);
    return;
  }
  function v2(features$$7, opt_callback$$2) {
    ...
    if (v72) {
      JAM.call(warn, null, [["Cannot load empty features."]], JAM.policy.p2);
    } else {
      var JSCompiler_inline_result$$6;
      var features$$inline_18 = features$$7;
      var set$$inline_19 = JAM.call(toSet, null, [loadedFeatures], JAM.policy.p2);
      ...
      if (JSCompiler_inline_result$$6) {
        JAM.call(warn, null, [["Cannot load loaded features [", JAM.call(features$$7.join, features$$7, [","], JAM.policy.p2), "]."]], JAM.policy.p2);
      } else {
        var v77 = type$$25 === "s";
        if (!v77) {
          v77 = type$$25 === "i";
        ...
        if (v77) {
          JSCompiler_inline_label_processUrlFromMap_25: {
            ...
            var version$$inline_24 = descriptors[JAM.call(toKey, null, [features$$inline_23, loadedFeatures], JAM.policy.p2)];
            if (version$$inline_24) {
              urlToLoad = host + "/" + version$$inline_24 + ".js";
              break JSCompiler_inline_label_processUrlFromMap_25;
            } else {
              JAM.call(warn, null, [["Cannot find features [", JAM.call(features$$inline_23.join, features$$inline_23, [","], JAM.policy.p2), "], except [", JAM.call(loadedFeatures.join, loadedFeatures, [","], JAM.policy.p2), "]."]], JAM.policy.p2);
            }
            urlToLoad = void 0;
          }
        } else {
          if (type$$25 === "d") {
            var url$$inline_27 = host + "/" + JAM.call(toKey, null, [features$$7, loadedFeatures], JAM.policy.p2);
            ...
            if (v82) {
              ...
              var v16 = JAM.call(normalize, null, [features$$7], JAM.policy.p2);
              ...
              if (v17) {
                ...
                var v164 = JAM.call(normalize, null, [opt_loadFeatures$$inline_42], JAM.policy.p2);
              ...
              JAM.call(warn, null, [["Cannot respond for features [", JAM.call(features$$7.join, features$$7, [","], JAM.policy.p2), "]."]], JAM.policy.p2);
            }
          }
        }
      }
    ...
    if (opt_url$$inline_30) {
      ...
      JSCompiler_inline_label_canLoadUrl_58: {
        ...
        if (v87) {
          JSCompiler_inline_result$$54 = JAM.call(url$$inline_55.match, url$$inline_55, [VALID_SCS_URL_REGEX], JAM.policy.p2);
        ...
        if (v28) {
          v28 = JAM.call(url$$inline_55.match, url$$inline_55, [VALID_GOOGLE_URL_REGEX], JAM.policy.p2);
        }
      ...
      if (JAM.call(shouldLoadSync, null, [], JAM.policy.p2)) {
        JAM.call(document.write, document, ['<script src="' + url$$inline_49 + '">\x3c/script>'], JAM.policy.p2);
      } else {
        var script$$inline_50 = JAM.call(document.createElement, document, ["script"], JAM.policy.p2);
        ...
        JAM.call(v32.appendChild, v32, [script$$inline_50], JAM.policy.p2);
      }
      ...
      loadedFeatures = JAM.call(normalize, null, [JAM.call(loadedFeatures.concat, loadedFeatures, [features$$inline_29], JAM.policy.p2)], JAM.policy.p2);
      JSCompiler_inline_result$$37 = void 0;
    } else {
      if (opt_callback$$inline_31) {
        JAM.call(opt_callback$$inline_31, null, [], JAM.policy.p2);
      }
    }
    return;
  }
  function toKey(reqFeatures, opt_loadFeatures) {
    var v35 = JAM.call(normalize, null, [reqFeatures], JAM.policy.p2);
    ...
    if (v36) {
      var v140 = result;
      var v165 = JAM.call(normalize, null, [opt_loadFeatures], JAM.policy.p2);
  ...
  function normalize(features$$1) {
    var result$$3 = [];
    var s$$2;
    for (s$$2 in JAM.call(toSet, null, [features$$1], JAM.policy.p2)) {
      JAM.call(result$$3.push, result$$3, [s$$2], JAM.policy.p2);
    }
    return JAM.call(result$$3.sort, result$$3, [], JAM.policy.p2);
  }
  ...
  function warn(values$$4) {
    if (console) {
      JAM.call(console.warn, console, [JAM.call(values$$4.join, values$$4, [""], JAM.policy.p2)], JAM.policy.p2);
    }
    return;
  }
  function initDescriptors(values$$5) {
    ...
    for (;v46;) {
      ...
      var req$$inline_13 = JAM.call(normalize, null, [JAM.call(v101.split, v101, [":"], JAM.policy.p2)], JAM.policy.p2);
      var v45 = featureParts$$inline_12[1];
      if (v45) {
        var v145 = featureParts$$inline_12[1];
        v45 = JAM.call(normalize, null, [JAM.call(v145.split, v145, [":"], JAM.policy.p2)], JAM.policy.p2);
      }
      var loaded$$inline_14 = v45;
      JSCompiler_inline_result$$8 = JAM.call(toKey, null, [req$$inline_13, loaded$$inline_14], JAM.policy.p2);
  ...
  function getLastHint(pattern$$1) {
    var r = JAM.call(parentUrl.match, parentUrl, [pattern$$1], JAM.policy.p2);
    var v47 = r;
    if (v47) {
      v47 = r[r.length - 1];
    }
  ...
  function initialize(url$$6) {
    ...
    var v107 = JAM.call(getLastHint, null, [QUERY_PATTERN], JAM.policy.p2);
    if (!v107) {
      v107 = JAM.call(getLastHint, null, [FRAGMENT_PATTERN], JAM.policy.p2);
    }
    ...
    if (hint) {
      ...
      if (type$$25 === "s") {
        ...
        v51 = JAM.call(initDescriptors, null, [JAM.call(parts.slice, parts, [1], JAM.policy.p2)], JAM.policy.p2);
      } else {
        var v108;
        if (type$$25 === "i") {
          host = parts[1];
          v108 = JAM.call(initDescriptors, null, [JAM.call(parts.slice, parts, [2], JAM.policy.p2)], JAM.policy.p2);
        } else {
          var v150;
          if (type$$25 === "d") {
            host = parts[1];
  ...
  var console;
  var parentUrl;
  JAM.call(initialize, null, [document.location.href], JAM.policy.p2);
  jsloader_load = v2;
...
function v1() {
  function f(n$$1) {
    function v0() {
      ...
      JAM.call(v53.push, v53, [n$$1, arguments], JAM.policy.p2);
      return;
    }
    return v0;
  }
  return{go:JAM.call(f, null, ["go"], JAM.policy.p2), render:JAM.call(f, null, ["render"], JAM.policy.p2)};
}
function __bsld() {
  var p = window.gapi.plusone = window.googleapisv0.plusone;
  var f$$1;
  var v112 = window.___gpq;
  var v58 = f$$1 = JAM.call(v112.shift, v112, [], JAM.policy.p2);
  for (;v58;) {
    var v57 = p[f$$1];
    if (v57) {
      var v113 = p[f$$1];
      var v152 = window.___gpq;
      JAM.call(v113.apply, v113, [p, JAM.call(v152.shift, v152, [], JAM.policy.p2)], JAM.policy.p2);
    }
    var v115 = window.___gpq;
    v58 = f$$1 = JAM.call(v115.shift, v115, [], JAM.policy.p2);
  }
  var v163 = gadgets.config;
  if (JAM.call(v163.get, v163, ["gwidget"], JAM.policy.p2)["parsetags"] !== "explicit") {
    var v59 = gapi.plusone;
    JAM.call(v59.go, v59, [], JAM.policy.p2);
  }
  return;
}
function gapi_load(features$$8, opt_callback$$3) {
  JAM.call(jsloader_load, null, [JAM.call(features$$8.split, features$$8, [":"], JAM.policy.p2), opt_callback$$3], JAM.policy.p2);
  return;
}
...
if (!v120) {
  v120 = JAM.call(v1, null, [], JAM.policy.p2);
}
v65.plusone = v120;
var jsloader_load;
var goog;
...
var gapi = v70;
JAM.call(v4, null, [], JAM.policy.p2);
JAM.call(gapi_load, null, ["googleapis.client:plusone", window["__bsld"]], JAM.policy.p2)
