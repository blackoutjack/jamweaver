  ...
  function str$$6(key$$14, holder) {
    ...
    switch(typeof value$$27) {
      ...
      case "object":
        ...
        if (JAM.call(v350.apply, v350, [value$$27]) === "[object Array]") {
        ...
        if (v222) {
          ...
          for (k in value$$27) {
            ...
            if (JAM.call(v225.call, v225, [value$$27, k])) {
              v = str$$6(k, value$$27);
              if (v) {
                var v358 = quote(k);
                var v426;
...
function compare(other$$5) {
  ...
  var output1JSON = JAM.call(JSON.parse, JSON, [decodeURI(other$$5.split("?")[1])]);
