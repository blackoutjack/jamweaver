...
function v227(name$$35, css_class, c_fn$$1) {
  ...
  if(css_class != "") {
    ...
    JAM.set(spn_btn, "innerHTML", name$$35)
  }else {
    spn_btn = JAM.call(AJS.TN, AJS, [name$$35])
  }
...
function v206() {
  ...
  if(results$$1.length > 0) {
    ...
    for(;v323;) {
      ...
      var offset$$15 = v927["attrs"]["o"];
      introspect(JAM.policy.p1) {
        var v928 = results$$1[i$$20]
      }
      var len$$1 = v928["attrs"]["l"];
      var part_1_text = this.orginal_text.substring(pointer, offset$$15);
      var part_1$$1 = JAM.call(GoogieSpell.createPart, GoogieSpell, [part_1_text]);
      JAM.call(output.appendChild, output, [part_1$$1]);
      pointer = pointer + (offset$$15 - pointer);
      var err_link = JAM.call(this.createErrorLink, this, [this.orginal_text.substr(offset$$15, len$$1), i$$20]);
...
function v198(elm$$43, id$$4) {
  ...
  function v195() {
    if(edit_input.value != "") {
      ...
      JAM.call(this.updateOrginalText, this, [offset$$14, elm$$43.innerHTML, edit_input.value, id$$4]);
  ...
  function v194(e$$22) {
    JAM.call(this.updateOrginalText, this, [offset$$14, elm$$43.innerHTML, old_value$$3, id$$4]);
    elm$$43.is_corrected = true;
  ...
  if(!changed) {
    ...
    for(;v407;) {
      ...
      item$$1 = AJS.TD();
      dummy = AJS.SPAN();
      JAM.set(dummy, "innerHTML", suggestions[i]);
...
function v192(id$$3, elm$$42, l_elm, rm_pre_space) {
  ...
  this.hideErrorWindow();
  JAM.call(this.updateOrginalText, this, [offset$$13, old_value$$2, new_value$$1, id$$3]);
...
function v189(offset$$12, old_value, new_value, id$$2) {
  var part_1 = this.orginal_text.substring(0, offset$$12);
  var part_2 = this.orginal_text.substring(offset$$12 + old_value.length);
...
function v172(name$$34, call_back_fn, checker) {
  this.extra_menu_items.push([name$$34, call_back_fn, checker]);
  return
}
function v171() {
...
function v138(str$$7) {
  var v1244 = JAM.call(AJS.isDefined, AJS, [str$$7]);
  if(v1244) {
...
function v137(str$$6) {
  var v1246 = JAM.call(AJS.isDefined, AJS, [str$$6]);
  if(v1246) {
...
function v103(data$$19) {
  ...
  for(k in data$$19) {
    ...
    post_data.push(v1077 + JAM.call(AJS.urlencode, AJS, [v1271]))
  }
...
function setCookie(name$$37, value$$31, expires, path, domain, secure) {
  var v1347 = name$$37 + "=" + escape(value$$31);
  var v1359;
  if(expires) {
