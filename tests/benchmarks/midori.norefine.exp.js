...
function v93(intervalKey, targetPos) {
  if(Math.abs(targetPos - this.intervals[intervalKey].scrollPos) > 10) {
    ...
    JAM.call(scrollTo, null, [0, this.intervals[intervalKey].scrollPos])
  }else {
...
function v92(id$$1, callback$$27, constantSpeed, horiz$$1) {
  ...
  var what$$2 = v185;
  var element$$6 = JAM.call(midori.get, midori, ["#" + id$$1]);
  var outsideSize$$1 = JAM.call(this.getOutsideSize, this, [element$$6, what$$2]);
  ...
  var vars$$4 = {intervalKey:v187, element:element$$6, outsideSize:outsideSize$$1, elementSize:v1114 - outsideSize$$1, callback:callback$$27, constantSpeed:constantSpeed, what:what$$2};
...
function v89(id, callback$$26, horiz) {
  ...
  var what$$1 = v206;
  var element$$5 = JAM.call(midori.get, midori, ["#" + id]);
  var vars$$2 = {intervalKey:Math.random(), element:element$$5, callback:callback$$26, what:what$$1};
  JAM.call(midori.setStyles, midori, [element$$5, {overflow:"hidden", visibility:"hidden", display:"block"}]);
  var v749 = vars$$2;
  var v1357;
  if(horiz) {
  ...
  v749.elementSize = v1357 - JAM.call(this.getOutsideSize, this, [element$$5, what$$1]);
  JAM.call(midori.setStyles, midori, [element$$5, {display:"none", visibility:"visible"}]);
...
function v80(element$$3, cb, callback$$25) {
  ...
  if(cb.checked) {
    ...
    JAM.set(element$$3, "innerHTML", element$$3.innerHTML + 1)
  }else {
    var v787;
    if(JAM.set(element$$3, "innerHTML", element$$3.innerHTML - 1) == 0) {
      v787 = JAM.set(element$$3, "innerHTML", "")
    }else {
      v787 = {}
    }
    v257 = v787
  ...
  v257;
  if(callback$$25) {
    JAM.call(callback$$25, null, [element$$3.innerHTML])
  }
  return
}
...
function v75(v$$2, a$$4) {
  ...
  for(;v275;) {
    var v1150 = v$$2 != null;
    if(v1150) {
      var v1375 = a$$4[i$$14].constructor == Array;
      if(v1375) {
        var v1491 = v$$2.constructor == Array;
        if(v1491) {
          v1491 = a$$4[i$$14].toString() == v$$2.toString()
        }
        v1375 = v1491
      }
      v1150 = v1375
...
function v68(name$$31, value$$30, expires, path, domain) {
  ...
  var today = new Date;
  var v293 = document;
  var v1162 = name$$31 + "=" + escape(value$$30) + "; expires=" + today.toUTCString(today.setSeconds(expires));
  var v1379;
  if(path) {
    v1379 = "; path=" + path
  }else {
...
function v57(target$$38, eventType$$2, listenerFunc) {
  ...
  if(target$$38.addEventListener) {
    ...
    JAM.call(target$$38.addEventListener, target$$38, [eventType$$2, listenerFunc, false]);
    return
  }
  if(eventType$$2 == "ready") {
  ...
  JAM.call(target$$38.attachEvent, target$$38, ["on" + eventType$$2, listenerFunc]);
  return
}
function v52(obj$$19) {
...
function v49(stylesheet, rule$$2, property$$3) {
  ...
  if(this.browserType == "Safari") {
    v340 = JAM.call(property$$3.replace, property$$3, [/([A-Z])/, "-$1"]).toLowerCase()
  }else {
    ...
    if(v851) {
      ...
      for(j$$1 in rules[i$$6].style) {
        if(this.browserType == "Safari") {
          ...
          if(v854) {
            v854 = rules[i$$6].style[j$$1].toLowerCase() == property$$3
          }
          if(v854) {
            if(rule$$2 == "*") {
...
function v48(selectorText$$1, startAt) {
  ...
  if(numS == 1) {
    ...
    var v866 = idMatch;
    if(v866) {
      var v1188 = selectors$$7["attrs"][0] == "";
      if(v1188) {
        v1188 = selectors$$7["separators"] == ""
      }
      v866 = v1188
    }
    if(v866) {
...
function v46(target$$37, s$$2, a$$1, oneLevelOnly) {
  ...
  if(s$$2.indexOf("#") != -1) {
    ...
    if(s$$2.indexOf(".") != -1) {
      ...
      objs = target$$37.getElementsByTagName(v895);
      i$$3 = 0;
      numObjs = objs.length;
      ...
      for(;v401;) {
        ...
        if(v1206) {
          v1206 = className.test(objs[i$$3].className)
        }
        var v896 = v1206;
        if(!v896) {
          var v1207 = oneLevelOnly;
          if(v1207) {
            var v1397 = className.test(objs[i$$3].className);
            if(v1397) {
              v1397 = objs[i$$3].parentNode == target$$37
            }
            v1207 = v1397
          }
          v896 = v1207
      ...
      if(v897) {
        ...
        for(;v404;) {
          ...
          if(!v898) {
            ...
            if(v1210) {
              v1210 = objs[i$$3].parentNode == target$$37
            }
            v898 = v1210
          }
          if(v898) {
...
function midoriDragDrop(containerId$$1, dropCallback) {
  ...
  function v13(o$$10, dragged, spacer) {
    ...
    var v490;
    var v1245 = o$$10.where == "next";
    if(v1245) {
      v1245 = !o$$10.obj.nextSibling
    }
    if(v1245) {
      ...
      v490 = JAM.call(v953.appendChild, v953, [v1247])
    }else {
      ...
      if(o$$10.where == "prev") {
        ...
        v1250 = o$$10.obj.nextSibling
      }
      v490 = JAM.call(v955.insertBefore, v955, [v956, v1250])
    }
    return v490
  }
  ...
  function v8(event$$5, mouseUp) {
    ...
    for(;v529;) {
      if(objCoords = this.objsCoords[j$$2]) {
        var v1429 = mousePos$$1.x >= objCoords.x;
        if(v1429) {
          v1429 = mousePos$$1.x <= objCoords.x + objCoords.width
        }
        var v1266 = v1429;
        if(v1266) {
          var v1430 = mousePos$$1.y >= objCoords.y;
          if(v1430) {
            v1430 = mousePos$$1.y <= objCoords.y + objCoords.height
          }
          v1266 = v1430
        }
        if(!v1266) {
  ...
  function v7() {
    function v6(o$$8) {
      ...
      var v994 = /not-draggable/.test(o$$8.className);
      if(!v994) {
        var v1274 = !/draggable/.test(o$$8.className);
        if(!v1274) {
          v1274 = o$$8.style.display == "none"
        }
        v994 = v1274
      }
      if(v994) {
...
function midoriAjax(callback$$29, params$$1, cache) {
  function v20(where, what$$3, verb, headers) {
    ...
    if(verb) {
      ...
      v554 = JAM.call(midori.trim, midori, [v1439.toUpperCase()])
    }else {
      v554 = "POST"
    }
    verb = v554;
  ...
  try {
    ...
    try {
      var v1651 = JAM.new(ActiveXObject, ["Msxml2.XMLHTTP"]);
      this.request = v1651
    }catch(e$$16) {
      var v1652 = JAM.new(ActiveXObject, ["Microsoft.XMLHTTP"]);
      this.request = v1652
    }
  }
...
function midoriAutoComplete(vars$$7) {
  ...
  function v27(snippet$$3) {
    ...
    for(i$$25 in this.suggestions[snippet$$3]) {
      if((pos = pos + 1) == this.suggestionPos) {
        ...
        var v1288;
        if(vars$$7.callback) {
          v1288 = JAM.call(vars$$7.callback, vars$$7, [this.suggestions[snippet$$3][i$$25]])
        }else {
          v1288 = this.suggestions[snippet$$3][i$$25]
        }
        var v1655 = JAM.call(v1022.replace, v1022, [snippet$$3, v1288]);
        v591.value = v1655;
        break
      }
    }
  ...
  function v26(suggestionPos) {
    var v1289 = "#" + this.popupId + " .";
    var v1450 = vars$$7.suggestionSelectedClass;
    var v596 = JAM.call(midori.get, midori, [v1289 + JAM.call(v1450.replace, v1450, [" ", "."])]);
  ...
  function v25(snippet$$2) {
    ...
    for(i$$24 in suggestions) {
      ...
      var v1027 = html;
      var v1452 = '<a id="midori_suggestion' + this.uniqid + "_" + (j$$5 = j$$5 + 1) + '" class="' + vars$$7.suggestionClass + '" href="#">';
      var v1543;
      if(vars$$7.htmlTemplate) {
        v1543 = JAM.call(midori.replace, midori, [vars$$7.htmlTemplate, properties])
      }else {
        v1543 = suggestions[i$$24]
      }
      html = v1027 + (v1452 + v1543 + "</a>\n")
    }
    if(!html) {
      midoriPopup.hide();
      return
...
function midoriInlineEdit(vars$$8) {
  function v39() {
    ...
    var v1316 = this.editObj.value;
    var v1060 = JAM.call(v1316.replace, v1316, ["\n", ""]);
  ...
  function v37() {
    ...
    var value$$31 = JAM.call(v658.replace, v658, [/"/g, "&quot;"]);
    var v659 = this.myObj;
    var v1065;
    if(vars$$8.textArea) {
      ...
      v1065 = JAM.call(midori.replace, midori, ['<textarea style="width: :w; height: :h; overflow: auto">:value</textarea>', {w:v1460, h:v1597 - v1620 + "px", value:value$$31}])
    }else {
      var v1546;
      if(vars$$8.size) {
        v1546 = vars$$8.size
      ...
      v1065 = JAM.call(midori.replace, midori, ['<input type="text" size=":size" maxlength=":maxlen" value=":value" />', {size:v1462, maxlen:v1547, value:value$$31}])
    }
