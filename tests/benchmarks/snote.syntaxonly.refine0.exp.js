...
function v88() {
  function v87(a$$54, b$$34, d$$20, e$$34, f$$18, h$$15, i$$13, g$$11) {
    ...
    n$$8 = v112 ^ v113;
    JAM.set(a$$54, b$$34, s$$8, JAM.policy.p21);
    JAM.set(a$$54, b$$34 + 1, u, JAM.policy.p21);
    JAM.set(a$$54, b$$34 + 2, v, JAM.policy.p21);
    JAM.set(a$$54, b$$34 + 3, n$$8, JAM.policy.p21);
    return;
  }
  function v86(c$$31, b$$33) {
    ...
    JAM.set(c$$31, b$$33 + 1, JAM.get(c$$31, b$$33 + 3, JAM.policy.p21), JAM.policy.p21);
    JAM.set(c$$31, b$$33 + 3, d$$19, JAM.policy.p21);
  ...
  function v66() {
    ...
    function b$$20(b$$21, a$$38, d$$11) {
      ...
      for (;v205;) {
        ...
        JAM.set(b$$21, v204, v601 ^ v602, JAM.policy.p21);
        e$$25 = e$$25 + 1;
        v205 = e$$25 < d$$11;
      }
      return;
...
function v45(p$$2) {
  function v44() {
    ...
    for (;v243;) {
      ...
      JAM.set(f$$7, g$$6, (a$$28 << 8 | a$$28 >>> 24) & 16711935 | (a$$28 << 24 | a$$28 >>> 8) & 4278255360, JAM.policy.p21);
      g$$6 = g$$6 + 1;
      v243 = 4 > g$$6;
    }
    return;
  ...
  function v43(f$$6, g$$5) {
    ...
    for (;v246;) {
      ...
      JAM.set(f$$6, e$$21, (c$$15 << 8 | c$$15 >>> 24) & 16711935 | (c$$15 << 24 | c$$15 >>> 8) & 4278255360, JAM.policy.p21);
      a$$27 = a$$27 + 1;
      v246 = 16 > a$$27;
    }
  ...
  function v11() {
    ...
    function v9(a$$2) {
      ...
      for (c$$1 in a$$2) {
        ...
        if (v329) {
          JAM.set(this, c$$1, JAM.get(a$$2, c$$1, JAM.policy.p21), JAM.policy.p21);
        }
      }
...
function SNote(serverPath, divParent) {
  function init(divParent$$1, serverPath$$1) {
    ...
    JAM.set(label, "textContent", "Are you sure you want to delete?", JAM.policy.p22);
  ...
  function createPasswordPanel(parent$$1, strPrompt, strPasswordInputId) {
    ...
    JAM.set(labelPassword, "textContent", strPrompt, JAM.policy.p22);
  ...
  function handleDeleteDialogOk() {
    ...
    function v0(strId) {
      JAM.set(m_preNote, "textContent", "", JAM.policy.p22);
      fetch(m_strId, handleSuccessfulFetch, handleFailedFetch);
      return;
    }
    deleteSNote(v0, v1);
  ...
  function handleUnlockDialogOk() {
    ...
    JAM.set(m_preNote, "textContent", JSCompiler_inline_result$$0, JAM.policy.p22);
    closeDialogsBoxes();
    m_imageEdit.style.display = "none";
...
function SNoteSwindler(serverPath$$4, divParent$$2, strNoteId) {
  function createButton(strLabel$$1, strFunc, parent$$5) {
    ...
    button.type = "input";
    JAM.set(button, "textContent", strLabel$$1, JAM.policy.p22);
  ...
  function forgeNote() {
    ...
    JAM.set(preNote, "textContent", "Forged note", JAM.policy.p22);
    return;
  }
  function forgeNoteInnerHTML() {
    preNote = document.getElementById("note");
    JAM.set(preNote, "innerHTML", "Forged note", JAM.policy.p9);
    return;
  }
  function readNote() {
    preNote = document.getElementById("note");
