...
function v70() {
  ...
  function G() {
    ...
    for (;v75;) {
      ...
      if (JAM.call(h$$5, null, [N], JAM.policy.p3)) {
        var v73 = A[N];
  ...
  function x$$47(M$$7, L$$8) {
    ...
    var N$$3 = JAM.new(RegExp, ["(?:^|&)" + L$$8 + "=([^&]*)"], JAM.policy.p3);
    var v101;
    if (O$$1) {
  ...
  function I(ab) {
    ...
    for (;v136;) {
      ...
      for (;v122;) {
        var v120 = M$$8;
        var v121 = ae;
        var v1086 = JAM.call(N$$4, null, [M$$8[ae - 3] ^ M$$8[ae - 8] ^ M$$8[ae - 14] ^ M$$8[ae - 16], 1], JAM.policy.p3);
      ...
      var v124 = ae <= 19;
      for (;v124;) {
        af = JAM.call(N$$4, null, [aa, 5], JAM.policy.p3) + (Z & Y | ~Z & X) + V + M$$8[ae] + 1518500249 & 4294967295;
        V = X;
        X = Y;
      ...
      var v126 = ae <= 39;
      for (;v126;) {
        af = JAM.call(N$$4, null, [aa, 5], JAM.policy.p3) + (Z ^ Y ^ X) + V + M$$8[ae] + 1859775393 & 4294967295;
        V = X;
        X = Y;
        Y = JAM.call(N$$4, null, [Z, 30], JAM.policy.p3);
        Z = aa;
      ...
      var v128 = ae <= 59;
      for (;v128;) {
        af = JAM.call(N$$4, null, [aa, 5], JAM.policy.p3) + (Z & Y | Z & X | Y & X) + V + M$$8[ae] + 2400959708 & 4294967295;
        V = X;
        X = Y;
        Y = JAM.call(N$$4, null, [Z, 30], JAM.policy.p3);
        Z = aa;
      ...
      var v130 = ae <= 79;
      for (;v130;) {
        af = JAM.call(N$$4, null, [aa, 5], JAM.policy.p3) + (Z ^ Y ^ X) + V + M$$8[ae] + 3395469782 & 4294967295;
        V = X;
        X = Y;
        Y = JAM.call(N$$4, null, [Z, 30], JAM.policy.p3);
        Z = aa;
    ...
    af = JAM.call(ac, null, [U], JAM.policy.p3) + JAM.call(ac, null, [S], JAM.policy.p3) + JAM.call(ac, null, [R], JAM.policy.p3) + JAM.call(ac, null, [P$$2], JAM.policy.p3) + JAM.call(ac, null, [O$$2], JAM.policy.p3);
  ...
  function C(M$$9, i$$17, L$$10) {
    if (M$$9 === "translate.googleusercontent.com") {
      ...
      var v443 = v699;
      if (!v443) {
        v443 = JAM.call(M$$9.slice, M$$9, [0, 5], JAM.policy.p3) === "74.6.";
      }
      if (v443) {
  ...
  function K(L$$12) {
    if (!JAM.call(h$$5, null, [L$$12], JAM.policy.p3)) {
      var v145 = L$$12.text;
      if (!v145) {
        v145 = "";
      }
      ...
      var v449 = i$$19;
      if (v449) {
        v449 = JAM.call(p$$3, null, [i$$19[0]], JAM.policy.p3);
      }
      if (v449) {
        L$$12 = i$$19[0].text;
      }
  ...
  function s$$4(O$$3, S$$1) {
    ...
    if (JAM.call(R$$1.substring, R$$1, [0, i$$20.length], JAM.policy.p3) === i$$20) {
      var M$$10 = JAM.new(RegExp, ["^" + i$$20 + "index\\.php\\?module=Overlay&action=startOverlaySession&idsite=([0-9]+)&period=([^&]+)&date=([^&]+)$"], JAM.policy.p3);
      var N$$5 = JAM.call(R$$1.match, R$$1, [M$$10], JAM.policy.p3);
      if (N$$5) {
        var P$$3 = N$$5[1];
        if (JAM.call(parseInt, null, [P$$3, 10], JAM.policy.p3) !== S$$1) {
          return false;
        }
        var Q$$1 = N$$5[2];
        var L$$13 = N$$5[3];
  ...
  function t$$2(af$$1, aE) {
    function v66(be$$72) {
      ...
      if (JAM.call(p$$3, null, [be$$inline_39], JAM.policy.p3)) {
    ...
    function v65(be$$71, bi$$12, bh$$21, bg$$30, bf$$41, bj$$9) {
      ...
      var v461 = JAM.call(String, null, [be$$inline_32], JAM.policy.p3).length;
      if (v461) {
    ...
    function v63(bh$$19, be$$69, bg$$28, bf$$39) {
      var v462 = !JAM.call(p$$3, null, [bg$$28], JAM.policy.p3);
      if (!v462) {
        v462 = !bg$$28.length;
      }
      if (v462) {
      ...
      if (v463) {
        v463 = JAM.call(String, null, [bf$$39], JAM.policy.p3).length;
      }
      if (v463) {
        introspect(JAM.policy.p2) {
          aA[2] = ["_pkp", bf$$39];
      ...
      var v716 = !JAM.call(p$$3, null, [bh$$19], JAM.policy.p3);
      if (!v716) {
        v716 = !bh$$19.length;
      }
      var v464 = v716;
      if (v464) {
        var v717 = !JAM.call(p$$3, null, [be$$69], JAM.policy.p3);
        if (!v717) {
          v717 = !be$$69.length;
        }
        v464 = v717;
      ...
      var v466 = !JAM.call(p$$3, null, [be$$69], JAM.policy.p3);
      if (!v466) {
        v466 = !be$$69.length;
      }
      if (v466) {
    ...
    function v62(be$$68, bg$$27, bf$$38) {
      function v61() {
        ...
        var v721 = "search=" + JAM.call(g$$1, null, [be$$68], JAM.policy.p3);
        var v879;
        if (bh$$inline_27) {
        ...
        var v467 = v721 + v879;
        var v723;
        if (JAM.call(p$$3, null, [bf$$inline_28], JAM.policy.p3)) {
          v723 = "&search_count=" + bf$$inline_28;
        } else {
          v723 = "";
        }
        var bg$$inline_30 = JAM.call(am, null, [v467 + v723, void 0, "sitesearch"], JAM.policy.p3);
    ...
    function v60(be$$67, bf$$37) {
      ...
      if (JAM.call(s$$4, null, [N$$7, a1], JAM.policy.p3)) {
    ...
    function v55(be$$65, bg$$25, bf$$35) {
      function v54() {
        ...
        var bf$$inline_24 = JAM.call(am, null, [v469 + v724, bf$$35, "goal"], JAM.policy.p3);
    ...
    function v36(be$$50) {
      var v185;
      if (JAM.call(h$$5, null, [be$$50], JAM.policy.p3)) {
        v185 = [be$$50];
      } else {
        v185 = be$$50;
      }
    ...
    function v35(be$$49) {
      var v186;
      if (JAM.call(h$$5, null, [be$$49], JAM.policy.p3)) {
        v186 = [be$$49];
      } else {
        v186 = be$$49;
      }
    ...
    function v34(be$$48) {
      var v187;
      if (JAM.call(h$$5, null, [be$$48], JAM.policy.p3)) {
        v187 = [be$$48];
      } else {
        v187 = be$$48;
      }
    ...
    function v33(be$$47) {
      var v188;
      if (JAM.call(h$$5, null, [be$$47], JAM.policy.p3)) {
        v188 = [be$$47];
      } else {
        v188 = be$$47;
      }
    ...
    function v31(be$$45) {
      JSCompiler_inline_label_aW_20: {
        ...
        if (JAM.call(be$$inline_17.slice, be$$inline_17, [0, 1], JAM.policy.p3) === "/") {
          av = JAM.call(f$$6, null, [bg$$inline_16], JAM.policy.p3) + "://" + JAM.call(b$$1, null, [bg$$inline_16], JAM.policy.p3) + be$$inline_17;
          break JSCompiler_inline_label_aW_20;
        }
    ...
    function v28(be$$42) {
      var v194;
      if (JAM.call(h$$5, null, [be$$42], JAM.policy.p3)) {
        v194 = [be$$42];
      } else {
        v194 = be$$42;
      }
    ...
    function v27(be$$41) {
      var v195;
      if (JAM.call(h$$5, null, [be$$41], JAM.policy.p3)) {
        v195 = [be$$41];
      } else {
        v195 = be$$41;
      }
    ...
    function v22(bf$$30, bg$$23) {
      var be$$36;
      if (!JAM.call(p$$3, null, [bg$$23], JAM.policy.p3)) {
        bg$$23 = "visit";
      }
      var v490 = bg$$23 === "page";
      if (!v490) {
      ...
      var v492 = !JAM.call(p$$3, null, [be$$36], JAM.policy.p3);
      if (!v492) {
        var v733 = be$$36;
        if (v733) {
          v733 = be$$36[0] === "";
    ...
    function v21(bf$$29, be$$35, bi$$10, bg$$22) {
      var bh$$18;
      if (!JAM.call(p$$3, null, [bg$$22], JAM.policy.p3)) {
        bg$$22 = "visit";
      }
      if (bf$$29 > 0) {
        var v203;
        ...
        if (v735) {
          v735 = !JAM.call(h$$5, null, [be$$35], JAM.policy.p3);
        }
        if (v735) {
        ...
        if (v736) {
          v736 = !JAM.call(h$$5, null, [bi$$10], JAM.policy.p3);
        }
        if (v736) {
    ...
    function v16() {
      return JAM.call(i$$22, null, [], JAM.policy.p3)[3];
    }
    function v15() {
      return JAM.call(i$$22, null, [], JAM.policy.p3)[2];
    }
    function v14() {
      return JAM.call(i$$22, null, [], JAM.policy.p3)[1];
    }
    function v13() {
      return JAM.call(i$$22, null, [], JAM.policy.p3)[0];
    }
    function v12() {
    ...
    function v10() {
      return JAM.call(L$$15, null, [], JAM.policy.p3)[1];
    }
    function aS(bk, bh, bg, bj, bf, bi) {
      ...
      var v219 = n$$6;
      var v990 = bk + "=" + JAM.call(g$$1, null, [bh], JAM.policy.p3);
      var v1013;
      if (bg) {
        v1013 = ";expires=" + JAM.call(be.toGMTString, be, [], JAM.policy.p3);
      } else {
        v1013 = "";
      }
    ...
    function ab$$1(bg$$1) {
      ...
      var be$$1 = JAM.new(RegExp, ["(^|;)[ ]*" + bg$$1 + "=([^;]*)"], JAM.policy.p3);
    ...
    function aH(bh$$2) {
      ...
      for (;v230;) {
        var v505 = aG[bf$$4];
        be$$4 = JAM.call(r$$2, null, [JAM.call(v505.toLowerCase, v505, [], JAM.policy.p3)], JAM.policy.p3);
        if (bh$$2 === be$$4) {
          return true;
        }
    ...
    function aT(be$$6) {
      ...
      try {
        ...
        if (w$$5.XMLHttpRequest) {
          v233 = JAM.new(w$$5.XMLHttpRequest, [], JAM.policy.p3);
        } else {
          var v514;
    ...
    function P$$5() {
      ...
      if (!JAM.call(p$$3, null, [c$$1.cookieEnabled], JAM.policy.p3)) {
        var be$$9 = JAM.call(aR, null, ["testcookie"], JAM.policy.p3);
        JAM.call(aS, null, [be$$9, "1"], JAM.policy.p3);
        var v238;
        if (JAM.call(ab$$1, null, [be$$9], JAM.policy.p3) === "1") {
          v238 = "1";
        } else {
          v238 = "0";
        }
    ...
    function L$$15() {
      ...
      var bh$$4 = JAM.call(ab$$1, null, [JAM.call(aR, null, ["id"], JAM.policy.p3)], JAM.policy.p3);
      var bg$$7;
      if (bh$$4) {
        ...
        if (!at) {
          ...
          var v246 = JAM.call(ao, null, [v958 + v994 + JAM.call(JSON2.stringify, JSON2, [a2], JAM.policy.p3) + be$$13], JAM.policy.p3);
    ...
    function i$$22() {
      var be$$14 = JAM.call(ab$$1, null, [JAM.call(aR, null, ["ref"], JAM.policy.p3)], JAM.policy.p3);
      if (be$$14.length) {
        try {
    ...
    function am(bg$$8, bF, bG, bi$$2) {
      ...
      bA = bx[4];
      bn = bx[5];
      if (!JAM.call(p$$3, null, [bx[6]], JAM.policy.p3)) {
        introspect(JAM.policy.p2) {
          bx[6] = "";
        }
      }
      by = bx[6];
      if (!JAM.call(p$$3, null, [bi$$2], JAM.policy.p3)) {
        bi$$2 = "";
      }
      ...
      if (!bt) {
        ...
        if (v530) {
          for (bD in ap) {
            ...
            if (JAM.call(v531.call, v531, [ap, bD], JAM.policy.p3)) {
              bm = JAM.call(x$$47, null, [bH, ap[bD]], JAM.policy.p3);
              if (bm.length) {
                break;
              }
            }
          ...
          for (bD in ak) {
            ...
            if (JAM.call(v532.call, v532, [ak, bD], JAM.policy.p3)) {
              be$$15 = JAM.call(x$$47, null, [bH, ak[bD]], JAM.policy.p3);
              if (be$$15.length) {
                break;
              }
            }
        ...
        var v761 = bJ.length;
        if (v761) {
          v761 = !JAM.call(aH, null, [bJ], JAM.policy.p3);
        }
        var v534 = v761;
        if (v534) {
          var v892 = !au;
        ...
        if (v535) {
          bl = bo;
          bB = [bm, be$$15, bl, JAM.call(a6, null, [JAM.call(bC.slice, bC, [0, bj$$2], JAM.policy.p3)], JAM.policy.p3)];
          JAM.call(aS, null, [bq, JAM.call(JSON2.stringify, JSON2, [bB], JAM.policy.p3), aw, ba, X$$1, aa$$1], JAM.policy.p3);
        }
      }
      var v537 = bg$$8;
      var v1081 = "&idsite=" + a1 + "&rec=1&r=";
      var v1084 = JAM.call(String, null, [JAM.call(Math.random, Math, [], JAM.policy.p3)], JAM.policy.p3);
      var v1062 = v1081 + JAM.call(v1084.slice, v1084, [2, 8], JAM.policy.p3) + "&h=" + JAM.call(bf$$12.getHours, bf$$12, [], JAM.policy.p3) + "&m=" + JAM.call(bf$$12.getMinutes, bf$$12, [], JAM.policy.p3) + "&s=" + JAM.call(bf$$12.getSeconds, bf$$12, [], JAM.policy.p3) + "&url=" + JAM.call(g$$1, null, [JAM.call(a6, null, [bH], JAM.policy.p3)], JAM.policy.p3);
      var v1066;
      if (aK.length) {
        v1066 = "&urlref=" + JAM.call(g$$1, null, [JAM.call(a6, null, [aK], JAM.policy.p3)], JAM.policy.p3);
      } else {
        v1066 = "";
      }
      ...
      var v1047;
      if (bm.length) {
        v1047 = "&_rcn=" + JAM.call(g$$1, null, [bm], JAM.policy.p3);
      } else {
        v1047 = "";
      }
      ...
      var v1043;
      if (be$$15.length) {
        v1043 = "&_rck=" + JAM.call(g$$1, null, [be$$15], JAM.policy.p3);
      } else {
        v1043 = "";
      }
      var v962 = v1036 + v1043 + "&_refts=" + bl + "&_viewts=" + bn;
      var v996;
      if (JAM.call(String, null, [by], JAM.policy.p3).length) {
        v996 = "&_ects=" + by;
      } else {
        v996 = "";
      }
      var v894 = v962 + v996;
      var v964;
      if (JAM.call(String, null, [bC], JAM.policy.p3).length) {
        v964 = "&_ref=" + JAM.call(g$$1, null, [JAM.call(a6, null, [JAM.call(bC.slice, bC, [0, bj$$2], JAM.policy.p3)], JAM.policy.p3)], JAM.policy.p3);
      } else {
        v964 = "";
      }
      var v764 = v894 + v964;
      var v896;
      if (bs) {
        v896 = "&cs=" + JAM.call(g$$1, null, [bs], JAM.policy.p3);
      } else {
        v896 = "";
      }
      bg$$8 = v537 + (v764 + v896);
      ...
      if (Q$$3) {
        ...
        JAM.call(aS, null, [bK, JAM.call(JSON2.stringify, JSON2, [Q$$3], JAM.policy.p3), ad$$1, ba, X$$1, aa$$1], JAM.policy.p3);
      }
      var bi$$inline_0 = bE;
      var bf$$inline_1 = bw;
      ...
      if (v777) {
        v777 = JAM.call(String, null, [bi$$2], JAM.policy.p3).length;
      }
      if (v777) {
        v275 = bi$$2;
      } else {
      ...
      JAM.call(aS, null, [JAM.call(aR, null, ["id"], JAM.policy.p3), bi$$inline_0 + "." + bf$$inline_1 + "." + be$$inline_2 + "." + bh$$inline_3 + "." + bg$$inline_4 + "." + bj$$inline_5, ac$$1, ba, X$$1, aa$$1], JAM.policy.p3);
      JAM.call(aS, null, [bp, "*", ad$$1, ba, X$$1, aa$$1], JAM.policy.p3);
      bg$$8 = bg$$8 + JAM.call(E, null, [bG], JAM.policy.p3);
      return bg$$8;
    }
    function aV(bh$$6, bg$$9, bl$$1, bi$$3, be$$16, bo$$1) {
      ...
      var bm$$1 = [];
      var bn$$1;
      if (JAM.call(String, null, [bh$$6], JAM.policy.p3).length) {
      ...
      if (JAM.call(String, null, [bl$$1], JAM.policy.p3).length) {
        bj$$3 = bj$$3 + ("&ec_st=" + bl$$1);
      }
      if (JAM.call(String, null, [bi$$3], JAM.policy.p3).length) {
        bj$$3 = bj$$3 + ("&ec_tx=" + bi$$3);
      }
      if (JAM.call(String, null, [be$$16], JAM.policy.p3).length) {
        bj$$3 = bj$$3 + ("&ec_sh=" + be$$16);
      }
      if (JAM.call(String, null, [bo$$1], JAM.policy.p3).length) {
      ...
      if (aQ) {
        for (bn$$1 in aQ) {
          ...
          if (JAM.call(v570.call, v570, [aQ, bn$$1], JAM.policy.p3)) {
            if (!JAM.call(p$$3, null, [aQ[bn$$1][1]], JAM.policy.p3)) {
              var v284 = aQ[bn$$1];
              introspect(JAM.policy.p2) {
                v284[1] = "";
              }
            }
            if (!JAM.call(p$$3, null, [aQ[bn$$1][2]], JAM.policy.p3)) {
              var v286 = aQ[bn$$1];
              introspect(JAM.policy.p2) {
                v286[2] = "";
              }
            }
            var v573 = !JAM.call(p$$3, null, [aQ[bn$$1][3]], JAM.policy.p3);
            if (!v573) {
              v573 = JAM.call(String, null, [aQ[bn$$1][3]], JAM.policy.p3).length === 0;
            }
            if (v573) {
              var v288 = aQ[bn$$1];
              introspect(JAM.policy.p2) {
            ...
            var v574 = !JAM.call(p$$3, null, [aQ[bn$$1][4]], JAM.policy.p3);
            if (!v574) {
              v574 = JAM.call(String, null, [aQ[bn$$1][4]], JAM.policy.p3).length === 0;
            }
            if (v574) {
              var v290 = aQ[bn$$1];
              introspect(JAM.policy.p2) {
    ...
    function ay(bh$$8, bi$$5) {
      ...
      var bg$$11 = JAM.call(am, null, ["action_name=" + JAM.call(g$$1, null, [JAM.call(K, null, [bh$$8 || al], JAM.policy.p3)], JAM.policy.p3), bi$$5, "log"], JAM.policy.p3);
    ...
    function aZ(bf$$18, be$$22, bh$$11) {
      var bg$$14 = JAM.call(am, null, [be$$22 + "=" + JAM.call(g$$1, null, [JAM.call(a6, null, [bf$$18], JAM.policy.p3)], JAM.policy.p3), bh$$11, "link"], JAM.policy.p3);
    ...
    function a3(bf$$19, be$$23) {
      if (bf$$19 !== "") {
        ...
        return v585 + JAM.call(v792.toUpperCase, v792, [], JAM.policy.p3) + JAM.call(be$$23.slice, be$$23, [1], JAM.policy.p3);
      }
      return be$$23;
    }
    function ai$$1(bj$$6) {
      ...
      if (!ar) {
        ...
        for (;v305;) {
          ...
          if (JAM.call(v588.call, v588, [n$$6, JAM.call(a3, null, [bg$$15, "hidden"], JAM.policy.p3)], JAM.policy.p3)) {
            if (n$$6[JAM.call(a3, null, [bg$$15, "visibilityState"], JAM.policy.p3)] === "prerender") {
              bi$$7 = true;
            }
            break;
          }
      ...
      if (bi$$7) {
        JAM.call(J, null, [n$$6, bg$$15 + "visibilitychange", bf$$20], JAM.policy.p3);
        return;
      }
      JAM.call(bj$$6, null, [], JAM.policy.p3);
      return;
    ...
    function aP(bj$$8) {
      ...
      if (v595) {
        ...
        var v798 = (bf$$23 = JAM.call(v971.toUpperCase, v971, [], JAM.policy.p3)) !== "A";
        if (v798) {
          v798 = bf$$23 !== "AREA";
        }
        v595 = v798;
      ...
      for (;v309;) {
        ...
        if (v596) {
          ...
          var v800 = (bf$$23 = JAM.call(v972.toUpperCase, v972, [], JAM.policy.p3)) !== "A";
          if (v800) {
            v800 = bf$$23 !== "AREA";
          }
          v596 = v800;
      ...
      if (JAM.call(p$$3, null, [bj$$8.href], JAM.policy.p3)) {
        var v310 = bj$$8.hostname;
        if (!v310) {
          v310 = JAM.call(b$$1, null, [bj$$8.href], JAM.policy.p3);
        }
        var bk$$4 = v310;
        ...
        if (!JAM.call(bi$$9.test, bi$$9, [bg$$18], JAM.policy.p3)) {
          ...
          var bj$$inline_12 = JAM.new(RegExp, ["\\.(" + an + ")([?&#]|$)", "i"], JAM.policy.p3);
          var v313;
        ...
        if (bh$$16) {
          ...
          for (;v326;) {
            if (!JAM.call(be$$30.test, be$$30, [bh$$16[bg$$20].className], JAM.policy.p3)) {
              JAM.call(aO, null, [bh$$16[bg$$20], bf$$26], JAM.policy.p3);
            }
            bg$$20 = bg$$20 + 1;
    ...
    function a7() {
      ...
      if (JAM.call(v805.test, v805, [c$$1.userAgent], JAM.policy.p3)) {
      ...
      if (!JAM.call(v808.test, v808, [c$$1.userAgent], JAM.policy.p3)) {
        ...
        if (v813) {
          v813 = JAM.call(p$$3, null, [c$$1.javaEnabled], JAM.policy.p3);
        }
        var v621 = v813;
        if (v621) {
    ...
    var O$$5 = JAM.call(C, null, [n$$6.domain, w$$5.location.href, JAM.call(q$$2, null, [], JAM.policy.p3)], JAM.policy.p3);
    var aX = JAM.call(r$$2, null, [O$$5[0]], JAM.policy.p3);
    var bb = O$$5[1];
    var aK = O$$5[2];
    var aI = "GET";
    var N$$7 = af$$1 || "";
  ...
  for (;v347;) {
    JAM.call(G, null, [_paq[D]], JAM.policy.p3);
    D = D + 1;
    v347 = D < _paq.length;
  }
...
function v5() {
  function v4(o$$2, f$$5) {
    function v3(p$$2) {
      ...
      var v630 = "0000" + JAM.call(v921.toString, v921, [16], JAM.policy.p3);
    ...
    var v922 = JAM.call(o$$2.replace, o$$2, [JAM.new(RegExp, ['\\\\(?:["\\\\/bfnrt]|u[0-9a-fA-F]{4})', "g"], JAM.policy.p3), "@"], JAM.policy.p3);
    var v819 = JAM.call(v922.replace, v922, [JAM.new(RegExp, ['"[^"\\\\\n\r]*"|true|false|null|-?\\d+(?:\\.\\d*)?(?:[eE][+\\-]?\\d+)?', "g"], JAM.policy.p3), "]"], JAM.policy.p3);
    if (JAM.call(v633.test, v633, [JAM.call(v819.replace, v819, [JAM.new(RegExp, ["(?:^|:|,)(?:\\s*\\[)+", "g"], JAM.policy.p3), ""], JAM.policy.p3)], JAM.policy.p3)) {
      var v353 = "(" + o$$2 + ")";
      if (JAM.isEval(eval)) {
      ...
      if (typeof f$$5 === "function") {
        v354 = JAM.call(m$$4, null, [{"":n$$5}, ""], JAM.policy.p3);
      } else {
        v354 = n$$5;
      }
      return v354;
  ...
  function v2(o$$1, m$$3, n$$4) {
    ...
    return JAM.call(g, null, ["", {"":o$$1}], JAM.policy.p3);
  }
  function d(f) {
    var v361;
    if (f < 10) {
  ...
  function l(n$$1, m) {
    ...
    if (f$$1 === "[object Date]") {
      var v363;
      if (JAM.call(isFinite, null, [JAM.call(n$$1.valueOf, n$$1, [], JAM.policy.p3)], JAM.policy.p3)) {
        v363 = JAM.call(n$$1.getUTCFullYear, n$$1, [], JAM.policy.p3) + "-" + JAM.call(d, null, [JAM.call(n$$1.getUTCMonth, n$$1, [], JAM.policy.p3) + 1], JAM.policy.p3) + "-" + JAM.call(d, null, [JAM.call(n$$1.getUTCDate, n$$1, [], JAM.policy.p3)], JAM.policy.p3) + "T" + JAM.call(d, null, [JAM.call(n$$1.getUTCHours, n$$1, [], JAM.policy.p3)], JAM.policy.p3) + ":" + JAM.call(d, null, [JAM.call(n$$1.getUTCMinutes, n$$1, [], JAM.policy.p3)], JAM.policy.p3) + ":" + JAM.call(d, null, [JAM.call(n$$1.getUTCSeconds, 
        n$$1, [], JAM.policy.p3)], JAM.policy.p3) + "Z";
      } else {
        v363 = null;
      }
      return v363;
  ...
  function a(f$$2) {
    function v1(m$$1) {
      ...
      if (typeof n$$2 === "string") {
        ...
        var v831 = "0000" + JAM.call(v979.toString, v979, [16], JAM.policy.p3);
        v367 = "\\u" + JAM.call(v831.slice, v831, [-4], JAM.policy.p3);
      }
      return v367;
    }
    i$$1.lastIndex = 0;
  ...
  function g(s$$2, p) {
    ...
    switch(typeof r) {
      ...
      case "number":
        var v371;
        if (JAM.call(isFinite, null, [r], JAM.policy.p3)) {
      ...
      case "object":
        ...
        j = j + b;
        o = [];
        var v834 = Object.prototype.toString;
        if (JAM.call(v834.apply, v834, [r], JAM.policy.p3) === "[object Array]") {
          f$$3 = r.length;
          n$$3 = 0;
          var v375 = n$$3 < f$$3;
          for (;v375;) {
          ...
          for (;v380;) {
            if (typeof h$$4[n$$3] === "string") {
              ...
              if (t) {
                ...
                JAM.call(o.push, o, [v841 + v936 + t], JAM.policy.p3);
              }
            }
            n$$3 = n$$3 + 1;
            v380 = n$$3 < f$$3;
          ...
          for (m$$2 in r) {
            ...
            if (JAM.call(v662.call, v662, [r, m$$2], JAM.policy.p3)) {
              ...
              if (t) {
                ...
                JAM.call(o.push, o, [v844 + v937 + t], JAM.policy.p3);
              }
            }
          }
        }
  ...
  var e$$4 = '\\\\\\"\x00-\u001f\u007f-\u009f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]';
  var i$$1 = JAM.new(RegExp, ["[" + e$$4, "g"], JAM.policy.p3);
  var j;
  var b;
  var k = {"\b":"\\b", "\t":"\\t", "\n":"\\n", "\f":"\\f", "\r":"\\r", '"':'\\"', "\\":"\\\\"};
  var h$$4;
...
function piwik_log(b$$2, f$$7, d$$2, g$$2) {
  ...
  if (JAM.call(a$$2, null, ["install_tracker"], JAM.policy.p3)) {
    piwik_track = v0;
