...
function v1() {
  function l$$1(b$$3) {
    ...
    var v3 = c$$2 < d$$2;
    for (;v3;) {
      JAM.call(k$$1, null, [b$$3[c$$2]], JAM.policy.p3);
      c$$2 = c$$2 + 1;
      v3 = c$$2 < d$$2;
    }
    b$$3 = _comscore = [];
  ...
  function k$$1(b$$2) {
    ...
    if (!!b$$2) {
      ...
      JAM.call(udm_, null, [JAM.call(e$$6.join, e$$6, [""], JAM.policy.p3), v0], JAM.policy.p3);
    }
    return;
  }
  var a$$1 = "length";
  ...
  var i$$2 = /c2=(\d*)&/;
  var j$$1;
  JAM.call(l$$1, null, [], JAM.policy.p3);
  var v44;
  if (j$$1 = b$$1.COMSCORE) {
    j$$1.purge = l$$1;
    v44 = j$$1.beacon = k$$1;
...
function udm_(a, b) {
  ...
  if (JAM.call(e$$4[g], e$$4, [c], JAM.policy.p3) + 1) {
    ...
    for (;v19;) {
      ...
      if (v48) {
        var v74 = m;
        var v101 = o[p];
        f = v74 + JAM.call(unescape, null, [JAM.call(v101[h$$4], v101, [n$$1 + c[i$$1]], JAM.policy.p3)], JAM.policy.p3);
      }
      p = p + 1;
      v19 = p < q;
    }
  ...
  var v92 = a;
  var v135 = l + "_t=" + +JAM.new(Date, [], JAM.policy.p3) + l + "c=";
  ...
  var v49;
  if (d.images) {
    n$$1 = JAM.new(Image, [], JAM.policy.p3);
    var v118 = r.ns_p;
    if (!v118) {
      ns_p = n$$1;
    }
...
JAM.call(v1, null, [], JAM.policy.p3)
