...
function v114(k$$9) {
  ...
  x$$79 = JAM.call(p$$46, null, [sc_vector2list(sc_makeVector(k$$9, "\u1e9ca"))], JAM.policy.p1);
          ...
          if (sc_x_11.car === if_constructor_nboyer) {
            ...
            if (v2169 !== false) {
              ...
              if (tmp1125 !== false) {
                ...
                v2170 = JAM.call(is_term_member_nboyer, null, [x$$76, false_lst]);
              }
              if (v2170 !== false) {
...
function v46() {
  function readList(listBeginType) {
    ...
    for (;true;) {
      ...
      switch(token$$5.type) {
        ...
        ;
        default:
          res$$25 = sc_cons(JAM.call(this.read, this, [], JAM.policy.p1), res$$25);
      }
    }
    return;
  }
    ...
    for (;true;) {
      ...
      switch(token$$6.type) {
        case 2:
          ...
          return a$$11;
        default:
          JAM.call(a$$11.push, a$$11, [JAM.call(this.read, this, [], JAM.policy.p1)], JAM.policy.p1);
      }
    }
    return;
  }
  ...
  switch(token$$4.type) {
    ...
    case 8:
      return sc_cons("quote", sc_cons(JAM.call(this.read, this, [], JAM.policy.p1), null));
    case 11:
...
function v45() {
            ...
            case "x":
              ...
              for (;true;) {
                ...
                if (v1256) {
                  ...
                  nb = nb * 16 + JAM.call(hexC.charCodeAt, hexC, [0], JAM.policy.p1) - JAM.call("0".charCodeAt, "0", [0], JAM.policy.p1);
                } else {
                  var v1259 = hexC >= "a";
                  if (v1259) {
                    v1259 = hexC <= "f";
                  ...
                  if (v1259) {
                    JAM.call(port$$1.readChar, port$$1, [], JAM.policy.p1);
                    nb = nb * 16 + JAM.call(hexC.charCodeAt, hexC, [0], JAM.policy.p1) - JAM.call("a".charCodeAt, "a", [0], JAM.policy.p1);
                  } else {
                    var v1262 = hexC >= "A";
                    if (v1262) {
                      v1262 = hexC <= "F";
                    ...
                    if (v1262) {
                      ...
                      res = res + JAM.call(String.fromCharCode, String, [nb], JAM.policy.p1);
                      break;
                    }
                  }
                }
  ...
  function readIdOrNumber(firstChar) {
    ...
    var v383 = isIdOrNumberChar(JAM.call(port$$1.peekChar, port$$1, [], JAM.policy.p1));
    for (;v383;) {
      res$$23 = res$$23 + JAM.call(port$$1.readChar, port$$1, [], JAM.policy.p1);
      v383 = isIdOrNumberChar(JAM.call(port$$1.peekChar, port$$1, [], JAM.policy.p1));
    }
    if (isNaN(res$$23)) {
  ...
  function skipWhitespaceAndComments() {
    ...
    for (;v389;) {
      ...
      var v386 = isWhitespace(JAM.call(port$$1.peekChar, port$$1, [], JAM.policy.p1));
      for (;v386;) {
        JAM.call(port$$1.readChar, port$$1, [], JAM.policy.p1);
        v386 = isWhitespace(JAM.call(port$$1.peekChar, port$$1, [], JAM.policy.p1));
      }
  ...
  function readSharp() {
    ...
    if (isNumberChar(c$$20)) {
      var nb$$1 = c$$20 - 0;
      var v393 = isNumberChar(JAM.call(port$$1.peekChar, port$$1, [], JAM.policy.p1));
      for (;v393;) {
        nb$$1 = nb$$1 * 10 + (JAM.call(port$$1.readChar, port$$1, [], JAM.policy.p1) - 0);
        v393 = isNumberChar(JAM.call(port$$1.peekChar, port$$1, [], JAM.policy.p1));
      }
      switch(JAM.call(port$$1.readChar, port$$1, [], JAM.policy.p1)) {
        case "#":
    ...
    if (c$$20 === "\\") {
      var tmp$$17 = "";
      var v398 = !isWhitespaceOrEOF(JAM.call(port$$1.peekChar, port$$1, [], JAM.policy.p1));
      for (;v398;) {
        tmp$$17 = tmp$$17 + JAM.call(port$$1.readChar, port$$1, [], JAM.policy.p1);
        v398 = !isWhitespaceOrEOF(JAM.call(port$$1.peekChar, port$$1, [], JAM.policy.p1));
      }
      switch(tmp$$17.length) {
        case 0:
          if (sc_isEOFObject(port$$1.peekChar)) {
            ...
            return new sc_Token(20, JAM.call(port$$1.readChar, port$$1, [], JAM.policy.p1));
          }
        ;
        case 1:
          return new sc_Token(20, tmp$$17);
        default:
          var entry$$1 = sc_Char.readable2char[JAM.call(tmp$$17.toLowerCase, tmp$$17, [], JAM.policy.p1)];
          if (entry$$1) {
  ...
  switch(curChar) {
    ...
    case ".":
      ...
      JSCompiler_inline_label_readDot_1: {
        if (isWhitespace(JAM.call(port$$1.peekChar, port$$1, [], JAM.policy.p1))) {
...
function sc_any2String(o) {
  return JAM.call(jsstring2string, null, [sc_toDisplayString(o)], JAM.policy.p1);
}
...
function sc_lcm() {
  ...
  for (;v555;) {
    var f = JAM.call(Math.round, Math, [arguments[i$$19] / sc_euclid_gcd(arguments[i$$19], lcm)], JAM.policy.p1);
...
function sc_jsstring2number(s$$4, radix$$1) {
  ...
  if (radix$$1) {
    ...
    var v1412 = new RegExp("^[" + allowedChars + "]*$", "i");
...
function sc_integer2char(n$$8) {
  return new sc_Char(JAM.call(String.fromCharCode, String, [n$$8], JAM.policy.p1));
}
function sc_charUpcase(c$$10) {
  var v1481 = c$$10.val;
  return new sc_Char(JAM.call(v1481.toUpperCase, v1481, [], JAM.policy.p1));
}
function sc_charDowncase(c$$11) {
  var v1482 = c$$11.val;
  return new sc_Char(JAM.call(v1482.toLowerCase, v1482, [], JAM.policy.p1));
}
...
function sc_jsstring2list(s$$5) {
  ...
  var v686 = i$$27 >= 0;
  for (;v686;) {
    res$$16 = sc_cons(new sc_Char(JAM.call(s$$5.charAt, s$$5, [i$$27], JAM.policy.p1)), res$$16);
    i$$27 = i$$27 - 1;
    v686 = i$$27 >= 0;
  }
  return res$$16;
...
function sc_pregexpMatch(re$$1, s$$9) {
  ...
  var reg = v776;
  var tmp$$12 = JAM.call(reg.exec, reg, [sc_string2jsstring(s$$9)], JAM.policy.p1);
  if (tmp$$12 == null) {
    return false;
  }
  var res$$20 = null;
...
function sc_withOutputToProcedure(proc$$17, thunk$$7) {
  function t$$3(s$$18) {
    JAM.call(proc$$17, null, [sc_jsstring2string(s$$18)], JAM.policy.p1);
    return;
  }
...
function sc_write(o$$26, p$$40) {
  ...
  JAM.call(p$$40.appendJSString, p$$40, [sc_toWriteString(o$$26)], JAM.policy.p1);
  return;
}
...
function sc_escapeWriteString(s$$21) {
  ...
  for (;v838;) {
    switch(JAM.call(s$$21.charAt, s$$21, [i], JAM.policy.p1)) {
      case "\x00":
...
function sc_display(o$$28, p$$41) {
  ...
  JAM.call(p$$41.appendJSString, p$$41, [sc_toDisplayString(o$$28)], JAM.policy.p1);
  return;
}
...
function sc_writeCircle(o$$30, p$$44) {
  ...
  JAM.call(p$$44.appendJSString, p$$44, [sc_toWriteCircleString(o$$30)], JAM.policy.p1);
  return;
}
...
function sc_format(s$$23, args$$4) {
  ...
  for (;v881;) {
    ...
    if (i2 == -1) {
      ...
      switch(JAM.call(s$$23.charCodeAt, s$$23, [i2 + 1], JAM.policy.p1)) {
        case 65:
        ;
        case 97:
        ...
        ;
        case 99:
          JAM.call(p$$45.appendJSString, p$$45, [JAM.call(String.fromCharCode, String, [arguments[j$$2]], JAM.policy.p1)], JAM.policy.p1);
          i$$48 = i$$48 + 2;
          j$$2 = j$$2 + 1;
          break;
        case 88:
        ...
        case 120:
          ...
          JAM.call(p$$45.appendJSString, p$$45, [JAM.call(v1584.toString, v1584, [6], JAM.policy.p1)], JAM.policy.p1);
          i$$48 = i$$48 + 2;
          j$$2 = j$$2 + 1;
          break;
        case 79:
        ...
        case 111:
          ...
          JAM.call(p$$45.appendJSString, p$$45, [JAM.call(v1585.toString, v1585, [8], JAM.policy.p1)], JAM.policy.p1);
          i$$48 = i$$48 + 2;
          j$$2 = j$$2 + 1;
          break;
        case 66:
        ...
        case 98:
          ...
          JAM.call(p$$45.appendJSString, p$$45, [JAM.call(v1586.toString, v1586, [2], JAM.policy.p1)], JAM.policy.p1);
          i$$48 = i$$48 + 2;
          j$$2 = j$$2 + 1;
          break;
        case 37:
        ...
        case 126:
          ...
          break;
        default:
          sc_error("format: illegal ~" + JAM.call(String.fromCharCode, String, [JAM.call(s$$23.charCodeAt, s$$23, [i2 + 1], JAM.policy.p1)], JAM.policy.p1) + " sequence");
          return "";
      }
    }
    v881 = i$$48 < len$$3;
...
function sc_symbol2number(s$$30, radix$$3) {
  return sc_jsstring2number(JAM.call(s$$30.slice, s$$30, [1], JAM.policy.p1), radix$$3);
}
...
function sc_stringRef(s$$38, k$$5) {
  return new sc_Char(JAM.call(s$$38.charAt, s$$38, [k$$5], JAM.policy.p1));
}
