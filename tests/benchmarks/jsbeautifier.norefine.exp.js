...
function unpacker_filter(source$$1) {
  if(document.getElementById("detect-packers").checked) {
    ...
    var unpacked = "";
    if(JAM.call(P_A_C_K_E_R.detect, P_A_C_K_E_R, [stripped_source], JAM.policy.p750A7ECA0CEA34F16F7CDD3F0C47CDDFC768D4A5)) {
    ...
    if(JAM.call(EscapedBookmarklet.detect, EscapedBookmarklet, [source$$1], JAM.policy.p750A7ECA0CEA34F16F7CDD3F0C47CDDFC768D4A5)) {
    ...
    if(JAM.call(JavascriptObfuscator.detect, JavascriptObfuscator, [stripped_source], JAM.policy.p750A7ECA0CEA34F16F7CDD3F0C47CDDFC768D4A5)) {
...
function do_js_beautify() {
  ...
  var js_source = JAM.call(document.getElementById, document, ["content"], JAM.policy.p750A7ECA0CEA34F16F7CDD3F0C47CDDFC768D4A5).value.replace(/^\s+/, "");
  ...
  if(v35) {
    ...
    var v47 = JAM.call(js_beautify, null, [unpacker_filter(js_source), {indent_size:indent_size, indent_char:indent_char, preserve_newlines:preserve_newlines, brace_style:brace_style$$1, keep_array_indentation:keep_array_indentation, space_after_anon_function:true}], JAM.policy.p750A7ECA0CEA34F16F7CDD3F0C47CDDFC768D4A5);
    v22.value = v47
  }
...
function get_var(name$$31) {
  ...
  var res = JAM.call(reg.exec, reg, [window.location.href], JAM.policy.p750A7ECA0CEA34F16F7CDD3F0C47CDDFC768D4A5);
  var v27;
  if(res) {
    v27 = res[1]
  }else {
