...
function v246() {
  if (this.current_index != this.current_set.length - 1) {
    ...
    JAM.call(this.updateFrame, this, [], JAM.policy.p1);
    JAM.call(this.updateStatus, this, [], JAM.policy.p1);
  }
  return;
}
function v245() {
...
function v244() {
  ...
  this.url = item$$3.url;
  JAM.call(this.startLoading, this, [], JAM.policy.p1);
  return;
}
function v243(caption$$5) {
  JAM.call(AJS.setHTML, AJS, [JAM.call(AJS.$, AJS, ["GB_caption"], JAM.policy.p1), caption$$5], JAM.policy.p1);
  return;
}
function v242() {
...
function v241(start_index$$4) {
  ...
  JAM.call(AJS.ACN, AJS, [JAM.call(AJS.$, AJS, ["GB_middle"], JAM.policy.p1), this.btn_prev, GB_STATUS, this.btn_next], JAM.policy.p1);
  JAM.call(this.updateStatus, this, [], JAM.policy.p1);
  return;
}
...
function v239(set$$1, start_index$$3, callback_fn$$6) {
  ...
  var gb_sets$$1 = JAM.new(GB_Sets, [options$$19, set$$1], JAM.policy.p1);
  JAM.call(gb_sets$$1.addCallback, gb_sets$$1, [callback_fn$$6], JAM.policy.p1);
  JAM.call(gb_sets$$1.showSet, gb_sets$$1, [start_index$$3 - 1], JAM.policy.p1);
  return false;
}
function v238(set, start_index$$2, callback_fn$$5) {
  var options$$18 = {type:"page", fullscreen:true, center_win:false};
  var gb_sets = JAM.new(GB_Sets, [options$$18, set], JAM.policy.p1);
  JAM.call(gb_sets.addCallback, gb_sets, [callback_fn$$5], JAM.policy.p1);
  JAM.call(gb_sets.showSet, gb_sets, [start_index$$2 - 1], JAM.policy.p1);
  return false;
}
function v237() {
  var page_size$$4 = JAM.call(AJS.getWindowSize, AJS, [], JAM.policy.p1);
  JAM.call(AJS.setLeft, AJS, [this.g_window, (page_size$$4.w - this.width) / 2 - 13], JAM.policy.p1);
  if (!this.center_win) {
    JAM.call(AJS.setTop, AJS, [this.g_window, JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1)], JAM.policy.p1);
  } else {
    var fl$$1 = (page_size$$4.h - this.height) / 2 - 20 + JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1);
    if (fl$$1 < 0) {
      fl$$1 = 0;
    }
...
function v236() {
  if (this.fullscreen) {
    var page_size$$3 = JAM.call(AJS.getWindowSize, AJS, [], JAM.policy.p1);
...
function v235() {
  ...
  if (this.show_close_img) {
    ...
    var span = JAM.call(AJS.SPAN, AJS, ["Close"], JAM.policy.p1);
  ...
  tbody_header = JAM.call(AJS.TBODY, AJS, [], JAM.policy.p1);
...
function v230(options$$17) {
  JAM.call(this.parent, this, [{}], JAM.policy.p1);
...
function v229(caption$$4, url$$10, callback_fn$$4) {
  ...
  var win$$4 = JAM.new(GB_Window, [options$$16], JAM.policy.p1);
...
function v228(caption$$3, url$$9, height$$9, width$$10, callback_fn$$3) {
  ...
  var win$$3 = JAM.new(GB_Window, [options$$15], JAM.policy.p1);
...
function v227(caption$$2, url$$8, height$$8, width$$9, callback_fn$$2) {
  ...
  var win$$2 = JAM.new(GB_Window, [options$$14], JAM.policy.p1);
...
function v224() {
  ...
  var page_size$$2 = JAM.call(AJS.getWindowSize, AJS, [], JAM.policy.p1);
  JAM.call(AJS.setLeft, AJS, [this.g_window, (overlay_w$$1 - 50 - this.width) / 2], JAM.policy.p1);
  var header_top = JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1) + 55;
  if (!this.center_win) {
    JAM.call(AJS.setTop, AJS, [this.g_window, header_top], JAM.policy.p1);
  } else {
    var fl = (page_size$$2.h - this.height) / 2 + 20 + JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1);
    if (fl < 0) {
      fl = 0;
    }
    if (header_top > fl) {
  ...
  JAM.call(this._setHeaderPos, this, [], JAM.policy.p1);
  return;
}
function v223() {
  JAM.call(AJS.setTop, AJS, [this.header, JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1) + 10], JAM.policy.p1);
  return;
}
function v222() {
  var overlay_w = this.overlay.offsetWidth;
  var page_size$$1 = JAM.call(AJS.getWindowSize, AJS, [], JAM.policy.p1);
  if (this.fullscreen) {
...
function v221() {
  ...
  var v359 = JAM.call(AJS.getBody, AJS, [], JAM.policy.p1);
...
function v219(caption$$1, url$$7, callback_fn$$1) {
  ...
  var win$$1 = JAM.new(GB_Gallery, [options$$12], JAM.policy.p1);
...
function v218(caption, url$$6, callback_fn) {
  ...
  var win = JAM.new(GB_Gallery, [options$$11], JAM.policy.p1);
  return JAM.call(win.show, win, [url$$6], JAM.policy.p1);
}
function v217() {
  if (GB_CURRENT) {
    JAM.call(GB_CURRENT.setOverlayDimension, GB_CURRENT, [], JAM.policy.p1);
  }
  return;
}
function v216() {
  if (GB_CURRENT) {
    JAM.call(GB_CURRENT.update, GB_CURRENT, [], JAM.policy.p1);
  }
  return;
}
function v215() {
...
function v210() {
  if (!this.iframe) {
    ...
    if (JAM.call(AJS.isIe, AJS, [], JAM.policy.p1)) {
    ...
    var v1254 = JAM.call(AJS.DIV, AJS, [], JAM.policy.p1);
    this.top_cnt = v1254;
    var v1255 = JAM.call(AJS.DIV, AJS, [], JAM.policy.p1);
...
function v209() {
  ...
  var v386 = JAM.call(AJS.getBody, AJS, [], JAM.policy.p1);
  JAM.call(v386.insertBefore, v386, [this.overlay, JAM.call(AJS.getBody, AJS, [], JAM.policy.p1).firstChild], JAM.policy.p1);
  return;
}
function v208() {
  var page_size = JAM.call(AJS.getWindowSize, AJS, [], JAM.policy.p1);
  var v871 = JAM.call(AJS.isMozilla, AJS, [], JAM.policy.p1);
  if (!v871) {
    v871 = JAM.call(AJS.isOpera, AJS, [], JAM.policy.p1);
  }
  if (v871) {
  ...
  var max_height = JAM.call(Math.max, Math, [JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1) + page_size.h, JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1) + this.height], JAM.policy.p1);
  if (max_height < JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1)) {
    JAM.call(AJS.setHeight, AJS, [this.overlay, max_height], JAM.policy.p1);
  } else {
    JAM.call(AJS.setHeight, AJS, [this.overlay, JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1) + page_size.h], JAM.policy.p1);
  }
  return;
}
function v207() {
...
function v205() {
  function v204() {
    JAM.call(me$$3.onShow, me$$3, [], JAM.policy.p1);
    JAM.call(AJS.showElement, AJS, [me$$3.g_window], JAM.policy.p1);
    JAM.call(me$$3.startLoading, me$$3, [], JAM.policy.p1);
    return;
  }
  JAM.call(this.initOverlay, this, [], JAM.policy.p1);
  var v1257 = JAM.call(AJS.DIV, AJS, [{"id":"GB_window"}], JAM.policy.p1);
  this.g_window = v1257;
  JAM.call(AJS.hideElement, AJS, [this.g_window], JAM.policy.p1);
  var v405 = JAM.call(AJS.getBody, AJS, [], JAM.policy.p1);
  JAM.call(v405.insertBefore, v405, [this.g_window, this.overlay.nextSibling], JAM.policy.p1);
  JAM.call(this.initFrame, this, [], JAM.policy.p1);
  JAM.call(this.initHook, this, [], JAM.policy.p1);
  JAM.call(this.update, this, [], JAM.policy.p1);
  var me$$3 = this;
  if (this.use_fx) {
    var v408 = AJS.fx;
    JAM.call(v408.fadeIn, v408, [this.overlay, {duration:300, to:.7, onComplete:v204}], JAM.policy.p1);
  } else {
    JAM.call(AJS.setOpacity, AJS, [this.overlay, .7], JAM.policy.p1);
    JAM.call(AJS.showElement, AJS, [this.g_window], JAM.policy.p1);
    JAM.call(this.onShow, this, [], JAM.policy.p1);
    JAM.call(this.startLoading, this, [], JAM.policy.p1);
  }
...
function v203() {
  JAM.call(this.setOverlayDimension, this, [], JAM.policy.p1);
  JAM.call(this.setFrameSize, this, [], JAM.policy.p1);
  JAM.call(this.setWindowPosition, this, [], JAM.policy.p1);
  return;
}
function v202(cb$$1) {
  function v201() {
    ...
    function v198(fn$$17) {
      JAM.call(fn$$17, null, [], JAM.policy.p1);
      return;
    }
    ...
    JAM.call(me$$2.onHide, me$$2, [], JAM.policy.p1);
    if (me$$2.use_fx) {
    ...
    JAM.call(me$$2.removeFrame, me$$2, [], JAM.policy.p1);
    ...
    var elms$$6 = [JAM.call(AJS.$bytc, AJS, ["object"], JAM.policy.p1), JAM.call(AJS.$bytc, AJS, ["select"], JAM.policy.p1)];
    ...
    if (me$$2.reload_on_close) {
      ...
      JAM.call(v426.reload, v426, [], JAM.policy.p1);
    }
    if (JAM.call(AJS.isFunction, AJS, [cb$$1], JAM.policy.p1)) {
      JAM.call(cb$$1, null, [], JAM.policy.p1);
    }
    return;
  }
  var me$$2 = this;
  JAM.call(setTimeout, null, [v201, 10], JAM.policy.p1);
  return;
}
function v197(url$$5) {
  ...
  GB_CURRENT = this;
  this.url = url$$5;
  var elms$$5 = [JAM.call(AJS.$bytc, AJS, ["object"], JAM.policy.p1), JAM.call(AJS.$bytc, AJS, ["select"], JAM.policy.p1)];
  JAM.call(AJS.map, AJS, [JAM.call(AJS.flattenList, AJS, [elms$$5], JAM.policy.p1), v196], JAM.policy.p1);
  JAM.call(this.createElements, this, [], JAM.policy.p1);
  return false;
}
function v195(fn$$16) {
  if (fn$$16) {
...
function v194(options$$10) {
  ...
  var v435 = window.location.hostname;
  var h_www = JAM.call(v435.indexOf, v435, ["www"], JAM.policy.p1);
  var v436 = this.src_loader;
  var src_www = JAM.call(v436.indexOf, v436, ["www"], JAM.policy.p1);
  var v884 = h_www != -1;
  if (v884) {
    v884 = src_www == -1;
  }
  if (v884) {
    ...
    var v1258 = JAM.call(v437.replace, v437, ["://", "://www."], JAM.policy.p1);
  ...
  if (v885) {
    ...
    var v1259 = JAM.call(v439.replace, v439, ["://www.", "://"], JAM.policy.p1);
...
function v183(to$$3) {
  this.now = to$$3;
  JAM.call(this.increase, this, [], JAM.policy.p1);
  return this;
}
...
function v181(from$$1, to$$1) {
  if (!this.options.wait) {
    JAM.call(this.clearTimer, this, [], JAM.policy.p1);
  }
  if (this.timer) {
    return;
  }
  JAM.call(setTimeout, null, [JAM.call(AJS.$p, AJS, [this.options.onStart, this.elm], JAM.policy.p1), 10], JAM.policy.p1);
  this.from = from$$1;
  this.to = to$$1;
  var v459 = JAM.new(Date, [], JAM.policy.p1);
  var v1262 = JAM.call(v459.getTime, v459, [], JAM.policy.p1);
  this.time = v1262;
  var v1263 = JAM.call(setInterval, null, [this.step, JAM.call(Math.round, Math, [1E3 / this.options.fps], JAM.policy.p1)], JAM.policy.p1);
  this.timer = v1263;
  return this;
}
function v180() {
...
function v177() {
  var v468 = JAM.new(Date, [], JAM.policy.p1);
  var time = JAM.call(v468.getTime, v468, [], JAM.policy.p1);
  if (time < this.time + this.options.duration) {
    this.cTime = time - this.time;
    JAM.call(this.setNow, this, [], JAM.policy.p1);
  } else {
    JAM.call(setTimeout, null, [JAM.call(AJS.$b, AJS, [this.options.onComplete, this, [this.elm]], JAM.policy.p1), 10], JAM.policy.p1);
    JAM.call(this.clearTimer, this, [], JAM.policy.p1);
    this.now = this.to;
  }
  JAM.call(this.increase, this, [], JAM.policy.p1);
...
function v172(elm$$43, options$$5) {
  var s$$5 = JAM.new(AJS.fx.Style, [elm$$43, "height", options$$5], JAM.policy.p1);
  return JAM.call(s$$5.custom, s$$5, [options$$5.from, options$$5.to], JAM.policy.p1);
}
function v171(elm$$42, options$$4) {
  var s$$4 = JAM.new(AJS.fx.Style, [elm$$42, "width", options$$4], JAM.policy.p1);
...
function v170(elm$$41, options$$3) {
  ...
  var s$$3 = JAM.new(AJS.fx.Style, [elm$$41, "opacity", options$$3], JAM.policy.p1);
...
function v169(elm$$40, options$$2) {
  ...
  var s$$2 = JAM.new(AJS.fx.Style, [elm$$40, "opacity", options$$2], JAM.policy.p1);
...
function v168(elm$$39, options$$1) {
  ...
  var base$$1 = JAM.new(AJS.fx.Base, [], JAM.policy.p1);
  var v495 = base$$1;
  ...
  return JAM.call(base$$1.custom, base$$1, [6, 0], JAM.policy.p1);
}
function v166(data$$21) {
  ...
  if (http_method == "POST") {
    ...
    JAM.call(req$$6.setRequestHeader, req$$6, ["Content-type", "application/x-www-form-urlencoded"], JAM.policy.p1);
    if (JAM.call(AJS.isObject, AJS, [data$$21], JAM.policy.p1)) {
      ...
      if (JAM.call(AJS.isDefined, AJS, [data$$21], JAM.policy.p1)) {
        ...
        JAM.call(req$$6.send, req$$6, [""], JAM.policy.p1);
      }
    }
  } else {
    JAM.call(req$$6.open, req$$6, ["GET", http_url, true], JAM.policy.p1);
    var v502 = req$$6;
    var v1267 = JAM.call(AJS.$b, AJS, [this._onreadystatechange, this], JAM.policy.p1);
    JAM.set(v502, "onreadystatechange", v1267);
    JAM.call(req$$6.send, req$$6, [null], JAM.policy.p1);
  }
  return;
}
function v165() {
  ...
  if (req$$5.readyState == 4) {
    ...
    if (v917) {
      JAM.call(this.callback, this, [], JAM.policy.p1);
    } else {
      JAM.call(this.errback, this, [], JAM.policy.p1);
    }
  }
  return;
}
...
function v163() {
  var v506 = this.req;
  JAM.call(v506.abort, v506, [], JAM.policy.p1);
  return;
}
function v162(fn$$15) {
...
function v160() {
  if (this.errbacks.length == 0) {
    if (AJS.ajaxErrorHandler) {
      ...
      var v510 = this.req.responseText;
      var txt$$1 = JAM.call(v510.substring, v510, [0, 200], JAM.policy.p1);
      var v920 = JAM.call(AJS.strip, AJS, [txt$$1], JAM.policy.p1);
      if (v920) {
        v920 = JAM.call(txt$$1.indexOf, txt$$1, ["<html"], JAM.policy.p1) == -1;
      }
      if (v920) {
        JAM.call(alert, null, ["Error encountered:\n" + txt$$1], JAM.policy.p1);
      }
    }
  }
...
function v158(req$$4, list$$10) {
  ...
  for (;v525;) {
    var fn$$13 = JAM.call(list$$10.pop, list$$10, [], JAM.policy.p1);
...
function v153(members$$1) {
  var parent$$2 = JAM.new(this, ["no_init"], JAM.policy.p1);
  for (k in members$$1) {
    var prev = parent$$2[k];
    var cur = members$$1[k];
    var v1120 = prev;
  ...
  return JAM.new(AJS.Class, [parent$$2], JAM.policy.p1);
}
...
function v151(str$$9, limit, delim$$1) {
  if (str$$9.length > limit) {
    return JAM.call(str$$9.substring, str$$9, [0, limit], JAM.policy.p1) + (delim$$1 || "...");
  }
  return str$$9;
}
function v150(str$$8) {
  var v535 = JAM.call(str$$8.replace, str$$8, [/^\s+/, ""], JAM.policy.p1);
  return JAM.call(v535.replace, v535, [/\s+$/g, ""], JAM.policy.p1);
}
...
function v146(o$$6) {
  var str_repr = JAM.call(String, null, [o$$6], JAM.policy.p1);
  return JAM.call(str_repr.indexOf, str_repr, [" Object"], JAM.policy.p1) != -1;
}
...
function v139(str$$7) {
  ...
  if (v1122) {
    v1122 = JAM.call(str$$7.toString, str$$7, [], JAM.policy.p1);
  }
  var v927 = v1122;
  if (!v927) {
    v927 = "";
  }
  var result = JAM.call(decodeURIComponent, null, [v927], JAM.policy.p1);
  return JAM.call(result.replace, result, [/\+/g, " "], JAM.policy.p1);
}
function v138(str$$6) {
  var v1124 = JAM.call(AJS.isDefined, AJS, [str$$6], JAM.policy.p1);
  if (v1124) {
    v1124 = JAM.call(str$$6.toString, str$$6, [], JAM.policy.p1);
  }
  var v928 = v1124;
  if (!v928) {
    v928 = "";
  }
  return JAM.call(encodeURIComponent, null, [v928], JAM.policy.p1);
}
...
function v135(name$$32, fn$$10, interval) {
  ...
  if (current) {
    JAM.call(clearTimeout, null, [current], JAM.policy.p1);
  }
  var v550 = AJS._reccruing_tos;
  var v551 = name$$32;
  var v1268 = JAM.call(setTimeout, null, [fn$$10, interval], JAM.policy.p1);
...
function v134(fn$$9, extra_args$$1) {
  function v133() {
    try {
      var v552 = JAM.call(AJS.$FA, AJS, [arguments], JAM.policy.p1);
...
function v132(elm$$38, type$$30, fn$$8) {
  function r_fn() {
    ...
    JAM.call(fn$$8, null, [arguments], JAM.policy.p1);
    return;
  }
  return r_fn;
}
function v131(e$$12) {
  if (JAM.call(AJS.isIe, AJS, [], JAM.policy.p1)) {
    ...
    JAM.call(e$$12.preventDefault, e$$12, [], JAM.policy.p1);
  }
  return;
}
...
function v126(event$$1) {
  ...
  if (v936) {
    ...
    v936 = JAM.call(v1208.indexOf, v1208, ["key"], JAM.policy.p1) != -1;
  }
  if (v936) {
...
function v119() {
  function v118() {
    ...
    try {
      ...
      JAM.call(v587.doScroll, v587, ["left"], JAM.policy.p1);
    } catch (error$$1) {
      JAM.call(setTimeout, null, [arguments.callee, 0], JAM.policy.p1);
      return;
    }
    JAM.call(AJS.ready, AJS, [], JAM.policy.p1);
    return;
  }
  function v117() {
    if (document.readyState === "complete") {
      JAM.call(document.detachEvent, document, ["onreadystatechange", arguments.callee], JAM.policy.p1);
      JAM.call(AJS.ready, AJS, [], JAM.policy.p1);
    }
    return;
  }
  function v116() {
    JAM.call(document.removeEventListener, document, ["DOMContentLoaded", arguments.callee, false], JAM.policy.p1);
    JAM.call(AJS.ready, AJS, [], JAM.policy.p1);
    return;
  }
  if (AJS.ready_bound) {
  ...
  if (document.addEventListener) {
    JAM.call(document.addEventListener, document, ["DOMContentLoaded", v116, false], JAM.policy.p1);
  } else {
    if (document.attachEvent) {
      JAM.call(document.attachEvent, document, ["onreadystatechange", v117], JAM.policy.p1);
      var v947 = document.documentElement.doScroll;
      if (v947) {
        v947 = window == window.top;
      }
      if (v947) {
        JAM.call(v118, null, [], JAM.policy.p1);
      }
    }
  }
...
function v111(elm1, elm2) {
  ...
  var v951 = JAM.call(getSign, null, [top1 - bottom2], JAM.policy.p1) != JAM.call(getSign, null, [bottom1 - top2], JAM.policy.p1);
  if (v951) {
    v951 = JAM.call(getSign, null, [left1 - right2], JAM.policy.p1) != JAM.call(getSign, null, [right1 - left2], JAM.policy.p1);
  }
  if (v951) {
    return true;
  }
...
function v109(elm$$34) {
  ...
  var v957 = JAM.call(AJS.isSafari, AJS, [], JAM.policy.p1);
  if (v957) {
...
function v106(date$$1) {
  ...
  var year$$1 = JAM.call(date$$1.getUTCFullYear, date$$1, [], JAM.policy.p1);
  var dd = JAM.call(date$$1.getUTCDate, date$$1, [], JAM.policy.p1);
  var mm = JAM.call(date$$1.getUTCMonth, date$$1, [], JAM.policy.p1) + 1;
  return'"' + year$$1 + "-" + mm + "-" + dd + "T" + JAM.call(leadingZero, null, [JAM.call(date$$1.getUTCHours, date$$1, [], JAM.policy.p1)], JAM.policy.p1) + ":" + JAM.call(leadingZero, null, [JAM.call(date$$1.getUTCMinutes, date$$1, [], JAM.policy.p1)], JAM.policy.p1) + ":" + JAM.call(leadingZero, null, [JAM.call(date$$1.getUTCSeconds, date$$1, [], JAM.policy.p1)], JAM.policy.p1) + '"';
}
function v105(o$$4) {
  var v1231 = '"' + JAM.call(o$$4.replace, o$$4, [/(["\\])/g, "\\$1"], JAM.policy.p1) + '"';
  var v1217 = JAM.call(v1231.replace, v1231, [/[\f]/g, "\\f"], JAM.policy.p1);
  var v1149 = JAM.call(v1217.replace, v1217, [/[\b]/g, "\\b"], JAM.policy.p1);
  var v973 = JAM.call(v1149.replace, v1149, [/[\n]/g, "\\n"], JAM.policy.p1);
  var v645 = JAM.call(v973.replace, v973, [/[\t]/g, "\\t"], JAM.policy.p1);
  return JAM.call(v645.replace, v645, [/[\r]/g, "\\r"], JAM.policy.p1);
}
function v104(data$$19) {
  ...
  return JAM.call(post_data.join, post_data, ["&"], JAM.policy.p1);
}
function v103(html$$2) {
  var script_data = JAM.call(html$$2.match, html$$2, [/<script.*?>((\n|\r|.)*?)<\/script>/g], JAM.policy.p1);
  if (script_data != null) {
    var i$$15 = 0;
    var v648 = i$$15 < script_data.length;
    for (;v648;) {
      var v647 = script_data[i$$15];
      var script_only = JAM.call(v647.replace, v647, [/<script.*?>/g, ""], JAM.policy.p1);
      script_only = JAM.call(script_only.replace, script_only, [/<\/script>/g, ""], JAM.policy.p1);
      if (JAM.isEval(eval)) {
...
function v100(o$$3) {
  ...
  if (v981) {
    ...
    return "[" + JAM.call(res.join, res, [","], JAM.policy.p1) + "]";
  }
  if (objtype == "function") {
    return null;
  }
...
function v99(url$$2, method$$1) {
  var req$$1 = JAM.call(AJS.getXMLHttpRequest, AJS, [], JAM.policy.p1);
  if (JAM.call(url$$2.match, url$$2, [/^https?:\/\//], JAM.policy.p1) == null) {
    if (AJS.BASE_URL != "") {
      var v1153 = AJS.BASE_URL;
      if (JAM.call(v1153.lastIndexOf, v1153, ["/"], JAM.policy.p1) != AJS.BASE_URL.length - 1) {
  ...
  return JAM.new(AJSDeferred, [req$$1, method$$1, url$$2], JAM.policy.p1);
}
function v98() {
  function v97() {
  ...
  function v96() {
    return JAM.new(ActiveXObject, ["Msxml2.XMLHTTP.4.0"], JAM.policy.p1);
  }
  function v95() {
  ...
  for (;v675;) {
    ...
    try {
      return JAM.call(func$$3, null, [], JAM.policy.p1);
    } catch (e$$7) {
...
function v92(tmpl, ns, scope) {
  function fn$$4(w$$5, g) {
    g = JAM.call(g.split, g, ["|"], JAM.policy.p1);
    var cnt = ns[g[0]];
    var i$$12 = 1;
  ...
  scope = scope || window;
  return JAM.call(tmpl.replace, tmpl, [/%\(([A-Za-z0-9_|.]*)\)/g, fn$$4], JAM.policy.p1);
}
function v91() {
  function v90(args$$13) {
    function v89(src$$2) {
      var pic = JAM.new(Image, [], JAM.policy.p1);
      pic.src = src$$2;
      return;
    }
...
function v88(html$$1, first_child$$1) {
  var d = JAM.call(AJS.DIV, AJS, [], JAM.policy.p1);
...
function v86() {
  function v85(elm$$32) {
    ...
    var v1270 = JAM.call(v1002.replace, v1002, [JAM.new(RegExp, ["(^|\\s)" + cls$$2, "g"], JAM.policy.p1), ""], JAM.policy.p1);
    v687.className = v1270;
    return;
  }
  var args$$12 = JAM.call(AJS.flattenElmArguments, AJS, [arguments], JAM.policy.p1);
  var cls$$2 = JAM.call(args$$12.pop, args$$12, [], JAM.policy.p1);
...
function v84(elm$$31, cls$$1) {
  ...
  if (v689) {
    ...
    if (!v1006) {
      var v1160 = JAM.new(RegExp, ["(^|\\s)" + cls$$1 + "(\\s|$)"], JAM.policy.p1);
...
function v83() {
  function v82(elm$$30) {
    ...
    var v1162 = JAM.new(RegExp, ["(^|\\s)" + cls + "(\\s|$)"], JAM.policy.p1);
  ...
  var args$$11 = JAM.call(AJS.flattenElmArguments, AJS, [arguments], JAM.policy.p1);
  var cls = JAM.call(args$$11.pop, args$$11, [], JAM.policy.p1);
...
function v81() {
  ...
  var args$$10 = JAM.call(AJS.flattenElmArguments, AJS, [arguments], JAM.policy.p1);
  var c = JAM.call(args$$10.pop, args$$10, [], JAM.policy.p1);
  JAM.call(AJS.map, AJS, [args$$10, v80], JAM.policy.p1);
  return;
}
function v79() {
  return JAM.call(AJS.__cssDim, AJS, [arguments, "top"], JAM.policy.p1);
}
function v78() {
  return JAM.call(AJS.__cssDim, AJS, [arguments, "right"], JAM.policy.p1);
}
function v77() {
  return JAM.call(AJS.__cssDim, AJS, [arguments, "left"], JAM.policy.p1);
}
function v76() {
  return JAM.call(AJS.__cssDim, AJS, [arguments, "height"], JAM.policy.p1);
}
function v75() {
  return JAM.call(AJS.__cssDim, AJS, [arguments, "width"], JAM.policy.p1);
}
function v74(args$$9, property$$1) {
  args$$9 = JAM.call(AJS.$FA, AJS, [args$$9], JAM.policy.p1);
  JAM.call(args$$9.splice, args$$9, [args$$9.length - 1, 0, property$$1], JAM.policy.p1);
  var v692 = AJS.setStyle;
  JAM.call(v692.apply, v692, [null, args$$9], JAM.policy.p1);
  return;
}
function v73() {
  function v72(elm$$28) {
  ...
  function v71(elm$$27) {
    ...
    JAM.call(AJS.map, AJS, [JAM.call(AJS.keys, AJS, [value$$27], JAM.policy.p1), v70], JAM.policy.p1);
    return;
  }
  var args$$8 = JAM.call(AJS.flattenElmArguments, AJS, [arguments], JAM.policy.p1);
  var value$$27 = JAM.call(args$$8.pop, args$$8, [], JAM.policy.p1);
  ...
  if (JAM.call(AJS.isObject, AJS, [value$$27], JAM.policy.p1)) {
    ...
    var property = JAM.call(args$$8.pop, args$$8, [], JAM.policy.p1);
...
function v67(elm$$24) {
  JAM.call(AJS.setStyle, AJS, [JAM.call(AJS.flattenElmArguments, AJS, [arguments], JAM.policy.p1), "display", "none"], JAM.policy.p1);
  return;
}
function v66() {
  JAM.call(AJS.setStyle, AJS, [JAM.call(AJS.flattenElmArguments, AJS, [arguments], JAM.policy.p1), "display", ""], JAM.policy.p1);
  return;
}
function v65() {
  var args$$7 = JAM.call(AJS.flattenElmArguments, AJS, [arguments], JAM.policy.p1);
  var v1018 = JAM.call(args$$7.pop, args$$7, [], JAM.policy.p1);
  if (v1018) {
    v1018 = "visible";
  }
  var v705 = v1018;
...
function v64() {
  ...
  var args$$6 = JAM.call(AJS.flattenElmArguments, AJS, [arguments], JAM.policy.p1);
  var html = JAM.call(args$$6.pop, args$$6, [], JAM.policy.p1);
...
function v62() {
  ...
  function extends_ajs(elm$$22) {
    function v60() {
      ...
      return JAM.call(v706.apply, v706, [null, [elm$$22, arguments]], JAM.policy.p1);
    }
    JAM.set(AJS, JAM.call(elm$$22.toUpperCase, elm$$22, [], JAM.policy.p1), v60);
    return;
  }
...
function v58() {
  ...
  var args$$5 = JAM.call(AJS.flattenElmArguments, AJS, [arguments], JAM.policy.p1);
  try {
...
function v53(elm$$17) {
  ...
  if (arguments.length < 2) {
    ...
    return JAM.call(v721.apply, v721, [null, arguments], JAM.policy.p1);
  }
  return;
}
function v52(elm$$16) {
  var v723 = JAM.call(AJS.flattenElmArguments, AJS, [arguments], JAM.policy.p1);
  var args$$4 = JAM.call(v723.slice, v723, [1], JAM.policy.p1);
  if (args$$4.length >= 1) {
    var first_child = elm$$16.firstChild;
    if (first_child) {
      for (;true;) {
        var t_elm = JAM.call(args$$4.shift, args$$4, [], JAM.policy.p1);
        if (t_elm) {
      ...
      var v724 = AJS.ACN;
      JAM.call(v724.apply, v724, [null, arguments], JAM.policy.p1);
    }
  }
  return elm$$16;
}
function v51(elm$$15) {
  ...
  if (arguments.length >= 2) {
    JAM.call(AJS.map, AJS, [arguments, v50, 1], JAM.policy.p1);
  }
  return elm$$15;
}
function v49(elm$$14) {
  ...
  JAM.call(document.write, document, ['<span id="dummy_holder"></span>'], JAM.policy.p1);
  JAM.call(AJS.swapDOM, AJS, [JAM.call(AJS.$, AJS, ["dummy_holder"], JAM.policy.p1), elm$$14], JAM.policy.p1);
  return;
}
function v48(select) {
...
function v47(form, name$$30) {
  ...
  JAM.call(AJS.map, AJS, [JAM.call(AJS.$bytc, AJS, ["select", null, form], JAM.policy.p1), v46], JAM.policy.p1);
  return r$$5;
}
function v44() {
  return JAM.call(AJS.$bytc, AJS, ["body"], JAM.policy.p1)[0];
}
...
function v31(elm$$5) {
  ...
  return JAM.call(v747.toLowerCase, v747, [], JAM.policy.p1);
}
function v30(tag_name, class_name, parent, first_match) {
  ...
  if (v1038) {
    ...
    if (tag_name == "*") {
      ...
      for (;v752;) {
        var v1173 = els[i$$10].nodeName;
        if (JAM.call(v1173.toLowerCase, v1173, [], JAM.policy.p1) == tag_name) {
    ...
    if (!class_name) {
      ...
      els_len = els.length;
      var pattern$$1 = JAM.new(RegExp, ["(^|\\s)" + class_name + "(\\s|$)"], JAM.policy.p1);
      i$$10 = 0;
...
function v29() {
  var args$$3 = JAM.call(AJS.flattenElmArguments, AJS, [arguments], JAM.policy.p1);
  var elements = JAM.new(Array, [], JAM.policy.p1);
  var i$$9 = 0;
...
function v27(fn$$3) {
  function v26() {
    args$$2 = JAM.call(args$$2.concat, args$$2, [JAM.call(AJS.$FA, AJS, [arguments], JAM.policy.p1)], JAM.policy.p1);
    return JAM.call(fn$$3.apply, fn$$3, [window, args$$2], JAM.policy.p1);
  }
  var args$$2 = JAM.call(AJS.$FA, AJS, [arguments], JAM.policy.p1);
  JAM.call(args$$2.shift, args$$2, [], JAM.policy.p1);
  return v26;
}
...
function v23(list$$8, fn$$1) {
  ...
  var v768 = i$$8 >= l$$2;
  for (;v768;) {
    var val$$1 = JAM.call(fn$$1.apply, fn$$1, [null, [list$$8[i$$8], i$$8]], JAM.policy.p1);
    if (val$$1 != undefined) {
      return val$$1;
    }
    i$$8 = i$$8 - 1;
...
function v20(list$$6) {
    ...
    function v19(o) {
      if (o == null) {
        ...
        if (JAM.call(AJS.isArray, AJS, [o], JAM.policy.p1)) {
          JAM.call(_flatten, null, [r$$3, o], JAM.policy.p1);
        } else {
  ...
  var r$$2 = [];
  JAM.call(_flatten, null, [r$$2, list$$6], JAM.policy.p1);
  return r$$2;
}
function v18(l1, l2) {
  var i$$5;
...
function v17(list$$5) {
  return list$$5[JAM.call(Math.floor, Math, [JAM.call(Math.random, Math, [], JAM.policy.p1) * list$$5.length], JAM.policy.p1)];
}
function v16(list$$4) {
  if (list$$4.length > 0) {
...
function v8() {
  ...
  return JAM.call(v1060.indexOf, v1060, ["camino"], JAM.policy.p1) != -1;
}
function v7() {
  var v1061 = AJS._agent;
  return JAM.call(v1061.indexOf, v1061, ["macintosh"], JAM.policy.p1) != -1;
}
function v6() {
  var v1183 = AJS._agent;
  var v793 = JAM.call(v1183.indexOf, v1183, ["gecko"], JAM.policy.p1) != -1;
  if (v793) {
...
function v5() {
  ...
  return JAM.call(v1064.indexOf, v1064, ["opera"], JAM.policy.p1) != -1;
}
function v4(all) {
  if (all) {
    var v795 = AJS._agent;
    return JAM.call(v795.indexOf, v795, ["khtml"], JAM.policy.p1);
  }
  var v1184 = AJS._agent;
  var v796 = JAM.call(v1184.indexOf, v1184, ["khtml"], JAM.policy.p1) != -1;
  if (v796) {
    var v1185 = AJS._agent;
    v796 = JAM.call(v1185.match, v1185, [/3\.\d\.\d safari/], JAM.policy.p1) == null;
  }
  return v796;
}
function v3() {
  var v1067 = AJS._agent;
  return JAM.call(v1067.indexOf, v1067, ["msie 8"], JAM.policy.p1) != -1;
}
function v2() {
  var v1186 = AJS._agent;
  var v798 = JAM.call(v1186.indexOf, v1186, ["msie"], JAM.policy.p1) != -1;
  if (v798) {
    var v1187 = AJS._agent;
    v798 = JAM.call(v1187.indexOf, v1187, ["opera"], JAM.policy.p1) == -1;
  }
  return v798;
}
function v1(var_name) {
  var v799 = window.location.search;
  var query$$2 = JAM.call(v799.substring, v799, [1], JAM.policy.p1);
  var vars = JAM.call(query$$2.split, query$$2, ["&"], JAM.policy.p1);
  var i$$1 = 0;
  var v802 = i$$1 < vars.length;
  for (;v802;) {
    var v800 = vars[i$$1];
    var pair = JAM.call(v800.split, v800, ["="], JAM.policy.p1);
    if (pair[0] == var_name) {
      return pair[1];
    }
    i$$1 = i$$1 + 1;
...
function insertMenu(current_page) {
  function v0(item$$1) {
    if (item$$1.className == current_page) {
      JAM.call(AJS.addClass, AJS, [JAM.call(AJS.$bytc, AJS, ["a", null, item$$1], JAM.policy.p1)[0], "current"], JAM.policy.p1);
    }
  ...
  var items = [JAM.call(create_item, null, ["installation", "Installation"], JAM.policy.p1), JAM.call(create_item, null, ["examples", "Examples"], JAM.policy.p1), JAM.call(create_item, null, ["nrm_usage", "Normal usage"], JAM.policy.p1), JAM.call(create_item, null, ["adv_usage", "Advance usage"], JAM.policy.p1), JAM.call(create_item, null, ["cmpr", "Compressing GreyBox"], JAM.policy.p1), JAM.call(create_item, null, ["about", "About"], JAM.policy.p1)];
  JAM.call(AJS.map, AJS, [items, v0], JAM.policy.p1);
  JAM.call(AJS.DI, AJS, [menu], JAM.policy.p1);
  return;
}
function insertCode() {
  var code$$2 = JAM.call(AJS.join, AJS, ["\n", arguments], JAM.policy.p1);
  var result$$2 = "<pre><code>";
  var v814 = JAM.call(code$$2.replace, code$$2, [/</g, "&lt;"], JAM.policy.p1);
  code$$2 = JAM.call(v814.replace, v814, [/>/g, "&gt;"], JAM.policy.p1);
...
if (!window.AJS) {
  ...
  JAM.call(AJS._createDomShortcuts, AJS, [], JAM.policy.p1);
}
script_loaded = true;
JAM.call(AJS.exportToGlobalScope, AJS, [], JAM.policy.p1);
JAM.call(AJS.bindReady, AJS, [], JAM.policy.p1);
...
var v820 = AJS.fx;
var v1271 = JAM.new(AJS.Class, [{init:v175, setOptions:v176, step:v177, setNow:v178, compute:v179, clearTimer:v180, _start:v181, custom:v182, set:v183, setStyle:v184}], JAM.policy.p1);
v820.Base = v1271;
var v821 = AJS.fx;
...
script_loaded = true;
var tmpl_header = JAM.call(AJS.join, AJS, ["", ['<div id="top"> <img src="logo.gif" alt="" /> <br />', '<span style="font-weight: bold; color: #333">A pop-up window that doesn\'t suck.</span>', "</div>"]], JAM.policy.p1);
...
var GB_CURRENT = null;
GB_hide = v193;
GreyBox = JAM.new(AJS.Class, [{init:v194, addCallback:v195, show:v197, hide:v202, update:v203, createElements:v205, removeFrame:v206, startLoading:v207, setOverlayDimension:v208, initOverlay:v209, initFrame:v210, onHide:v211, onShow:v212, setFrameSize:v213, setWindowPosition:v214, initHook:v215}], JAM.policy.p1);
_GB_update = v216;
...
JAM.call(insertHeader, null, [], JAM.policy.p1);
JAM.call(insertMenu, null, ["examples"], JAM.policy.p1)
