...
function v99(url$$3, method$$1) {
  ...
  if (JAM.call(url$$3.match, url$$3, [/^https?:\/\//], JAM.policy.p1) == null) {
    if (AJS.BASE_URL != "") {
  ...
  return JAM.new(AJSDeferred, [req$$1, method$$1, url$$3], JAM.policy.p1);
}
function v98() {
  function v97() {
...
function v74(args$$9, property$$4) {
  ...
  JAM.call(args$$9.splice, args$$9, [args$$9.length - 1, 0, property$$4], JAM.policy.p1);
...
function v73() {
  ...
  var value$$29 = JAM.call(args$$8.pop, args$$8, [], JAM.policy.p1);
  ...
  if (JAM.call(AJS.isObject, AJS, [value$$29], JAM.policy.p1)) {
    ...
    var property$$3 = JAM.call(args$$8.pop, args$$8, [], JAM.policy.p1);
