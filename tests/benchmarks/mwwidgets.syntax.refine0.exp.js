  ...
  function v76() {
    ...
    function b$$20(b$$21, a$$38, d$$11) {
      ...
      for (;v215;) {
        ...
        JAM.set(b$$21, v214, v709 ^ v710, JAM.policy.p18);
        e$$25 = e$$25 + 1;
        v215 = e$$25 < d$$11;
      }
      return;
...
function v55(p$$2) {
  function v54() {
    ...
    var v720 = 128 << 24 - e$$22 % 32;
    introspect(JAM.policy.p18) {
      g$$6[v249] = v719 | v720;
    }
    var v250 = (e$$22 + 64 >>> 9 << 4) + 14;
    var v542 = (a$$28 << 8 | a$$28 >>> 24) & 16711935;
    var v543 = (a$$28 << 24 | a$$28 >>> 8) & 4278255360;
    introspect(JAM.policy.p18) {
      g$$6[v250] = v542 | v543;
    }
  ...
  function v51() {
    ...
    for (;v267;) {
      var v265 = k$$2;
      var v266 = f$$5;
      var v555 = 4294967296 * p$$2.abs(p$$2.sin(f$$5 + 1));
      introspect(JAM.policy.p18) {
        v265[v266] = v555 | 0;
      }
      f$$5 = f$$5 + 1;
...
function v47(p, h$$4) {
  ...
  function v31(a$$12) {
    ...
    for (;v312;) {
      ...
      var v758 = (a$$12.charCodeAt(b$$4) & 255) << 24 - 8 * (b$$4 % 4);
      introspect(JAM.policy.p18) {
        v310[v311] = v757 | v758;
      }
      b$$4 = b$$4 + 1;
  ...
  function v29(a$$10) {
    ...
    for (;v317;) {
      ...
      var v761 = parseInt(a$$10.substr(b$$2, 2), 16) << 24 - 4 * (b$$2 % 8);
      introspect(JAM.policy.p18) {
        v315[v316] = v760 | v761;
      }
      b$$2 = b$$2 + 2;
  ...
  function v25() {
    ...
    var v766 = 4294967295 << 32 - 8 * (e$$7 % 4);
    introspect(JAM.policy.p18) {
      a$$6[v327] = v765 & v766;
    }
    var v328 = a$$6;
  ...
  function v24(a$$5) {
    ...
    if (b % 4) {
      ...
      for (;v330;) {
        ...
        var v768 = (v1010 >>> 24 - 8 * (d % 4) & 255) << 24 - 8 * ((b + d) % 4);
        introspect(JAM.policy.p18) {
          e$$6[v329] = v767 | v768;
        }
        d = d + 1;
