...
function v126(image$$2, points) {
  ...
  var v349 = v1204;
  for (;v349;) {
    var x$$48 = JAM.call(Math.floor, Math, [points[offset$$8]], JAM.policy.p36);
    var y$$31 = JAM.call(Math.floor, Math, [points[offset$$8 + 1]], JAM.policy.p36);
    var v2539 = x$$48 < -1;
    if (!v2539) {
      v2539 = x$$48 > width$$9;
    }
  ...
  var v360 = v1208;
  for (;v360;) {
    x$$48 = JAM.call(Math.floor, Math, [points[offset$$8]], JAM.policy.p36);
    y$$31 = JAM.call(Math.floor, Math, [points[offset$$8 + 1]], JAM.policy.p36);
    var v2541 = x$$48 < -1;
    if (!v2541) {
      v2541 = x$$48 > width$$9;
    }
...
function BitMatrix(width$$10, height$$9) {
  ...
  function v39(x$$56, y$$39) {
    ...
    var v557 = this.bits;
    v557[offset$$11] = v557[offset$$11] ^ 1 << (x$$56 & 31);
    return;
  }
  function v38(x$$55, y$$38) {
    var offset$$10 = y$$38 * this.rowSize + (x$$55 >> 5);
    var v560 = this.bits;
    v560[offset$$10] = v560[offset$$10] | 1 << (x$$55 & 31);
    return;
  }
  function v37(x$$54, y$$37) {
    var offset$$9 = y$$37 * this.rowSize + (x$$54 >> 5);
    return(URShift(this.bits[offset$$9], x$$54 & 31) & 1) != 0;
  }
  function v36() {
