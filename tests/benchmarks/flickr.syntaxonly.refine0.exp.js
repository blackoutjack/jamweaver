...
function v316() {
  function v315() {
    ...
    var v1367 = JAM.new(Date, [], JAM.policy.p1);
  ...
  function v314() {
    ...
    var v1368 = JAM.new(Date, [], JAM.policy.p1);
  ...
  if (typeof page_timing != "undefined") {
    ...
    var v1373 = JAM.new(Date, [], JAM.policy.p1);
...
function v309() {
  function v308(Y) {
    ...
    function v306(Y$$2) {
      ...
      var v1375 = JAM.new(Date, [], JAM.policy.p1);
    ...
    function v305(Y$$1) {
      function v304() {
        function v303() {
          ...
          JAM.call(noAd, null, [], JAM.policy.p1);
          JAM.call(enhancePage, null, [], JAM.policy.p1);
          return;
        }
        function v302() {
          if (adTimer) {
      ...
      function v300() {
        function v299(e$$186) {
          function v298() {
            JAM.call(updateSearch, null, [e$$186], JAM.policy.p1);
            return;
          }
        ...
        if (href) {
          if (JAM.call(href.match, href, [/section/i], JAM.policy.p1)) {
            ...
            if (hashOffset !== -1) {
              ...
              JAM.call(animateTo, null, [hash$$2], JAM.policy.p1);
              JAM.call(e$$181.preventDefault, e$$181, [], JAM.policy.p1);
              return false;
            }
          } else {
            if (JAM.call(href.match, href, [/\#down/i], JAM.policy.p1)) {
              JAM.call(animateTo, null, ["#section-" + JAM.call(getNextSection, null, [], JAM.policy.p1)], JAM.policy.p1);
              JAM.call(e$$181.preventDefault, e$$181, [], JAM.policy.p1);
              return false;
            } else {
              if (JAM.call(href.match, href, [/\#up/i], JAM.policy.p1)) {
                JAM.call(animateTo, null, ["#section-" + JAM.call(getPreviousSection, null, [], JAM.policy.p1)], JAM.policy.p1);
                JAM.call(e$$181.preventDefault, e$$181, [], JAM.policy.p1);
                return false;
              }
            }
      ...
      function v292() {
        ...
        function v290(e$$179) {
          JAM.call(resetVideoActions, null, [e$$179.target.id], JAM.policy.p1);
          return;
        }
        function v289(e$$178) {
      ...
      function v288() {
        ...
        var currentSection$$3 = JAM.call(getCurrentSection, null, [], JAM.policy.p1);
        var navItem;
        var eventID;
        if (lastDotNavItem) {
      ...
      function v280() {
        JAM.call(playVideo, null, [4], JAM.policy.p1);
        return;
      }
      function v279() {
        if (JAM.call(getCurrentSection, null, [], JAM.policy.p1) === 3) {
          if (!overlayWrapperVisible) {
            JAM.call(overlayWrapper.addClass, overlayWrapper, ["visible"], JAM.policy.p1);
            overlayWrapperVisible = true;
          }
        }
        JAM.call(playVideo, null, [3], JAM.policy.p1);
        return;
      }
      function v278() {
        JAM.call(playVideo, null, [2], JAM.policy.p1);
        return;
      }
      function v277() {
        JAM.call(playVideo, null, [1], JAM.policy.p1);
        return;
      }
      ...
      function animateTo(node$$6, preventInterrupt, scrollAction) {
        function v272() {
          ...
          JAM.call(resetVideo, null, [oldSection], JAM.policy.p1);
          var v1387 = !history;
          if (!v1387) {
        ...
        function v270(e$$173) {
          ...
          scrollTop = JAM.call(parseInt, null, [position, 10], JAM.policy.p1);
          return;
        }
        function v269() {
          scrollAnimation = null;
        ...
        var oldSection;
        if (node$$6) {
          oldSection = JAM.call(getCurrentSection, null, [], JAM.policy.p1);
          ...
          isRetina = JAM.call(checkRetina, null, [], JAM.policy.p1);
          ...
          useScale3D = v395;
          scrollTop = JAM.call(parseInt, null, [scrollElement.scrollTop, 10], JAM.policy.p1);
          from = scrollTop;
          to = JAM.call(parseInt, null, [targetY, 10], JAM.policy.p1);
          duration = 1;
          var v397 = Y$$1.Anim;
          var v1390 = {scrollTop:JAM.call(parseInt, null, [targetY, 10], JAM.policy.p1)};
          var v2689;
          if (interrupted) {
            v2689 = "easeOutStrong";
          } else {
          ...
          scrollAnimation = JAM.new(v397, [{node:scrollElement, to:v1390, easing:v2689, duration:duration}], JAM.policy.p1);
          ...
          sectionOffset = JAM.call(parseInt, null, [JAM.call(id$$2.substr, id$$2, [id$$2.length - 1], JAM.policy.p1), 10], JAM.policy.p1);
        ...
        JAM.call(updateFixedItems, null, [], JAM.policy.p1);
        return;
      }
      function updateFixedItems() {
        var currentSection = JAM.call(getCurrentSection, null, [], JAM.policy.p1);
      ...
      function playVideo(section$$1) {
        var videoId;
        var video;
        section$$1 = JAM.call(parseInt, null, [section$$1, 10], JAM.policy.p1);
        video = videos[section$$1 - 1];
        var v1395 = JAM.call(getCurrentSection, null, [], JAM.policy.p1) === section$$1;
        if (v1395) {
          v1395 = video;
        }
        if (v1395) {
      ...
      function resetVideo(videoNodeOrOffset) {
        ...
        if (video$$3) {
          ...
          JAM.call(resetVideoActions, null, [video$$3.id], JAM.policy.p1);
        }
        return;
      }
      function getCurrentSection() {
        ...
        return JAM.call(parseInt, null, [section, 10], JAM.policy.p1);
      }
      function getNextSection() {
        var currentSection$$1 = JAM.call(getCurrentSection, null, [], JAM.policy.p1);
        currentSection$$1 = JAM.call(Math.min, Math, [maxSections, currentSection$$1 + 1], JAM.policy.p1);
        return currentSection$$1;
      }
      function getPreviousSection() {
        var currentSection$$2 = JAM.call(getCurrentSection, null, [], JAM.policy.p1);
      ...
      function getDimensions() {
        windowInnerWidth = JAM.call(parseInt, null, [window.innerWidth, 10], JAM.policy.p1);
        windowInnerHeight = JAM.call(parseInt, null, [window.innerHeight, 10], JAM.policy.p1);
      ...
      function resizeHandler() {
        ...
        var innerHeight;
        var hash$$1;
        JAM.call(getDimensions, null, [], JAM.policy.p1);
        ...
        if (hash$$1) {
          ...
          if (v1405) {
            var v461 = JAM.call(parseInt, null, [JAM.call(hash$$1.substr, hash$$1, [JAM.call(hash$$1.lastIndexOf, hash$$1, ["-"], JAM.policy.p1) + 1], JAM.policy.p1), 10], JAM.policy.p1);
            var v1407;
            if (!hasAd) {
              v1407 = -1;
            } else {
        ...
        if (amount !== lastAmount) {
          if (useBlur) {
            if (scrollPosition >= .45) {
              JAM.call(setBackgroundOpacity, null, [1, 1], JAM.policy.p1);
              JAM.call(setBackgroundOpacity, null, [2, JAM.call(Math.min, Math, [1, (scrollPosition - .45) / .5], JAM.policy.p1)], JAM.policy.p1);
            } else {
              JAM.call(setBackgroundOpacity, null, [2, 0], JAM.policy.p1);
              JAM.call(setBackgroundOpacity, null, [1, JAM.call(Math.min, Math, [1, scrollPosition / .45], JAM.policy.p1)], JAM.policy.p1);
            }
          }
          if (useParallax) {
      ...
      function evilWheelHandler(e$$176) {
        ...
        now = JAM.new(Date, [], JAM.policy.p1);
        var v1417 = e$$176.deltaY;
        if (!v1417) {
          v1417 = e$$176.wheelDeltaY;
        }
        deltaY = JAM.call(parseInt, null, [v1417, 10], JAM.policy.p1);
        var v1418 = deltaY !== undefined;
        if (v1418) {
          v1418 = !JAM.call(isNaN, null, [deltaY], JAM.policy.p1);
        }
        if (v1418) {
          if (now - lastScrollTimestamp > 1500) {
            ...
            if (deltaY < 0) {
              JAM.call(animateTo, null, ["#section-" + JAM.call(getPreviousSection, null, [], JAM.policy.p1), true, true], JAM.policy.p1);
            } else {
              if (deltaY > 0) {
                JAM.call(animateTo, null, ["#section-" + JAM.call(getNextSection, null, [], JAM.policy.p1), true, true], JAM.policy.p1);
              }
            }
      ...
      function enhancePage() {
        function v276() {
          function v275() {
            ...
            if (v1423) {
              v1423 = JAM.call(getCurrentSection, null, [], JAM.policy.p1) < maxSections;
            }
            if (v1423) {
        ...
        function v274(e$$177) {
          ...
          if (v1430) {
            ...
            if (down) {
              JAM.call(animateTo, null, ["#section-" + JAM.call(getNextSection, null, [], JAM.policy.p1), ignoreMultiple], JAM.policy.p1);
            } else {
              if (up) {
                JAM.call(animateTo, null, ["#section-" + JAM.call(getPreviousSection, null, [], JAM.policy.p1), ignoreMultiple], JAM.policy.p1);
              } else {
                if (beginning) {
                  JAM.call(animateTo, null, ["#section-1"], JAM.policy.p1);
                } else {
                  if (end$$1) {
                    JAM.call(animateTo, null, ["#section-" + maxSections], JAM.policy.p1);
                  }
                }
              }
            }
        ...
        useScale3D = v508;
        JAM.call(scrollHandler, null, [], JAM.policy.p1);
        JAM.call(resizeHandler, null, [], JAM.policy.p1);
        var v1438 = !isMobile;
        if (!v1438) {
          v1438 = allowMobile;
        }
      ...
      function whatFormat(width$$9, height$$8) {
        var ratio = JAM.call(parseFloat, null, [width$$9 / height$$8, 10], JAM.policy.p1);
        if (ratio < 1) {
          return 0;
        }
        if (ratio == 1) {
      ...
      var scrollAnimation;
      var lastScrollTimestamp = JAM.new(Date, [], JAM.policy.p1);
      ...
      if (!isOldIE) {
        ...
        JAM.call(v292, null, [], JAM.policy.p1);
        ...
        JAM.call(v300, null, [], JAM.policy.p1);
      }
      JAM.call(v304, null, [], JAM.policy.p1);
      if (isWebkit) {
      ...
      var v1459 = JAM.call(whatFormat, null, [viewport_w, viewport_h], JAM.policy.p1);
      var v1460 = JAM.call(findClosestBreakpoint, null, [viewport_w], JAM.policy.p1);
      var v2739;
      var v4588 = Y$$1.Lang;
      ...
      var v1462 = true;
      if (v1462) {
        v1462 = JAM.call(clientOnOffSwitch, null, [], JAM.policy.p1);
      }
    ...
    var v1464 = JAM.new(Date, [], JAM.policy.p1);
  ...
  var v1465 = JAM.new(Date, [], JAM.policy.p1);
  ...
  v569.config = v6077;
  var v570 = JAM.call(YUI, null, [yconf], JAM.policy.p1);
...
function v261(F$$3) {
  function v260() {
    function v259(e$$172) {
      ...
      var anchor$$2 = JAM.call(normalizeAnchor, null, [], JAM.policy.p1);
      JAM.call(alignToAnchor, null, [anchor$$2], JAM.policy.p1);
      return;
    }
    function v258() {
      JAM.call(alignToAnchor, null, [pageLoadAnchor], JAM.policy.p1);
      return;
    }
    ...
    var pageLoadAnchor = JAM.call(normalizeAnchor, null, [], JAM.policy.p1);
    if (pageLoadAnchor) {
      JAM.call(handleEvent, null, [document, "DOMContentLoaded", v258], JAM.policy.p1);
    }
    JAM.call(handleEvent, null, [window, "hashchange", v259, true], JAM.policy.p1);
    return;
  }
  function alignToAnchor(anchor, preventDelay) {
    ...
    var elt$$1 = v613;
    if (elt$$1) {
      JAM.call(setTimeout, null, [v255, delay$$3], JAM.policy.p1);
    }
    return;
  }
...
function v254() {
  ...
  if (v1968) {
    v1968 = JAM.call(YUI, null, [], JAM.policy.p1);
  }
  var v620 = v1968;
  if (v620) {
    v620 = JAM.call(YUI, null, [], JAM.policy.p1).UA;
  }
  var ua$$1 = v620;
  var v3174 = ua$$1;
  if (v3174) {
  ...
  var v4593 = JAM.call(make_class, null, ["webkit"], JAM.policy.p1);
  if (!v4593) {
    v4593 = JAM.call(make_class, null, ["ie"], JAM.policy.p1);
  }
  var v3819 = v4593;
  if (!v3819) {
    v3819 = JAM.call(make_class, null, ["gecko"], JAM.policy.p1);
  }
...
function v231(e$$114, t$$103) {
            ...
            if (r$$98) {
              if (T$$4 > A$$2) {
                ...
                for (;v701;) {
                  ...
                  var v2053 = x$$52.length > A$$2;
                  if (v2053) {
                    o$$47 = JAM.call(S$$5.pop, S$$5, [], JAM.policy.p1);
                    x$$52 = w$$12 + JAM.call(S$$5.join, S$$5, [k$$3], JAM.policy.p1);
                    var v5291 = M$$2[_$$2];
                    JAM.call(v5291.push, v5291, [JAM.call(C$$2._filter, C$$2, [x$$52, null, N$$3[w$$12].group], JAM.policy.p1)], JAM.policy.p1);
                    S$$5 = [];
                    if (o$$47) {
                ...
                if (v702) {
                  x$$52 = w$$12 + JAM.call(S$$5.join, S$$5, [k$$3], JAM.policy.p1);
                  var v3268 = M$$2[_$$2];
                  JAM.call(v3268.push, v3268, [JAM.call(C$$2._filter, C$$2, [x$$52, null, N$$3[w$$12].group], JAM.policy.p1)], JAM.policy.p1);
                }
              } else {
                var v703 = M$$2[_$$2];
  ...
  function v225(e$$146, t$$144, n$$113) {
    ...
    if (e$$146) {
      ...
      if (r$$97) {
        e$$146 = JAM.call(e$$146.replace, e$$146, [JAM.new(RegExp, [r$$97.searchExp, "g"], JAM.policy.p1), r$$97.replaceStr], JAM.policy.p1);
      }
    }
    return e$$146;
  }
      ...
      if (l$$17 === f$$23) {
        ...
        if (o$$45._refetch.length) {
          ...
          if (c$$14.length) {
            ...
            p$$11 = JAM.call(o$$45.resolve, o$$45, [!0], JAM.policy.p1);
  ...
  function v197(t$$128, n$$100, r$$86) {
    ...
    if (!u$$26) {
      ...
      s$$60 = JAM.call(S$$3, null, [v5812, r$$86, a$$18, !0], JAM.policy.p1);
  ...
  function v192(t$$122) {
    ...
    var v4339 = t$$122;
    var v6083 = JAM.call(v$$5.hash, v$$5, [y$$37], JAM.policy.p1);
  ...
  function v187(t$$118, n$$93) {
    ...
    if (v5476) {
      var v5620 = t$$118;
      var v6086 = JAM.call(S$$3, null, [n$$93, n$$93, t$$118.type], JAM.policy.p1);
      v5620.path = v6086;
    }
    ...
    if (r$$81) {
      ...
      for (i$$72 in r$$81) {
        if (JAM.call(r$$81.hasOwnProperty, r$$81, [i$$72], JAM.policy.p1)) {
          ...
          var v5621 = c$$12.path;
          if (!v5621) {
            v5621 = JAM.call(S$$3, null, [n$$93, i$$72, t$$118.type], JAM.policy.p1);
          }
          v5485.path = v5621;
          c$$12.pkg = n$$93;
    ...
    if (d$$8) {
      for (i$$72 in d$$8) {
        ...
        if (v858) {
          ...
          var v5625 = m$$6.path;
          if (!v5625) {
            v5625 = JAM.call(S$$3, null, [n$$93, i$$72, t$$118.type], JAM.policy.p1);
          }
          v5487.path = v5625;
  ...
  function v175() {
    ...
    JAM.call(p$$8, null, [], JAM.policy.p1);
    JAM.call(h$$13, null, [], JAM.policy.p1);
  ...
  if (!v915) {
    JAM.call(v175, null, [], JAM.policy.p1);
  }
  var n$$81 = {};
  var r$$69 = [];
  var i$$62 = 1024;
...
function v173(e$$113, t$$101) {
  function v172(t$$102, r$$68, i$$61, s$$45, o$$26) {
    function v171() {
      ...
      var v2292;
      if (this.interval) {
        v2292 = JAM.call(clearInterval, null, [l$$9], JAM.policy.p1);
      } else {
        v2292 = JAM.call(clearTimeout, null, [l$$9], JAM.policy.p1);
      }
      v2292;
      return;
    }
    ...
    var v917;
    if (o$$26) {
      v917 = JAM.call(setInterval, null, [f$$14, t$$102], JAM.policy.p1);
    } else {
      v917 = JAM.call(setTimeout, null, [f$$14, t$$102], JAM.policy.p1);
    }
    var l$$9 = v917;
...
function v142(e$$77, t$$59) {
  ...
  function v140(t$$75) {
    ...
    if (v994) {
      var v2376 = n$$62;
      var v6098 = JAM.call(setTimeout, null, [v139, n$$62.options.pollInterval], JAM.policy.p1);
  ...
  function v137(t$$74) {
    function v136() {
      JAM.call(setTimeout, null, [h$$10, 0], JAM.policy.p1);
      return;
    }
    function v135() {
      JAM.call(setTimeout, null, [c$$6, 0], JAM.policy.p1);
      return;
    }
    function v134() {
      ...
      if (v997) {
        ...
        JAM.call(h$$10, null, [], JAM.policy.p1);
      }
      return;
    }
    function c$$6() {
    ...
    function h$$10() {
      if (f$$10) {
        JAM.call(clearTimeout, null, [f$$10], JAM.policy.p1);
      }
    ...
    if (v5364) {
      ...
      if (v5526) {
        ...
        if (v5528) {
          ...
          v5528 = f$$10 = JAM.call(setTimeout, null, [c$$6, v5777], JAM.policy.p1);
        }
        v5173 = v5528;
      }
      v4434 = v5173;
  ...
  function v128(e$$86) {
    ...
    if (v3551) {
      var v4444 = t$$69;
      var v6100 = JAM.call(setTimeout, null, [v127, t$$69.options.timeout], JAM.policy.p1);
  ...
  function v126(e$$85) {
    ...
    var v6101 = JAM.call(clearTimeout, null, [this._pollTimer], JAM.policy.p1);
  ...
  function v120(t$$65, r$$45) {
    ...
    return JAM.new(s$$29, [i$$43, r$$45], JAM.policy.p1);
  }
  function v119() {
...
function v113(e$$36, t$$24) {
  function v112(e$$76, t$$58) {
    ...
    var v1032 = o$$15 < u$$10;
    for (;v1032;) {
      n$$47 = JAM.call(parseInt, null, [r$$42[o$$15], 10], JAM.policy.p1);
      i$$40 = JAM.call(parseInt, null, [s$$28[o$$15], 10], JAM.policy.p1);
      var v3574 = JAM.call(isNaN, null, [n$$47], JAM.policy.p1);
      if (v3574) {
        n$$47 = 0;
      }
      var v2422 = JAM.call(isNaN, null, [i$$40], JAM.policy.p1);
      if (v2422) {
        i$$40 = 0;
      }
      if (n$$47 < i$$40) {
  ...
  function v111(t$$56) {
    function n$$46(e$$75) {
      ...
      var t$$57 = 0;
      return JAM.call(parseFloat, null, [JAM.call(e$$75.replace, e$$75, [/\./g, v110], JAM.policy.p1)], JAM.policy.p1);
    }
    ...
    if (o$$14) {
      ...
      if (v5674) {
        var v5957 = s$$27;
        var v6104 = JAM.call(n$$46, null, [f$$8[1]], JAM.policy.p1);
        v5957.webkit = v6104;
        ...
        if (v5943) {
          ...
          if (v5978) {
            var v5997 = s$$27;
            var v6105 = JAM.call(n$$46, null, [f$$8[1]], JAM.policy.p1);
        ...
        if (v5958) {
          ...
          if (v6028) {
            var v6045 = f$$8[1];
            f$$8 = JAM.call(n$$46, null, [JAM.call(v6045.replace, v6045, ["_", "."], JAM.policy.p1)], JAM.policy.p1);
          }
          s$$27.ios = f$$8;
          s$$27.os = "ios";
          ...
          if (v5999) {
            ...
            if (v6019) {
              var v6030 = s$$27;
              var v6106 = JAM.call(n$$46, null, [f$$8[1]], JAM.policy.p1);
              v6030.webos = v6106;
            }
          }
          ...
          if (v5982) {
            ...
            if (v6012) {
              var v6022 = s$$27;
              var v6107 = JAM.call(n$$46, null, [f$$8[1]], JAM.policy.p1);
              v6022.android = v6107;
            }
          }
          ...
          if (v5960) {
            ...
            if (v6023) {
              var v6033 = s$$27;
              var v6108 = JAM.call(n$$46, null, [f$$8[1]], JAM.policy.p1);
              v6033.silk = v6108;
            }
        ...
        if (v5920) {
          var v5888 = s$$27;
          var v6109 = JAM.call(n$$46, null, [f$$8[1]], JAM.policy.p1);
          ...
          if (v5961) {
            var v5984 = s$$27;
            var v6110 = JAM.call(n$$46, null, [f$$8[2]], JAM.policy.p1);
            v5984.chrome = v6110;
            s$$27.safari = 0;
      ...
      if (!v5544) {
        ...
        if (JAM.call(/Opera/.test, /Opera/, [o$$14], JAM.policy.p1)) {
          ...
          if (v5986) {
            var v6003 = s$$27;
            var v6111 = JAM.call(n$$46, null, [f$$8[1]], JAM.policy.p1);
            v6003.opera = v6111;
          }
          ...
          if (v5946) {
            var v5965 = s$$27;
            var v6112 = JAM.call(n$$46, null, [f$$8[1]], JAM.policy.p1);
            v5965.opera = v6112;
          }
          ...
          if (v5923) {
            ...
            if (v5966) {
              var v5990 = s$$27;
              var v6113 = JAM.call(n$$46, null, [f$$8[1]], JAM.policy.p1);
              v5990.opera = v6113;
            }
          }
          ...
          if (v5924) {
            ...
            var v6114 = JAM.call(n$$46, null, [v5948], JAM.policy.p1);
            ...
            if (v5926) {
              ...
              if (v5969) {
                var v6005 = s$$27;
                var v6115 = JAM.call(n$$46, null, [f$$8[1]], JAM.policy.p1);
                v6005.gecko = v6115;
    ...
    if (!t$$56) {
      ...
      if (v5200) {
        ...
        var v5549 = s$$27;
        var v6116 = JAM.call(n$$46, null, [process.versions.node], JAM.policy.p1);
        v5549.nodejs = v6116;
      }
      YUI.Env.UA = s$$27;
    }
  ...
  function v109(e$$74) {
    return!JAM.call(E$$2.keys, E$$2, [JAM.call(Object, null, [e$$74], JAM.policy.p1)], JAM.policy.p1).length;
  }
  ...
  function v101(e$$71) {
    if (!JAM.call(p$$4.isObject, p$$4, [e$$71], JAM.policy.p1)) {
      throw JAM.new(TypeError, ["Object.keys called on a non-object"], JAM.policy.p1);
    }
    var t$$48 = [];
    var n$$39;
    var r$$35;
  ...
  function v98() {
    function v97(t$$46) {
      e$$69.prototype = t$$46;
      return JAM.new(e$$69, [], JAM.policy.p1);
    }
    function e$$69() {
      return;
    }
  ...
  function v92(e$$66, t$$42, n$$36) {
    function v91(r$$32) {
      ...
      if (arguments.length > 1) {
        ...
        v1089 = JAM.call(v2459.call, v2459, [arguments, y$$34], JAM.policy.p1);
      } else {
        v1089 = JAM.call(String, null, [r$$32], JAM.policy.p1);
      }
      var i$$30 = v1089;
  ...
  function v65() {
    var v1117 = JAM.new(Date, [], JAM.policy.p1);
  ...
  function v64(e$$47) {
    ...
    introspect(JAM.policy.p1) {
      switch(t$$28) {
        case "number":
          return JAM.call(isFinite, null, [e$$47], JAM.policy.p1);
        case "null":
        ;
        case "undefined":
          return!1;
  ...
  function v60(e$$43) {
    ...
    if (v1122) {
      v1122 = JAM.call(isFinite, null, [e$$43], JAM.policy.p1);
    }
    return v1122;
  }
  function v59(e$$42) {
  ...
  function v57(e$$40) {
    ...
    var v1124 = v2489;
    if (v1124) {
      v1124 = !JAM.call(isNaN, null, [e$$40], JAM.policy.p1);
    }
    return v1124;
  }
  function v56(e$$39) {
  ...
  var u$$6 = "\t\n\x0B\f\r \u00a0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u2028\u2029\u202f\u205f\u3000\ufeff";
  var a$$8 = "[\t-\r \u00a0\u1680\u180e\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]+";
  var f$$6 = JAM.new(RegExp, ["^" + a$$8], JAM.policy.p1);
  var l$$4 = JAM.new(RegExp, [a$$8 + "$"], JAM.policy.p1);
  var c$$4 = JAM.new(RegExp, [f$$6.source + "|" + l$$4.source, "g"], JAM.policy.p1);
  ...
  if (!v3626) {
    v3626 = JAM.new(g$$3, [], JAM.policy.p1);
  }
  ...
  if (JAM.call(p$$4._isNative, p$$4, [Object.create], JAM.policy.p1)) {
    ...
    v2499 = JAM.call(v98, null, [], JAM.policy.p1);
  }
  ...
  var v1142 = E$$2;
  var v3628 = {valueOf:0};
  var x$$49 = v1142._hasEnumBug = !JAM.call(v3628.propertyIsEnumerable, v3628, ["valueOf"], JAM.policy.p1);
  var v1143 = E$$2;
...
function v53() {
  ...
  function v47(e$$30, t$$21, n$$22) {
    ...
    if (!i$$22) {
      var v1153 = t$$21;
      if (!v1153) {
        v1153 = JAM.new(Error, [e$$30], JAM.policy.p1);
      }
      throw v1153;
    }
  ...
  function v44(e$$26, t$$18) {
    ...
    function T(n$$20) {
      ...
      if (a$$7) {
        ...
        g$$2 = [];
        b$$2 = [];
        JAM.call(x$$48, null, [a$$7], JAM.policy.p1);
        i$$20 = g$$2.length;
        var v5556 = i$$20;
        if (v5556) {
    ...
    function x$$48(e$$27, t$$19) {
      ...
      for (;v1165;) {
        ...
        var v3690 = v4515;
        if (v3690) {
          JAM.call(x$$48, null, [h$$7], JAM.policy.p1);
        }
        var v3691 = p$$3;
        if (v3691) {
          v3691 = p$$3.length;
        ...
        var v2526 = v3691;
        if (v2526) {
          JAM.call(x$$48, null, [p$$3, 1], JAM.policy.p1);
        }
        r$$17 = r$$17 + 1;
        v1165 = r$$17 < o$$9;
      }
    ...
    if (p$$2 === "*") {
      e$$26 = [];
      for (y$$33 in a$$6) {
        var v1167 = JAM.call(a$$6.hasOwnProperty, a$$6, [y$$33], JAM.policy.p1);
        if (v1167) {
    ...
    var v5560 = v5691;
    if (v5560) {
      i$$18 = JAM.call(w$$7, null, [o$$8], JAM.policy.p1);
    ...
    JAM.call(x$$48, null, [e$$26], JAM.policy.p1);
    r$$16 = g$$2.length;
    if (r$$16) {
    ...
    if (v5224) {
      ...
      if (v5411) {
        ...
        var v5413 = E$$1;
        if (v5413) {
          v5413 = JAM.call(T, null, [], JAM.policy.p1);
        }
        v4516 = v5413;
      }
      v3692 = v4516;
  ...
  function v40() {
    ...
    if (n$$17._loading) {
      ...
      if (!v5230) {
        v5230 = JAM.new(n$$17.Queue, [], JAM.policy.p1);
      }
  ...
  function v31() {
    ...
    if (v2583) {
      JAM.call(w$$7, null, [t$$11], JAM.policy.p1);
    }
    return;
  }
  function v30() {
    ...
    if (!v5430) {
      v5430 = {bootstrap:!0, cacheUse:!0, debug:!0, doc:h$$4, fetchCSS:!0, throwFail:!0, useBrowserConsole:!0, useNativeES5:!0, win:c$$1, global:JAM.call(JAM.call(Function, null, ["return this"], JAM.policy.p1), null, [], JAM.policy.p1)};
    }
    v5243.config = v5430;
    var v4549;
    var v5431 = h$$4;
  ...
  function v26(e$$15) {
    ...
    for (n$$9 in e$$15) {
      ...
      if (v1227) {
        ...
        if (v5249) {
          v3745 = JAM.call(E, null, [i$$9, t$$7], JAM.policy.p1);
        } else {
          var v4558;
          var v5435 = o$$2;
          if (v5435) {
          ...
          if (v5435) {
            v4558 = JAM.call(E, null, [o$$2, t$$7], JAM.policy.p1);
          } else {
            var v5250;
            var v5590 = s$$5;
            if (v5590) {
            ...
            if (v5590) {
              v5250 = JAM.call(E, null, [s$$5, t$$7], JAM.policy.p1);
            } else {
              var v5436;
              if (n$$9 == "win") {
                var v5800 = t$$7;
  ...
  function w$$7(e$$13, t$$5) {
    ...
    if (n$$7) {
      ...
      n$$7 = JAM.new(e$$13.Loader, [e$$13.config], JAM.policy.p1);
  ...
  function b() {
    ...
    YUI.Env.DOMReady = !0;
    if (l) {
      JAM.call(y$$31, null, [window, "load", b], JAM.policy.p1);
    }
    return;
  }
  ...
  var d$$2 = v1238;
  var v = {};
  var v1239 = JAM.new(Date, [], JAM.policy.p1);
  ...
  var v5257;
  if (l) {
    v5257 = JAM.call(g, null, [window, "load", b], JAM.policy.p1);
  } else {
    v5257 = JAM.call(b, null, [], JAM.policy.p1);
  }
  v5257;
  YUI.Env.add = g;
  YUI.Env.remove = y$$31;
...
function v25() {
  function v24(node$$5) {
    return imgs[JAM.call(stamp, null, [node$$5], JAM.policy.p1)];
  }
  function v23(node$$4) {
    JAM.set(imgs, JAM.call(stamp, null, [node$$4], JAM.policy.p1), false);
    return;
  }
  function v22(node$$3) {
    JAM.set(imgs, JAM.call(stamp, null, [node$$3], JAM.policy.p1), true);
    return;
  }
  function stamp(node$$2) {
    ...
    if (!v1246) {
      var v2602 = node$$2;
      var v4567 = mod + "-";
      var v5258 = JAM.new(Date, [], JAM.policy.p1);
...
function v21(F$$2) {
  ...
  function isInput() {
    var n$$2 = JAM.call(get, null, [], JAM.policy.p1);
    var nn;
    if (!n$$2) {
      return false;
    }
  ...
  function instrumentInputs() {
    function v18(e$$7) {
      if (!disabled) {
        JAM.call(doF, null, [e$$7, me$$1], JAM.policy.p1);
      }
      return;
    }
    function v17(e$$6) {
      if (!disabled) {
        JAM.call(doF, null, [e$$6, me$$1], JAM.policy.p1);
      }
      return;
    }
    if (!assigned_events) {
  ...
  if (ae = w$$6.addEventListener) {
    ...
    if (ae = d$$1.attachEvent) {
      JAM.call(dom_onready, null, [instrumentInputs], JAM.policy.p1);
...
function v16(wipe_msg, root_url, bust_image_search, is_debug) {
  function v15() {
    ...
    JAM.call(redirect, null, [], JAM.policy.p1);
    return;
  }
  function redirect() {
    function v12() {
  ...
  function wipe() {
    ...
    logo_w = 162;
    font_size = "12px";
    JAM.call(setInterval, null, [v14, 200], JAM.policy.p1);
    return;
  }
  ...
  if (v1297) {
    v1297 = JAM.call(parseInt, null, [photo_page_re_result[1], 10], JAM.policy.p1);
  }
  var photo_id = v1297;
  ...
  var faq_url = root_url + "/frame_redir.gne?source=" + JAM.call(encodeURIComponent, null, [referrer], JAM.policy.p1) + "&dest=" + JAM.call(encodeURIComponent, null, [root_url + "/help/blogging/#1392237"], JAM.policy.p1);
  var redir_url = root_url + "/frame_redir.gne?source=" + JAM.call(encodeURIComponent, null, [referrer], JAM.policy.p1) + "&dest=" + JAM.call(encodeURIComponent, null, [self_url], JAM.policy.p1);
  var should_bust;
  var should_wipe;
  var base$$1;
    ...
    if (self_is_offline) {
      ...
      if (v2631) {
        ...
        if (v2632) {
          ...
          if (v2633) {
            v2633 = JAM.call(get_frame_depth, null, [], JAM.policy.p1) > 0;
          }
          if (v2633) {
            should_wipe = true;
          } else {
            ...
            if (v2634) {
              v2634 = JAM.call(get_frame_depth, null, [], JAM.policy.p1) > 1;
            }
            if (v2634) {
              should_wipe = true;
            }
  ...
  if (is_debug) {
    JAM.call(debug, null, [{self_is_flickr:self_is_flickr, top_loc:top_loc, self_loc:self_loc, referrer:referrer, self_is_offline:self_is_offline, self_is_flickr:self_is_flickr, self_url:self_url, photo_page_re_result:photo_page_re_result, photo_id:photo_id, referrer_is_flickr:referrer_is_flickr, referrer_is_whitelisted:referrer_is_whitelisted, referrer_is_image_search:referrer_is_image_search, self_is_whitelisted:JAM.call(self_whitelist_regex.test, self_whitelist_regex, [self_loc], JAM.policy.p1), 
    frame_depth:JAM.call(get_frame_depth, null, [], JAM.policy.p1), faq_url:faq_url, redir_url:redir_url, should_bust:should_bust, should_wipe:should_wipe, base:base$$1}], JAM.policy.p1);
  } else {
    if (should_bust) {
      JAM.call(setTimeout, null, [v15, 1E3], JAM.policy.p1);
      JAM.call(setTimeout, null, [wipe, 2E3], JAM.policy.p1);
      JAM.call(redirect, null, [], JAM.policy.p1);
    } else {
      if (should_wipe) {
        JAM.call(wipe, null, [], JAM.policy.p1);
      } else {
...
function v11(F$$1) {
  ...
  function v8(name$$30, value$$29, days, path) {
    var date$$1;
    var expires = "";
    path = path || "/";
    if (days) {
      date$$1 = JAM.new(Date, [], JAM.policy.p1);
    ...
    document.cookie = name$$30 + "=" + value$$29 + expires + "; path=" + path;
    return;
  }
  ...
  function v6(id$$1, callback$$25, interval) {
    function checkElementAndCallback() {
      ...
      var el$$3 = v1321;
      if (el$$3) {
        JAM.call(clearInterval, null, [pollers[pollerId]], JAM.policy.p1);
    ...
    if (!JAM.call(checkElementAndCallback, null, [], JAM.policy.p1)) {
      var v6124 = JAM.call(setInterval, null, [checkElementAndCallback, interval], JAM.policy.p1);
  ...
  function v5(el$$2, className$$2) {
    if (JSCompiler_object_inline_classList_21) {
      ...
      if (v2649) {
        ...
        var v6125 = JAM.call(v2650.trim, v2650, [JAM.call(v3779.replace, v3779, [JAM.new(RegExp, ["(?:^|\\s+)" + className$$2 + "(?:\\s+|$)"], JAM.policy.p1), " "], JAM.policy.p1)], JAM.policy.p1);
  ...
  function v0(o) {
    ...
    var c = JAM.new(o.constructor, [], JAM.policy.p1);
    var k;
    for (k in o) {
      var v1345 = c;
      var v1346 = k;
...
function YUI() {
  ...
  var s$$2 = v1349;
  var v1350;
  if (JAM.call(i$$5, null, [t, YUI], JAM.policy.p1)) {
    ...
    v1350 = t = JAM.new(YUI, [], JAM.policy.p1);
  }
  v1350;
  if (r) {
    var v1352 = e$$8 < r;
...
F = v1356;
JAM.call(v11, null, [F], JAM.policy.p1);
JAM.call(v16, null, ['We\'re sorry, Flickr <a href="{faq}" target="_top">doesn\'t allow embedding within frames</a>.<br><br>If you\'d like to view this content, <a href="{url}" target="_top">please click here</a>.', "https://www.flickr.com", true, false], JAM.policy.p1);
JAM.call(v21, null, [F], JAM.policy.p1);
JAM.call(v25, null, [], JAM.policy.p1);
var v1357 = page_timing;
var v2669 = JAM.new(Date, [], JAM.policy.p1);
...
JAM.call(v53, null, [], JAM.policy.p1);
