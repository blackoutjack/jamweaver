...
function v4() {
  ...
  function v2(features$$7, opt_callback$$2) {
    ...
    if (v72) {
      JAM.call(warn, null, [["Cannot load empty features."]], JAM.policy.p3);
    } else {
      ...
      if (JSCompiler_inline_result$$6) {
        JAM.call(warn, null, [["Cannot load loaded features [", JAM.call(features$$7.join, features$$7, [","], JAM.policy.p2), "]."]], JAM.policy.p3);
      } else {
        var v77 = type$$25 === "s";
        if (!v77) {
          v77 = type$$25 === "i";
        ...
        if (v77) {
          JSCompiler_inline_label_processUrlFromMap_25: {
            ...
            var version$$inline_24 = descriptors[JAM.call(toKey, null, [features$$inline_23, loadedFeatures], JAM.policy.p3)];
            if (version$$inline_24) {
              urlToLoad = host + "/" + version$$inline_24 + ".js";
              break JSCompiler_inline_label_processUrlFromMap_25;
            } else {
              JAM.call(warn, null, [["Cannot find features [", JAM.call(features$$inline_23.join, features$$inline_23, [","], JAM.policy.p2), "], except [", JAM.call(loadedFeatures.join, loadedFeatures, [","], JAM.policy.p2), "]."]], JAM.policy.p3);
            }
            urlToLoad = void 0;
          }
        } else {
          if (type$$25 === "d") {
            var url$$inline_27 = host + "/" + JAM.call(toKey, null, [features$$7, loadedFeatures], JAM.policy.p3);
            ...
            if (v82) {
              ...
              JAM.call(warn, null, [["Cannot respond for features [", JAM.call(features$$7.join, features$$7, [","], JAM.policy.p2), "]."]], JAM.policy.p3);
            }
          }
        }
      }
    ...
    if (opt_url$$inline_30) {
      ...
      if (JAM.call(shouldLoadSync, null, [], JAM.policy.p3)) {
      ...
      loadedFeatures = JAM.call(normalize, null, [JAM.call(loadedFeatures.concat, loadedFeatures, [features$$inline_29], JAM.policy.p3)], JAM.policy.p3);
  ...
  function normalize(features$$1) {
    var result$$3 = [];
    var s$$2;
    for (s$$2 in JAM.call(toSet, null, [features$$1], JAM.policy.p3)) {
  ...
  function initDescriptors(values$$5) {
    ...
    for (;v46;) {
      ...
      var req$$inline_13 = JAM.call(normalize, null, [JAM.call(v101.split, v101, [":"], JAM.policy.p2)], JAM.policy.p3);
      var v45 = featureParts$$inline_12[1];
      if (v45) {
        var v145 = featureParts$$inline_12[1];
        v45 = JAM.call(normalize, null, [JAM.call(v145.split, v145, [":"], JAM.policy.p2)], JAM.policy.p3);
      }
  ...
  function initialize(url$$5) {
    ...
    if (hint) {
      ...
      if (type$$25 === "s") {
        ...
        v51 = JAM.call(initDescriptors, null, [JAM.call(parts.slice, parts, [1], JAM.policy.p2)], JAM.policy.p3);
      } else {
        var v108;
        if (type$$25 === "i") {
          host = parts[1];
          v108 = JAM.call(initDescriptors, null, [JAM.call(parts.slice, parts, [2], JAM.policy.p2)], JAM.policy.p3);
        } else {
          var v150;
          if (type$$25 === "d") {
            host = parts[1];
  ...
  var console;
  var parentUrl;
  JAM.call(initialize, null, [document.location.href], JAM.policy.p3);
  jsloader_load = v2;
...
function __bsld() {
  ...
  for (;v58;) {
    ...
    if (v57) {
      ...
      JAM.call(v113.apply, v113, [p, JAM.call(v152.shift, v152, [], JAM.policy.p3)], JAM.policy.p3);
    }
...
function gapi_load(features$$8, opt_callback$$3) {
  JAM.call(jsloader_load, null, [JAM.call(features$$8.split, features$$8, [":"], JAM.policy.p2), opt_callback$$3], JAM.policy.p3);
  return;
}
