function v88() {
  function v87(a$$54, b$$34, d$$20, e$$34, f$$18, h$$15, i$$13, g$$11) {
    ...
    introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
      var v89 = a$$54[b$$34]
    }
    var k$$6 = v89 ^ d$$20[0];
    var v394 = b$$34 + 1;
    ...
    var v568 = v676 | v773 << 16;
    var v774 = o$$6 >>> 8 & 255;
    introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
      var v678 = g$$11[v774]
    }
    var v409 = v568 | v678 << 8;
    var v570 = n$$8 & 255;
    introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
      var v410 = g$$11[v570]
    }
    ...
    var v571 = v679 | v776 << 16;
    var v777 = n$$8 >>> 8 & 255;
    introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
      var v681 = g$$11[v777]
    }
    var v412 = v571 | v681 << 8;
    var v573 = k$$6 & 255;
    introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
      var v413 = g$$11[v573]
    }
    ...
    var v574 = v682 | v779 << 16;
    var v780 = k$$6 >>> 8 & 255;
    introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
      var v684 = g$$11[v780]
    }
    var v415 = v574 | v684 << 8;
    var v576 = m$$7 & 255;
    introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
      var v416 = g$$11[v576]
    }
    ...
    var v577 = v685 | v782 << 16;
    var v783 = m$$7 >>> 8 & 255;
    introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
      var v687 = g$$11[v783]
    }
    var v418 = v577 | v687 << 8;
    var v579 = o$$6 & 255;
    introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
      var v419 = g$$11[v579]
    }
    ...
    n$$8 = v112 ^ v113;
    JAM.set(a$$54, b$$34, s$$8, JAM.policy.pC51DDFC22C8571C0FE27B1BC0B7671157BDF992D);
    JAM.set(a$$54, b$$34 + 1, u, JAM.policy.pC51DDFC22C8571C0FE27B1BC0B7671157BDF992D);
    JAM.set(a$$54, b$$34 + 2, v, JAM.policy.pC51DDFC22C8571C0FE27B1BC0B7671157BDF992D);
    JAM.set(a$$54, b$$34 + 3, n$$8, JAM.policy.pC51DDFC22C8571C0FE27B1BC0B7671157BDF992D);
    return
  }
  function v86(c$$31, b$$33) {
    ...
    JAM.set(c$$31, b$$33 + 1, JAM.get(c$$31, b$$33 + 3, JAM.policy.), JAM.policy.);
    JAM.set(c$$31, b$$33 + 3, d$$19, JAM.policy.p60BC769F7FE69A3D16A7359015C19BE54348D76EC51DDFC22C8571C0FE27B1BC0B7671157BDF992D510AD27954A2595FF3D635DFFE9522029FA0A17D643B7C49AB8946BE23E67884C2A1A1A95BFE0CBF);
        ...
        if(j$$6 % d$$18) {
          ...
          if(v424) {
            ...
            if(v580) {
              ...
              var v854 = v902 << 24;
              var v938 = h$$14 >>> 16 & 255;
              introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
                var v903 = l$$7[v938]
              }
              var v784 = v854 | v903 << 16;
              var v904 = h$$14 >>> 8 & 255;
              introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
                var v856 = l$$7[v904]
              }
              var v689 = v784 | v856 << 8;
              var v786 = h$$14 & 255;
              introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
                var v690 = l$$7[v786]
              }
          ...
          var v857 = v905 << 24;
          var v941 = h$$14 >>> 16 & 255;
          introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
            var v906 = l$$7[v941]
          }
          var v787 = v857 | v906 << 16;
          var v907 = h$$14 >>> 8 & 255;
          introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
            var v859 = l$$7[v907]
          }
          var v693 = v787 | v859 << 8;
          var v789 = h$$14 & 255;
          introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
            var v694 = l$$7[v789]
          }
...
function v82(p$$4) {
  ...
  function v74(a$$47) {
    ...
    var v449;
    if(a$$47) {
      var v705 = JAM.call(r$$4.create, r$$4, [[1398893684, 1701076831]]);
      var v594 = JAM.call(v705.concat, v705, [a$$47]);
      v449 = JAM.call(v594.concat, v594, [d$$14])
    }else {
      v449 = d$$14
    }
    var v187 = v449;
  ...
  function v68(b$$23) {
    ...
    var v706 = b$$23.words;
    var v707 = b$$23.sigBytes - 1 >>> 2;
    introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
      var v596 = v706[v707]
    }
    b$$23.sigBytes = v457 - (v596 & 255);
    return
  }
  ...
  function v66() {
    ...
    function b$$20(b$$21, a$$38, d$$11) {
      ...
      for(;v205;) {
        ...
        JAM.set(b$$21, v204, v599 ^ v600, JAM.policy.pC51DDFC22C8571C0FE27B1BC0B7671157BDF992D);
        e$$25 = e$$25 + 1;
        v205 = e$$25 < d$$11
      }
      return
  ...
  var v224 = i$$9;
  var v710 = n$$6.cfg;
  var v991 = JAM.call(n$$6.extend, n$$6, [{cfg:JAM.call(v710.extend, v710, [{mode:k$$4, padding:g$$8}]), reset:v69, _doProcessBlock:v70, _doFinalize:v71, blockSize:4}]);
  ...
  var v229 = i$$9;
  var v713 = e$$24.cfg;
  var v994 = JAM.call(e$$24.extend, e$$24, [{cfg:JAM.call(v713.extend, v713, [{kdf:h$$11}]), encrypt:v80, decrypt:v81}]);
...
function v45(p$$2) {
  function v44() {
    ...
    for(;v243;) {
      ...
      JAM.set(f$$7, g$$6, (a$$28 << 8 | a$$28 >>> 24) & 16711935 | (a$$28 << 24 | a$$28 >>> 8) & 4278255360, JAM.policy.pC51DDFC22C8571C0FE27B1BC0B7671157BDF992D);
      g$$6 = g$$6 + 1;
      v243 = 4 > g$$6
    }
    return
  ...
  function v43(f$$6, g$$5) {
    ...
    for(;v246;) {
      ...
      JAM.set(f$$6, e$$21, (c$$15 << 8 | c$$15 >>> 24) & 16711935 | (c$$15 << 24 | c$$15 >>> 8) & 4278255360, JAM.policy.pC51DDFC22C8571C0FE27B1BC0B7671157BDF992D);
      a$$27 = a$$27 + 1;
      v246 = 16 > a$$27
    }
...
function v40() {
  function v39(i$$3) {
    ...
    for(;v275;) {
      if(s$$4 % 4) {
        ...
        o$$2[v273] = v636 | (n$$3 | k$$1) << 24 - 8 * (m$$2 % 4);
        m$$2 = m$$2 + 1
      }
      s$$4 = s$$4 + 1;
      v275 = s$$4 < l$$2
  ...
  function v38(i$$2) {
    ...
    for(;v280;) {
      ...
      var v508 = (v822 >>> 24 - 8 * (m$$1 % 4) & 255) << 16;
      var v888 = m$$1 + 1 >>> 2;
      introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
        var v824 = l$$1[v888]
      }
      var v276 = v508 | (v824 >>> 24 - 8 * ((m$$1 + 1) % 4) & 255) << 8;
      var v744 = m$$1 + 2 >>> 2;
      introspect(JAM.policy.p02BEB9B7B2358FCBE710EE3EF4F98E5DB6FF7E1429142370413EC1F7A49F60B32ADBDF99B2C2500D41323F239D1C8F39E2D0E44249CC80F53BBDDF0D083CCCB7BDF4957FF03A722A119BF94D894180EE) {
        var v640 = l$$1[v744]
      }
      var s$$3 = v276 | v640 >>> 24 - 8 * ((m$$1 + 2) % 4) & 255;
      var n$$2 = 0;
      var v511 = 4 > n$$2;
      if(v511) {
        v511 = m$$1 + 0.75 * n$$2 < h$$6
      }
      var v279 = v511;
      for(;v279;) {
...
function v37(p, h$$4) {
  ...
  function v21(a$$12) {
    ...
    for(;v302;) {
      ...
      v300[v301] = v647 | (a$$12.charCodeAt(b$$4) & 255) << 24 - 8 * (b$$4 % 4);
      b$$4 = b$$4 + 1;
      v302 = b$$4 < e$$12
    }
  ...
  function v20(a$$11) {
    ...
    for(;v304;) {
      ...
      c$$6.push(String.fromCharCode(v751 >>> 24 - 8 * (b$$3 % 4) & 255));
      b$$3 = b$$3 + 1;
      v304 = b$$3 < a$$11
    }
    return c$$6.join("")
  ...
  function v19(a$$10) {
    ...
    for(;v307;) {
      ...
      v305[v306] = v650 | parseInt(a$$10.substr(b$$2, 2), 16) << 24 - 4 * (b$$2 % 8);
      b$$2 = b$$2 + 2;
      v307 = b$$2 < e$$10
    }
  ...
  function v15() {
    ...
    a$$6[v317] = v655 & 4294967295 << 32 - 8 * (e$$7 % 4);
    var v318 = a$$6;
  ...
  function v14(a$$5) {
    ...
    if(b % 4) {
      ...
      for(;v320;) {
        ...
        e$$6[v319] = v657 | (v895 >>> 24 - 8 * (d % 4) & 255) << 24 - 8 * ((b + d) % 4);
        d = d + 1;
        v320 = d < a$$5
      }
    }else {
  ...
  function v11() {
    ...
    function v9(a$$2) {
      ...
      for(c$$1 in a$$2) {
        ...
        if(v329) {
          JAM.set(this, c$$1, JAM.get(a$$2, c$$1, JAM.policy.), JAM.policy.)
        }
      }
...
function SNote(serverPath, divParent) {
  ...
  function handleUnlockDialogOk() {
    ...
    JAM.set(m_preNote, "textContent", JSCompiler_inline_result$$0, JAM.policy.p60BC769F7FE69A3D16A7359015C19BE54348D76E510AD27954A2595FF3D635DFFE9522029FA0A17D643B7C49AB8946BE23E67884C2A1A1A95BFE0CBF);
    closeDialogsBoxes();
    m_imageEdit.style.display = "none";
...
function SNoteSwindler(serverPath$$4, divParent$$2, strNoteId) {
  function createButton(strLabel$$1, strFunc, parent$$5) {
    ...
    button.type = "input";
    JAM.set(button, "textContent", strLabel$$1, JAM.policy.p60BC769F7FE69A3D16A7359015C19BE54348D76E510AD27954A2595FF3D635DFFE9522029FA0A17D643B7C49AB8946BE23E67884C2A1A1A95BFE0CBF);
