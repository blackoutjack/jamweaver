  ...
  function v0(f) {
    ...
    for (;v6;) {
      if (f.charAt(V) != "`") {
        ...
        if (f.charAt(V + 1) != "`") {
          var b = JAM.call(Z, null, [f.charAt(V + 3), 1], JAM.policy.p1) + 5;
          E = E + JAM.call(E.substr, E, [E.length - JAM.call(Z, null, [JAM.call(f.substr, f, [V + 1, 2], JAM.policy.p1), 2], JAM.policy.p1) - b, b], JAM.policy.p1);
          V = V + 4;
        } else {
          E = E + "`";
          V = V + 2;
