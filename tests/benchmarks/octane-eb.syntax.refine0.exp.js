...
function v114(k$$9) {
  ...
  x$$78 = JAM.call(p$$46, null, [sc_vector2list(JAM.call(sc_makeVector, null, [k$$9, "\u1e9ca"], JAM.policy.p1))]);
  return sc_length(JAM.call(BgL_parsezd2ze3treesz31, null, [x$$78, "\u1e9cs", 0, k$$9], JAM.policy.p1));
}
...
function v109(grammar, lexer) {
  function v108(input) {
    ...
    function v101(sc_conf_91, i$$64, j$$4, sc_enders_92, sc_steps_93, sc_names_94, sc_toks_95, sc_states_96, BgL_sc_nbzd2nts_97zd2) {
      ...
      if (name$$37 !== false) {
        ...
        if (sc_conf_91 < BgL_sc_nbzd2nts_97zd2) {
          v1744 = sc_list(JAM.call(sc_list, null, [name$$37, sc_toks_95[i$$64].car], JAM.policy.p1));
        } else {
    ...
    for (;v198;) {
      ...
      sc_optrOpnd_22 = JAM.new(sc_Pair, [tok.car, sc_reverse(l2$$5)], JAM.policy.p1);
...
function v79(n$$12) {
  ...
  if (!(sc_term_22 instanceof sc_Pair)) {
    ...
    optrOpnd$$1 = JAM.new(sc_Pair, [JAM.call(BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer, null, [sc_term_22.car]), JAM.call(translate_args_nboyer, null, [sc_term_22.cdr])], JAM.policy.p1);
  }
  var v1151;
  if (const_nboyer === null) {
    v1151 = null;
  } else {
    v1151 = JAM.new(sc_Pair, [JAM.new(sc_Pair, [const_nboyer.car.car, JAM.call(translate_term_nboyer, null, [const_nboyer.car.cdr])], JAM.policy.p1), JAM.call(translate_alist_nboyer, null, [const_nboyer.cdr])], JAM.policy.p1);
  }
  sc_term_21 = JAM.call(apply_subst_nboyer, null, [v1151, optrOpnd$$1], JAM.policy.p1);
  answer = JAM.call(tautologyp_nboyer, null, [JAM.call(rewrite_nboyer, null, [sc_term_21]), null, null], JAM.policy.p1);
...
function v78() {
  ...
  if (!(sc_term_19 instanceof sc_Pair)) {
    ...
    v1152 = JAM.new(sc_Pair, [JAM.call(BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer, null, [sc_term_19.car]), JAM.call(translate_args_nboyer, null, [sc_term_19.cdr])], JAM.policy.p1);
  }
  ...
  if (!(sc_term_18 instanceof sc_Pair)) {
    ...
    v1153 = JAM.new(sc_Pair, [JAM.call(BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer, null, [sc_term_18.car]), JAM.call(translate_args_nboyer, null, [sc_term_18.cdr])], JAM.policy.p1);
  }
  ...
  for (;v252;) {
    ...
    if (v1155) {
      ...
      if (!(term$$6 instanceof sc_Pair)) {
        ...
        v1157 = JAM.new(sc_Pair, [JAM.call(BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer, null, [term$$6.car]), JAM.call(translate_args_nboyer, null, [term$$6.cdr])], JAM.policy.p1);
      }
      var v249 = v1157;
      sym$$5 = term$$6.cdr.car.car;
      BgL_sc_symbolzd2record_16zd2 = JAM.call(BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer, null, [sym$$5]);
      value$$28 = JAM.new(sc_Pair, [v249, BgL_sc_symbolzd2record_16zd2[1]], JAM.policy.p1);
...
function v77(x$$77, lst$$6) {
  for (;true;) {
    if (lst$$6 === null) {
      ...
      if (JAM.call(is_term_equal_nboyer, null, [x$$77, lst$$6.car], JAM.policy.p1) !== false) {
        return true;
      } else {
        lst$$6 = lst$$6.cdr;
      }
...
function v76(x$$76, y$$42) {
  ...
  if (x$$76 instanceof sc_Pair) {
    ...
    return JAM.call(sc_isEqual, null, [x$$76, y$$42], JAM.policy.p1);
  }
  return;
}
function v75(n$$11) {
  ...
  if (JAM.call(sc_isEqual, null, [n$$11, 1], JAM.policy.p1)) {
    ...
    if (JAM.call(sc_isEqual, null, [sc_n_15, 1], JAM.policy.p1)) {
      ...
      v2161 = JAM.call(sc_list, null, ["\u1e9cand", JAM.call(sc_list, null, ["\u1e9cimplies", sc_n_15 - 1, sc_n_15], JAM.policy.p1), JAM.call(trans_of_implies1_nboyer, null, [sc_n_15 - 1])], JAM.policy.p1);
    }
...
function v73(lst$$5) {
  ...
  if (lst$$5 === null) {
    ...
    if (sc_lst_14 === null) {
      ...
      v2162 = JAM.new(sc_Pair, [JAM.call(rewrite_nboyer, null, [sc_lst_14.car]), JAM.call(rewrite_args_nboyer, null, [sc_lst_14.cdr])], JAM.policy.p1);
    }
...
function v72(term$$5) {
  ...
  if (!(term$$5 instanceof sc_Pair)) {
    ...
    if (sc_lst_13 === null) {
      ...
      v1777 = JAM.new(sc_Pair, [JAM.call(rewrite_nboyer, null, [sc_lst_13.car]), JAM.call(rewrite_args_nboyer, null, [sc_lst_13.cdr])], JAM.policy.p1);
    }
    ...
    for (;true;) {
      if (lst$$4 === null) {
        ...
        if (JAM.call(one_way_unify1_nboyer, null, [sc_term_12, term2], JAM.policy.p1) !== false) {
          return JAM.call(rewrite_nboyer, null, [JAM.call(apply_subst_nboyer, null, [unify_subst_nboyer, lst$$4.car.cdr.cdr.car], JAM.policy.p1)]);
        } else {
          lst$$4 = lst$$4.cdr;
        }
      }
        ...
        if (!(sc_x_11 instanceof sc_Pair)) {
          ...
          if (sc_x_11.car === if_constructor_nboyer) {
            ...
            if (v2169 !== false) {
              ...
              tmp1125 = JAM.call(is_term_equal_nboyer, null, [x$$75, false_term_nboyer], JAM.policy.p1);
              var v2170;
              if (tmp1125 !== false) {
                v2170 = tmp1125;
              } else {
                v2170 = JAM.call(is_term_member_nboyer, null, [x$$75, false_lst], JAM.policy.p1);
              }
              if (v2170 !== false) {
...
function v68(alist) {
  ...
  if (alist === null) {
    ...
    if (!(term$$3 instanceof sc_Pair)) {
      ...
      v2487 = JAM.new(sc_Pair, [JAM.call(BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer, null, [term$$3.car]), JAM.call(translate_args_nboyer, null, [term$$3.cdr])], JAM.policy.p1);
    }
    ...
    if (sc_alist_6 === null) {
      ...
      v2177 = JAM.new(sc_Pair, [JAM.new(sc_Pair, [sc_alist_6.car.car, JAM.call(translate_term_nboyer, null, [sc_alist_6.car.cdr])], JAM.policy.p1), JAM.call(translate_alist_nboyer, null, [sc_alist_6.cdr])], JAM.policy.p1);
    }
...
function v67(sym$$4) {
  var r;
  var x$$74;
  x$$74 = JAM.call(sc_assq, null, [sym$$4, BgL_sc_za2symbolzd2recordszd2alistza2_2z00_nboyer], JAM.policy.p1);
  var v1196;
  if (x$$74 !== false) {
    v1196 = x$$74.cdr;
  } else {
...
function v66(term$$2) {
  ...
  if (!(term$$2 instanceof sc_Pair)) {
    ...
    for (;v294;) {
      var v293 = tail1131;
      var v3735 = JAM.new(sc_Pair, [JAM.call(untranslate_term_nboyer, null, [L1127.car]), null], JAM.policy.p1);
      v293.cdr = v3735;
...
function v65(lst$$1) {
  ...
  if (lst$$1 === null) {
    ...
    if (!(term$$1 instanceof sc_Pair)) {
      ...
      v2178 = JAM.new(sc_Pair, [JAM.call(BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer, null, [term$$1.car]), JAM.call(translate_args_nboyer, null, [term$$1.cdr])], JAM.policy.p1);
    }
    var v1201 = v2178;
    sc_lst_5 = lst$$1.cdr;
    var v2179;
    if (sc_lst_5 === null) {
      ...
      v2179 = JAM.new(sc_Pair, [JAM.call(translate_term_nboyer, null, [sc_lst_5.car]), JAM.call(translate_args_nboyer, null, [sc_lst_5.cdr])], JAM.policy.p1);
    }
...
function v64(term) {
  ...
  if (!(term instanceof sc_Pair)) {
    ...
    if (lst === null) {
      ...
      v2180 = JAM.new(sc_Pair, [JAM.call(translate_term_nboyer, null, [lst.car]), JAM.call(translate_args_nboyer, null, [lst.cdr])], JAM.policy.p1);
    }
...
function v61() {
  ...
  return JAM.call(BgL_runzd2benchmarkzd2, null, ["nboyer" + JAM.call(sc_number2string, null, [n$$10]), 1, v59, v60], JAM.policy.p1);
}
function v58() {
...
function v46() {
  function readList(listBeginType) {
    ...
    for (;true;) {
      ...
      switch(token$$5.type) {
        ...
        ;
        case 6:
          if (JAM.call(matchesPeer, null, [listBeginType, token$$5.type], JAM.policy.p1)) {
        ...
        case 10:
          ...
          if (!JAM.call(matchesPeer, null, [listBeginType, par.type], JAM.policy.p1)) {
        ...
        ;
        default:
          res$$25 = JAM.call(sc_cons, null, [this.read(), res$$25], JAM.policy.p1);
      }
    }
    return;
  }
  ...
  switch(token$$4.type) {
    ...
    case 8:
      return JAM.call(sc_cons, null, ["quote", JAM.call(sc_cons, null, [this.read(), null], JAM.policy.p1)], JAM.policy.p1);
    case 11:
          ...
          switch(tmp$$16) {
            ...
            default:
              if (tmp$$16 === SC_EOF_OBJECT) {
                return JAM.new(sc_Token, [13, "unclosed string-literal" + res], JAM.policy.p1);
              }
              res = res + tmp$$16;
          }
          break;
  ...
  function readSharp() {
    ...
    if (isNumberChar(c$$20)) {
      ...
      switch(port$$1.readChar()) {
        ...
        default:
          return JAM.new(sc_Token, [13, "bad #-pattern1." + nb$$1], JAM.policy.p1);
      }
    }
    if (c$$20 === "(") {
      ...
      switch(tmp$$17.length) {
        case 0:
          if (sc_isEOFObject(port$$1.peekChar)) {
            ...
            return JAM.new(sc_Token, [20, port$$1.readChar()], JAM.policy.p1);
          }
        ;
        case 1:
        ...
        default:
          ...
          if (entry$$1) {
            ...
            return JAM.new(sc_Token, [13, "unknown character description: #\\" + tmp$$17], JAM.policy.p1);
          }
        ;
      }
    }
    ...
    switch(c$$20) {
      ...
      case "u":
        ...
        break;
      default:
        return JAM.new(sc_Token, [13, "bad #-pattern3: " + c$$20], JAM.policy.p1);
    }
    for (;true;) {
...
function sc_lcm() {
  ...
  for (;v555;) {
    var f = Math.round(arguments[i$$19] / JAM.call(sc_euclid_gcd, null, [arguments[i$$19], lcm], JAM.policy.p1));
    lcm = lcm * Math.abs(f);
    i$$19 = i$$19 + 1;
...
function sc_jsstring2number(s$$4, radix$$1) {
  ...
  if (radix$$1) {
    ...
    if (JAM.new(RegExp, ["^[" + allowedChars + "]*$", "i"], JAM.policy.p1).test(s$$4)) {
      return t;
    } else {
      return false;
    }
...
function sc_jsstring2list(s$$5) {
  ...
  var v686 = i$$27 >= 0;
  for (;v686;) {
    res$$16 = JAM.call(sc_cons, null, [new sc_Char(s$$5.charAt(i$$27)), res$$16], JAM.policy.p1);
    i$$27 = i$$27 - 1;
    v686 = i$$27 >= 0;
  }
  return res$$16;
...
function sc_pregexpMatch(re$$1, s$$9) {
  ...
  for (;v782;) {
    if (tmp$$12[i$$42] !== null) {
      res$$20 = JAM.call(sc_cons, null, [sc_jsstring2string(tmp$$12[i$$42]), res$$20], JAM.policy.p1);
    } else {
...
function sc_pregexpReplaceAll(re$$3, s1$$1, s2$$1) {
  ...
  if (re$$3 instanceof RegExp) {
    ...
    reg$$2 = JAM.new(RegExp, [sc_string2jsstring(re$$3), "g"], JAM.policy.p1);
  }
...
function sc_withInputFromString(s$$17, thunk$$4) {
  return JAM.call(sc_withInputFromPort, null, [new sc_StringInputPort(sc_string2jsstring(s$$17)), thunk$$4], JAM.policy.p1);
}
...
function sc_withOutputToProcedure(proc$$17, thunk$$7) {
  ...
  return JAM.call(sc_withOutputToPort, null, [new sc_GenericOutputPort(t$$3), thunk$$7], JAM.policy.p1);
}
  ...
  for (;v881;) {
    ...
    if (i2 == -1) {
      ...
      switch(s$$23.charCodeAt(i2 + 1)) {
        ...
        ;
        case 97:
          JAM.call(sc_display, null, [arguments[j$$2], p$$45], JAM.policy.p1);
          i$$48 = i$$48 + 2;
          j$$2 = j$$2 + 1;
          break;
        case 83:
        ;
        case 115:
          JAM.call(sc_write, null, [arguments[j$$2], p$$45], JAM.policy.p1);
          i$$48 = i$$48 + 2;
          j$$2 = j$$2 + 1;
          break;
        case 86:
...
function sc_number2symbol(x$$73, radix$$2) {
  return sc_SYMBOL_PREFIX + JAM.call(sc_number2jsstring, null, [x$$73, radix$$2], JAM.policy.p1);
}
function sc_symbol2number(s$$30, radix$$3) {
  return JAM.call(sc_jsstring2number, null, [s$$30.slice(1), radix$$3], JAM.policy.p1);
}
